...
#define CPLD_PORT_EVENT_SUMMARY_REG     0x10
#define CPLD_PORT_EVENT_MASK_REG        0x11
...
#define CPLD_SFP_PORT_PLUG_EVENT_REG    0x2E
...
#define CPLD_CPLD_INT_STATUS_REG        0x50
