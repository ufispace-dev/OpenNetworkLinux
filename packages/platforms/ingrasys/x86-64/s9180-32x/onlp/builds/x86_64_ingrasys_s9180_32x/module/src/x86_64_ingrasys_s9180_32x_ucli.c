...
static ucli_status_t x86_64_ingrasys_s9180_32x_ucli_ucli__config__(ucli_context_t* uc)
{
...
ucli_node_t* x86_64_ingrasys_s9180_32x_ucli_node_create(void)
{
    ucli_node_t* n;
...
#else
void* x86_64_ingrasys_s9180_32x_ucli_node_create(void)
{
    return NULL;
}
#endif
