...
onlp_fan_info_t fan_info[] = {
    { }, /* Not used */
    CHASSIS_INFO(FAN_OID_FAN1    , "CHASSIS FAN 0 FRONT"),
    CHASSIS_INFO(FAN_OID_FAN2    , "CHASSIS FAN 0 REAR"),
    CHASSIS_INFO(FAN_OID_FAN3    , "CHASSIS FAN 1 FRONT"),
    CHASSIS_INFO(FAN_OID_FAN4    , "CHASSIS FAN 1 REAR"),
    CHASSIS_INFO(FAN_OID_FAN5    , "CHASSIS FAN 2 FRONT"),
    CHASSIS_INFO(FAN_OID_FAN6    , "CHASSIS FAN 2 REAR"),
    CHASSIS_INFO(FAN_OID_FAN7    , "CHASSIS FAN 3 FRONT"),
    CHASSIS_INFO(FAN_OID_FAN8    , "CHASSIS FAN 3 REAR"),
