...
function _i2c_deinit {
    _i2c_gpio_deinit
    for mod in coretemp jc42 w83795 lm75 lm90 eeprom eeprom_mb gpio_pca953x i2c_mux_pca954x i2c_ismt i2c_i801 optoe;
    do
...
function _i2c_qsfp_eeprom_get {
    ...
    dd if=${PATH_SYS_I2C_DEVICES}/$eeprombus-$(printf "%04x" $eepromAddr)/eeprom bs=256 count=1 skip=0 status=none | hexdump -C
