...
/* This is definitions for x86-64-ufispace-s9600-28dx*/
/* OID map*/
/*
 * [01] CHASSIS
 *            |----[01] ONLP_THERMAL_CPU_PKG
 *            |----[02] ONLP_THERMAL_ENV_OCXO
 *            |----[03] ONLP_THERMAL_CPU_PECI
 *            |----[04] ONLP_THERMAL_ENV_CPU
 *            |----[05] ONLP_THERMAL_ENV_MAC0
 *            |----[06] ONLP_THERMAL_MAC0
 *            |----[07] ONLP_THERMAL_ENV_REAR0
 *            |----[08] ONLP_THERMAL_ENV_REAR1
 *            |----[09] ONLP_THERMAL_ENV_FRONT
 *            |----[01] ONLP_LED_SYS_SYNC
 *            |----[02] ONLP_LED_SYS_SYS
 *            |----[03] ONLP_LED_SYS_FAN
 *            |----[04] ONLP_LED_SYS_PSU_0
 *            |----[05] ONLP_LED_SYS_PSU_1
 *            |----[01] ONLP_PSU_0----[10] ONLP_THERMAL_PSU_0
 *            |                  |----[05] ONLP_PSU_0_FAN
 *            |----[02] ONLP_PSU_1----[11] ONLP_THERMAL_PSU_1
 *            |                  |----[06] ONLP_PSU_1_FAN
 *            |----[01] ONLP_FAN_0
 *            |----[03] ONLP_FAN_1
 *            |----[05] ONLP_FAN_2
...
#define SYSFS_CPU_CPLD_VER "/sys/devices/platform/x86_64_ufispace_s9600_28dx_lpc/cpu_cpld/cpu_cpld_version_h"
...
{
    char cpu_cpld_ver_out[ONLP_CONFIG_INFO_STR_MAX] = {'\0'};
...
{
    return "x86-64-ufispace-s9600-28dx-r0";
}
