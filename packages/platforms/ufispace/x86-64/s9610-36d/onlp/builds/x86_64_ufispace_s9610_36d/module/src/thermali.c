...
static onlp_thermal_info_t thermal_info[] = {
    ...
    THERMAL_INFO(ONLP_THERMAL_ENV_FRONT0, "TEMP_ENV_FRONT0", THERMAL_THRESHOLD_ENV),
    THERMAL_INFO(ONLP_THERMAL_ENV_FRONT1, "TEMP_ENV_FRONT1", THERMAL_THRESHOLD_ENV),
    THERMAL_INFO(ONLP_THERMAL_ENV0, "TEMP_ENV0", THERMAL_THRESHOLD_ENV),
    THERMAL_INFO(ONLP_THERMAL_ENV1, "TEMP_ENV1", THERMAL_THRESHOLD_ENV),
    THERMAL_INFO(ONLP_THERMAL_ENV_EXT0, "TEMP_ENV_EXT0", THERMAL_THRESHOLD_ENV),
    THERMAL_INFO(ONLP_THERMAL_ENV_EXT1, "TEMP_ENV_EXT1", THERMAL_THRESHOLD_ENV),
    THERMAL_INFO(ONLP_THERMAL_PSU0_TEMP1, "PSU 0 THERMAL 1", THERMAL_THRESHOLD_PSU),
    THERMAL_INFO(ONLP_THERMAL_PSU1_TEMP1, "PSU 1 THERMAL 1", THERMAL_THRESHOLD_PSU),
};
...
int ufi_bmc_thermal_info_get(onlp_thermal_info_t* info, int id)
{
    ...
    if (id == ONLP_THERMAL_PSU0_TEMP1 || id == ONLP_THERMAL_PSU1_TEMP1) {
