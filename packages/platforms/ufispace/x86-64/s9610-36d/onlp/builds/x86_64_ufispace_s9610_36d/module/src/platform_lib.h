...
enum bmc_attr_id {
    ...
    BMC_ATTR_ID_TEMP_ENV_FRONT0,
    BMC_ATTR_ID_TEMP_ENV_FRONT1,
...
enum onlp_thermal_id {
    ...
    ONLP_THERMAL_ENV_MAC1 = 13,
    ONLP_THERMAL_ENV_FRONT0  = 14,
    ONLP_THERMAL_ENV_FRONT1 = 15,
    ONLP_THERMAL_ENV0 = 16,
