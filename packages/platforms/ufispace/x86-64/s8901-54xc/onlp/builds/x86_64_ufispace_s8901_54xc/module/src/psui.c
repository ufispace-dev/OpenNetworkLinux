...
static psu_support_info_t psu_support_list[] =
{
    ...
    //{"FSPGROUP", "VICTO451AM",         ONLP_PSU_TYPE_AC,   ONLP_FAN_STATUS_B2F},
    ...
    {"DELTA",    "DPS-450AB-27 A",     ONLP_PSU_TYPE_AC,   ONLP_FAN_STATUS_B2F},
    {"DELTA",    "DPS-450AB-28 A",     ONLP_PSU_TYPE_DC48, ONLP_FAN_STATUS_B2F},
    {"DELTA",    "DPS-450AB-32 A",     ONLP_PSU_TYPE_DC48, ONLP_FAN_STATUS_F2B},
    {"DELTA",    "DPS-450AB-33 A",     ONLP_PSU_TYPE_AC,   ONLP_FAN_STATUS_F2B},
...
int ufi_psu_pwgood_get( int id, int *pw_good)
{
    int status = 0;
    int mask = 0;
