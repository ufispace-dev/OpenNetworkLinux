...
#include "x86_64_ufispace_s9600_32x_int.h"
...
typedef enum thermal_oid_e {
    ...
    THERMAL_OID_Q2CL_ENV = ONLP_THERMAL_ID_CREATE(2),//FIXME: order
    THERMAL_OID_Q2CL_DIE = ONLP_THERMAL_ID_CREATE(3),
    THERMAL_OID_REAR_ENV_1 = ONLP_THERMAL_ID_CREATE(4),
    THERMAL_OID_REAR_ENV_2 = ONLP_THERMAL_ID_CREATE(5),
    ...
    THERMAL_OID_ENV = ONLP_THERMAL_ID_CREATE(18),
    THERMAL_OID_FRONT_ENV = ONLP_THERMAL_ID_CREATE(19),
} thermal_oid_t;
...
typedef enum thermal_id_e {
    ...
    THERMAL_ID_Q2CL_ENV = 2, //FIXME: order
    THERMAL_ID_Q2CL_DIE = 3,
    THERMAL_ID_REAR_ENV_1 = 4,
    THERMAL_ID_REAR_ENV_2 = 5,
    THERMAL_ID_PSU0 = 6,
    THERMAL_ID_PSU1 = 7,
    THERMAL_ID_BMC_ENV = 8,
    THERMAL_ID_ENV = 9,
    THERMAL_ID_FRONT_ENV = 10,
