/*
 * A i2c cpld driver for the ufispace_s9600_32x
 *
...
#include "x86-64-ufispace-s9600-32x-cpld.h"
...
static const struct i2c_device_id cpld_id[] = {
    { "s9600_32x_cpld1",  cpld1 },
    { "s9600_32x_cpld2",  cpld2 },
    { "s9600_32x_cpld3",  cpld3 },
    {}
};

/* Addresses scanned for cpld */
static const unsigned short cpld_i2c_addr[] = { 0x38, 0x39, 0x3A, I2C_CLIENT_END };
...
static SENSOR_DEVICE_ATTR(cpld_build, S_IRUGO,
...
static struct i2c_driver cpld_driver = {
    ...
    .driver = {
        .name = "x86_64_ufispace_s9600_32x_cpld",
    },
    .probe = cpld_probe,
    .remove = cpld_remove,
    .id_table = cpld_id,
...
MODULE_DESCRIPTION("x86_64_ufispace_s9600_32x_cpld driver");
MODULE_LICENSE("GPL");
