...
/**
 * @brief Get fru id from local_id
 * @param local_id
 */
static int get_fru_id(int local_id)
{
    switch (local_id) {
        case ONLP_FAN_F_0:
        case ONLP_FAN_R_0:
            return BMC_FRU_IDX_FAN_TRAY_0;
        case ONLP_FAN_F_1:
        case ONLP_FAN_R_1:
            return BMC_FRU_IDX_FAN_TRAY_1;
        case ONLP_FAN_F_2:
        case ONLP_FAN_R_2:
            return BMC_FRU_IDX_FAN_TRAY_2;
        case ONLP_FAN_F_3:
        case ONLP_FAN_R_3:
            return BMC_FRU_IDX_FAN_TRAY_3;
        default:
            return BMC_FRU_IDX_INVALID;
    }
}
...
static int update_fru_info(int id, onlp_fan_info_t* info)
{
    ...
    if(get_fru_id(id) == BMC_FRU_IDX_INVALID) {
        return ONLP_STATUS_OK;
    }
    ...
    //read fru data
    ONLP_TRY(bmc_fru_read(get_fru_id(id), &fru));
