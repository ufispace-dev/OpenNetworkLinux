...
/* This is definitions for x86-64-ufispace-s9611-36d*/
/* OID map*/
/*
 * [01] CHASSIS
...
#define SYSFS_CPU_CPLD_VER "/sys/devices/platform/x86_64_ufispace_s9611_36d_lpc/cpu_cpld/cpu_cpld_version_h"
...
{
    return "x86-64-ufispace-s9611-36d-r0";
}
...
int onlp_sysi_oids_get(onlp_oid_t* table, int max)
{
    ...
    /* Thermal */
    for (i = ONLP_THERMAL_CPU_PKG; i < ONLP_THERMAL_PSU0_TEMP1; i++) {
