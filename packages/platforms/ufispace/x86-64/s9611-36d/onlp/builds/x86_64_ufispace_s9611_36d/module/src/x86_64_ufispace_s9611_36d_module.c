 ...
 ************************************************************
 *
 * x86_64_ufispace_s9611_36d_module.c
 *
 ***********************************************************/
...
{
#define UFISPACE_S9611_36D_ENUMERATION_ENTRY(_enum_name, _desc)     AIM_DATATYPE_MAP_REGISTER(_enum_name, _enum_name##_map, _desc,                               AIM_LOG_INTERNAL);
