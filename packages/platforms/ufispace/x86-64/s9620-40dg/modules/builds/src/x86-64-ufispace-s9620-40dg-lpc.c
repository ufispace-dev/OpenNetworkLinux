/*
 * A lpc driver for the ufispace_s9620_40dg
 *
...
#define DRIVER_NAME "x86_64_ufispace_s9620_40dg_lpc"
...
#define TOP_I2C_MUX_RESET_REG             (REG_BASE_MB + 0x46)
#define MAIN_I2C_MUX_RESET_REG            (REG_BASE_MB + 0xC7)
...
static SENSOR_DEVICE_ATTR_WO(mux_reset_top_0_5_12_15    , mux_reset_all    , MUX_RESET_TOP_0_5_12_15);
static SENSOR_DEVICE_ATTR_WO(mux_reset_main_6_11_16_39  , mux_reset_all    , MUX_RESET_MAIN_6_11_16_39);
...
static struct attribute *mb_cpld_attrs[] = {
    ...
    _DEVICE_ATTR(mux_reset_top_0_5_12_15),
    _DEVICE_ATTR(mux_reset_main_6_11_16_39),
...
MODULE_DESCRIPTION("x86_64_ufispace_s9620_40dg_lpc driver");
