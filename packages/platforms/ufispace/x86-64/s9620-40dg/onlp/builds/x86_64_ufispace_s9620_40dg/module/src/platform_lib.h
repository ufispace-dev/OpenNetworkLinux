...
#define LPC_FMT                     "/sys/devices/platform/x86_64_ufispace_s9620_40dg_lpc/mb_cpld/"
#define LPC_BSP_FMT                 "/sys/devices/platform/x86_64_ufispace_s9620_40dg_lpc/bsp/"
#define LPC_CPU_CPLD_FMT            "/sys/devices/platform/x86_64_ufispace_s9620_40dg_lpc/cpu_cpld/"
#define LPC_EC                      "/sys/devices/platform/x86_64_ufispace_s9620_40dg_lpc/ec/"
...
#define MUX_RESET_PATH              "/sys/devices/platform/x86_64_ufispace_s9620_40dg_lpc/mb_cpld/mux_reset_all"
#define SYSFS_DEVICES               "/sys/bus/i2c/devices/"
#define SYSFS_CPLD1                 SYSFS_DEVICES "2-0026/"
#define SYSFS_CPLD2                 SYSFS_DEVICES "2-0027/"
#define SYSFS_CPLD3                 SYSFS_DEVICES "6-0025/"
#define SYSFS_CPLD4                 SYSFS_DEVICES "6-0024/"
#define SYSFS_FAN0_ABS              SYSFS_CPLD3 "fan_0_abs"
#define SYSFS_FAN1_ABS              SYSFS_CPLD3 "fan_1_abs"
#define SYSFS_FAN2_ABS              SYSFS_CPLD3 "fan_2_abs"
#define SYSFS_FAN3_ABS              SYSFS_CPLD3 "fan_3_abs"
#define SYSFS_FAN4_ABS              SYSFS_CPLD3 "fan_4_abs"
...
/* BMC attr */
#define BMC_ATTR_NAME_TEMP_MAC_ENV0         "TEMP_MAC_ENV0"
#define BMC_ATTR_NAME_TEMP_MAC_CORE         "TEMP_MAC_CORE"
#define BMC_ATTR_NAME_TEMP_MAC_NIF50        "TEMP_MAC_NIF50"
#define BMC_ATTR_NAME_TEMP_MAC_ENV1         "TEMP_MAC_ENV1"
#define BMC_ATTR_NAME_TEMP_MAC_PADS         "TEMP_MAC_PADS"
#define BMC_ATTR_NAME_TEMP_MAC_ENV3         "TEMP_MAC_ENV3"
#define BMC_ATTR_NAME_TEMP_MAC_NIF100       "TEMP_MAC_NIF100"
#define BMC_ATTR_NAME_TEMP_MAC_SCH          "TEMP_MAC_SCH"
#define BMC_ATTR_NAME_TEMP_CPU_PECI         "TEMP_CPU_PECI"
#define BMC_ATTR_NAME_TEMP_MAC_MB           "TEMP_MAC_MB"
#define BMC_ATTR_NAME_TEMP_OPTICS           "TEMP_OPTICS"

#define BMC_ATTR_NAME_PSU0_TEMP1            "PSU0_TEMP1"
#define BMC_ATTR_NAME_PSU0_TEMP2            "PSU0_TEMP2"
#define BMC_ATTR_NAME_PSU0_TEMP3            "PSU0_TEMP3"
#define BMC_ATTR_NAME_PSU1_TEMP1            "PSU1_TEMP1"
#define BMC_ATTR_NAME_PSU1_TEMP2            "PSU1_TEMP2"
#define BMC_ATTR_NAME_PSU1_TEMP3            "PSU1_TEMP3"

#define BMC_ATTR_NAME_FAN0_RPM_UPPER        "FAN0_RPM_U"
#define BMC_ATTR_NAME_FAN0_RPM_LOWER        "FAN0_RPM_D"
#define BMC_ATTR_NAME_FAN1_RPM_UPPER        "FAN1_RPM_U"
#define BMC_ATTR_NAME_FAN1_RPM_LOWER        "FAN1_RPM_D"
#define BMC_ATTR_NAME_FAN2_RPM_UPPER        "FAN2_RPM_U"
#define BMC_ATTR_NAME_FAN2_RPM_LOWER        "FAN2_RPM_D"
#define BMC_ATTR_NAME_FAN3_RPM_UPPER        "FAN3_RPM_U"
#define BMC_ATTR_NAME_FAN3_RPM_LOWER        "FAN3_RPM_D"
#define BMC_ATTR_NAME_FAN4_RPM_UPPER        "FAN4_RPM_U"
#define BMC_ATTR_NAME_FAN4_RPM_LOWER        "FAN4_RPM_D"
#define BMC_ATTR_NAME_PSU0_FAN              "PSU0_FAN1"
#define BMC_ATTR_NAME_PSU1_FAN              "PSU1_FAN1"
#define BMC_ATTR_NAME_PSU0_PRSNT_L          "PSU0_PRSNT_L"
#define BMC_ATTR_NAME_PSU1_PRSNT_L          "PSU1_PRSNT_L"
...
#define BMC_ATTR_NAME_FAN4_PRSNT_L          "FAN4_PRSNT_L"
...
enum bmc_attr_id {
    BMC_ATTR_ID_START = 0,
    BMC_ATTR_ID_TEMP_MAC_ENV0 = BMC_ATTR_ID_START,
    BMC_ATTR_ID_TEMP_MAC_CORE,
    BMC_ATTR_ID_TEMP_MAC_NIF50,
    BMC_ATTR_ID_TEMP_MAC_ENV1,
    BMC_ATTR_ID_TEMP_MAC_PADS,
    BMC_ATTR_ID_TEMP_MAC_ENV3,
    BMC_ATTR_ID_TEMP_MAC_NIF100,
    BMC_ATTR_ID_TEMP_MAC_SCH,
    BMC_ATTR_ID_TEMP_CPU_PECI,
    BMC_ATTR_ID_TEMP_MAC_MB,
    BMC_ATTR_ID_TEMP_OPTICS,
    BMC_ATTR_ID_PSU0_TEMP1,
    BMC_ATTR_ID_PSU1_TEMP1,
    BMC_ATTR_ID_FAN0_RPM_UPPER,
    BMC_ATTR_ID_FAN0_RPM_LOWER,
    BMC_ATTR_ID_FAN1_RPM_UPPER,
    BMC_ATTR_ID_FAN1_RPM_LOWER,
    BMC_ATTR_ID_FAN2_RPM_UPPER,
    BMC_ATTR_ID_FAN2_RPM_LOWER,
    BMC_ATTR_ID_FAN3_RPM_UPPER,
    BMC_ATTR_ID_FAN3_RPM_LOWER,
    BMC_ATTR_ID_FAN4_RPM_UPPER,
    BMC_ATTR_ID_FAN4_RPM_LOWER,
    ...
    BMC_ATTR_ID_PSU0_PRSNT_L,
    BMC_ATTR_ID_PSU1_PRSNT_L,
...
enum onlp_thermal_id {
    ONLP_THERMAL_MAC_ENV0 = 1,
    ONLP_THERMAL_MAC_CORE,
    ONLP_THERMAL_MAC_NIF50,
    ONLP_THERMAL_MAC_ENV1,
    ONLP_THERMAL_MAC_PADS,
    ONLP_THERMAL_MAC_ENV3,
    ONLP_THERMAL_MAC_NIF100,
    ONLP_THERMAL_MAC_SCH,
