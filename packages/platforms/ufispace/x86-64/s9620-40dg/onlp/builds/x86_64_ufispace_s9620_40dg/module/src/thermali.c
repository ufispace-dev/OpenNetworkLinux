...
static onlp_thermal_info_t thermal_info[] = {
    ...
    {
        .hdr = {
            .id = ONLP_THERMAL_ID_CREATE(ONLP_THERMAL_MAC_CORE),
            .description = "TEMP_MAC_CORE",
            .poid = POID_0,
        },
        .status = ONLP_THERMAL_STATUS_PRESENT,
        .caps = (ONLP_THERMAL_CAPS_ALL)
    ...
    {
        .hdr = {
            .id = ONLP_THERMAL_ID_CREATE(ONLP_THERMAL_MAC_NIF50),
            .description = "TEMP_MAC_NIF50",
            .poid = POID_0,
        },
        .status = ONLP_THERMAL_STATUS_PRESENT,
        .caps = (ONLP_THERMAL_CAPS_ALL)
    ...
    {
        .hdr = {
            .id = ONLP_THERMAL_ID_CREATE(ONLP_THERMAL_MAC_PADS),
            .description = "TEMP_MAC_PADS",
            .poid = POID_0,
        },
        .status = ONLP_THERMAL_STATUS_PRESENT,
        .caps = (ONLP_THERMAL_CAPS_ALL)
    ...
    {
        .hdr = {
            .id = ONLP_THERMAL_ID_CREATE(ONLP_THERMAL_MAC_ENV3),
            .description = "TEMP_MAC_ENV3",
            .poid = POID_0,
        },
        .status = ONLP_THERMAL_STATUS_PRESENT,
        .caps = (ONLP_THERMAL_CAPS_ALL)
    ...
    {
        .hdr = {
            .id = ONLP_THERMAL_ID_CREATE(ONLP_THERMAL_MAC_NIF100),
            .description = "TEMP_MAC_NIF100",
            .poid = POID_0,
        },
        .status = ONLP_THERMAL_STATUS_PRESENT,
        .caps = (ONLP_THERMAL_CAPS_ALL)
    ...
    {
        .hdr = {
            .id = ONLP_THERMAL_ID_CREATE(ONLP_THERMAL_MAC_SCH),
            .description = "TEMP_MAC_SCH",
            .poid = POID_0,
        },
        .status = ONLP_THERMAL_STATUS_PRESENT,
        .caps = (ONLP_THERMAL_CAPS_ALL)
    ...
    {
        .hdr = {
            .id = ONLP_THERMAL_ID_CREATE(ONLP_THERMAL_MAC_MB),
            .description = "TEMP_MAC_MB",
            .poid = POID_0,
        },
        .status = ONLP_THERMAL_STATUS_PRESENT,
        .caps = (ONLP_THERMAL_CAPS_ALL)
...
static int get_node(int id, thrm_node_t *node) {
    ...
    switch(node->local_id) {
        case ONLP_THERMAL_MAC_ENV0:
            ...
            break;
        case ONLP_THERMAL_MAC_CORE:
            node->type = TYPE_THRM_ATTR_GENERAL_BMC;
            node->bmc = BMC_ATTR_ID_TEMP_MAC_CORE;
            break;
        case ONLP_THERMAL_MAC_NIF50:
            node->type = TYPE_THRM_ATTR_GENERAL_BMC;
            node->bmc = BMC_ATTR_ID_TEMP_MAC_NIF50;
            break;
        case ONLP_THERMAL_MAC_ENV1:
            node->type = TYPE_THRM_ATTR_GENERAL_BMC;
            node->bmc = BMC_ATTR_ID_TEMP_MAC_ENV1;
            break;
        case ONLP_THERMAL_MAC_PADS:
            node->type = TYPE_THRM_ATTR_GENERAL_BMC;
            node->bmc = BMC_ATTR_ID_TEMP_MAC_PADS;
            break;
        case ONLP_THERMAL_MAC_ENV3:
            node->type = TYPE_THRM_ATTR_GENERAL_BMC;
            node->bmc = BMC_ATTR_ID_TEMP_MAC_ENV3;
            break;
        case ONLP_THERMAL_MAC_NIF100:
            node->type = TYPE_THRM_ATTR_GENERAL_BMC;
            node->bmc = BMC_ATTR_ID_TEMP_MAC_NIF100;
            break;
        case ONLP_THERMAL_MAC_SCH:
            node->type = TYPE_THRM_ATTR_GENERAL_BMC;
            node->bmc = BMC_ATTR_ID_TEMP_MAC_SCH;
            break;
        case ONLP_THERMAL_CPU_PECI:
            node->type = TYPE_THRM_ATTR_GENERAL_BMC;
            node->bmc = BMC_ATTR_ID_TEMP_CPU_PECI;
            break;
        case ONLP_THERMAL_MAC_MB:
            node->type = TYPE_THRM_ATTR_GENERAL_BMC;
            node->bmc = BMC_ATTR_ID_TEMP_MAC_MB;
            break;
        case ONLP_THERMAL_OPTICS:
            node->type = TYPE_THRM_ATTR_GENERAL_BMC;
            node->bmc = BMC_ATTR_ID_TEMP_OPTICS;
            break;
