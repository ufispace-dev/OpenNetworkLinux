...
#define SYSFS_MB_CPLD_VER_H     LPC_FMT "cpld_version_h"
#define SYSFS_EC_VER_H          LPC_EC "ec_version_h"
...
/* This is definitions for x86-64-ufispace-s9620-40dg*/
/* OID map*/
/*
 * [01] CHASSIS
 *            |----[01] ONLP_THERMAL_MAC_ENV0
 *            |----[02] ONLP_THERMAL_MAC_CORE
 *            |----[03] ONLP_THERMAL_MAC_NIF50
 *            |----[04] ONLP_THERMAL_MAC_ENV1
 *            |----[05] ONLP_THERMAL_MAC_PADS
 *            |----[06] ONLP_THERMAL_MAC_ENV3
 *            |----[07] ONLP_THERMAL_MAC_NIF100
 *            |----[08] ONLP_THERMAL_MAC_SCH
 *            |----[09] ONLP_THERMAL_CPU_PECI
 *            |----[10] ONLP_THERMAL_MAC_MB
 *            |----[11] ONLP_THERMAL_OPTICS
 *            |----[14] ONLP_THERMAL_CPU_PKG
 *            |
...
static onlp_oid_t __onlp_oid_info_alpha[] = {
    ONLP_THERMAL_ID_CREATE(ONLP_THERMAL_MAC_ENV0),
    ONLP_THERMAL_ID_CREATE(ONLP_THERMAL_MAC_CORE),
    ONLP_THERMAL_ID_CREATE(ONLP_THERMAL_MAC_NIF50),
    ONLP_THERMAL_ID_CREATE(ONLP_THERMAL_MAC_ENV1),
    ONLP_THERMAL_ID_CREATE(ONLP_THERMAL_MAC_PADS),
    ONLP_THERMAL_ID_CREATE(ONLP_THERMAL_MAC_ENV3),
    ONLP_THERMAL_ID_CREATE(ONLP_THERMAL_MAC_NIF100),
    ONLP_THERMAL_ID_CREATE(ONLP_THERMAL_MAC_SCH),
    ONLP_THERMAL_ID_CREATE(ONLP_THERMAL_CPU_PECI),
    ONLP_THERMAL_ID_CREATE(ONLP_THERMAL_MAC_MB),
    ...
    ONLP_FAN_ID_CREATE(ONLP_FAN_0_U),
    ONLP_FAN_ID_CREATE(ONLP_FAN_0_L),
    ONLP_FAN_ID_CREATE(ONLP_FAN_1_U),
    ONLP_FAN_ID_CREATE(ONLP_FAN_1_L),
    ONLP_FAN_ID_CREATE(ONLP_FAN_2_U),
    ONLP_FAN_ID_CREATE(ONLP_FAN_2_L),
    ONLP_FAN_ID_CREATE(ONLP_FAN_3_U),
    ONLP_FAN_ID_CREATE(ONLP_FAN_3_L),
    ONLP_FAN_ID_CREATE(ONLP_FAN_4_U),
    ONLP_FAN_ID_CREATE(ONLP_FAN_4_L),
};
...
static int get_platform_info(onlp_platform_info_t* pi)
{
    ...
    char ec_ver[ONLP_CONFIG_INFO_STR_MAX] = {'\0'};
    ...
    if(board.hw_rev >= BRD_ALPHA) {
        ...
        ONLP_TRY(onlp_file_read((uint8_t*)&cpu_cpld_ver, ONLP_CONFIG_INFO_STR_MAX -1, &len, SYSFS_MB_CPLD_VER_H));
        ONLP_TRY(onlp_file_read((uint8_t*)&ec_ver, ONLP_CONFIG_INFO_STR_MAX -1, &len, SYSFS_EC_VER_H));
    }
...
{
    return "x86-64-ufispace-s9620-40dg-r0";
}
