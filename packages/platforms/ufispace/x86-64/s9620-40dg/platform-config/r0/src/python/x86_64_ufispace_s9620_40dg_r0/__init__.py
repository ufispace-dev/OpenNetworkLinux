...
class OnlPlatform_x86_64_ufispace_s9620_40dg_r0(OnlPlatformUfiSpace):
    PLATFORM='x86-64-ufispace-s9620-40dg-r0'
    MODEL="S9620-40DG"
    SYS_OBJECT_ID=".9620.40"
    PORT_COUNT=40
    PORT_CONFIG="24x50 + 12x100 + 4x400"
    LEVEL_INFO=1
    LEVEL_ERR=2
    BSP_VERSION='1.0.0'
    ...
    PATH_I2C_CPLD3="/sys/bus/i2c/devices/6-0025"
    PATH_I2C_CPLD4="/sys/bus/i2c/devices/6-0024"
    PATH_SYSTEM_LED=PATH_I2C_CPLD1+"/cpld_system_led_sys"
    PATH_MAC_ROV=[PATH_I2C_CPLD3+"/mac_rov"]
    ...
    PATH_LPC="/sys/devices/platform/x86_64_ufispace_s9620_40dg_lpc"
    ...
    port_conf = {
        0:  {"type": "QSFP"       , "bus": 14, "driver": "optoe1", "abs":{ 'type': 'sysfs', 'data': PATH_I2C_CPLD2+"/qsfp28_p0_abs" }},
        1:  {"type": "QSFP"       , "bus": 15, "driver": "optoe1", "abs":{ 'type': 'sysfs', 'data': PATH_I2C_CPLD2+"/qsfp28_p1_abs" }},
        2:  {"type": "QSFP"       , "bus": 16, "driver": "optoe1", "abs":{ 'type': 'sysfs', 'data': PATH_I2C_CPLD2+"/qsfp28_p2_abs" }},
        3:  {"type": "QSFP"       , "bus": 17, "driver": "optoe1", "abs":{ 'type': 'sysfs', 'data': PATH_I2C_CPLD2+"/qsfp28_p3_abs" }},
        4:  {"type": "QSFP"       , "bus": 18, "driver": "optoe1", "abs":{ 'type': 'sysfs', 'data': PATH_I2C_CPLD2+"/qsfp28_p4_abs" }},
        5:  {"type": "QSFP"       , "bus": 19, "driver": "optoe1", "abs":{ 'type': 'sysfs', 'data': PATH_I2C_CPLD2+"/qsfp28_p5_abs" }},
        6:  {"type": "QSFP"       , "bus": 22, "driver": "optoe1", "abs":{ 'type': 'sysfs', 'data': PATH_I2C_CPLD3+"/qsfp28_p6_abs" }},
        7:  {"type": "QSFP"       , "bus": 23, "driver": "optoe1", "abs":{ 'type': 'sysfs', 'data': PATH_I2C_CPLD3+"/qsfp28_p7_abs" }},
        8:  {"type": "QSFP"       , "bus": 24, "driver": "optoe1", "abs":{ 'type': 'sysfs', 'data': PATH_I2C_CPLD3+"/qsfp28_p8_abs" }},
        9:  {"type": "QSFP"       , "bus": 25, "driver": "optoe1", "abs":{ 'type': 'sysfs', 'data': PATH_I2C_CPLD3+"/qsfp28_p9_abs" }},
        10: {"type": "QSFP"       , "bus": 26, "driver": "optoe1", "abs":{ 'type': 'sysfs', 'data': PATH_I2C_CPLD3+"/qsfp28_p10_abs"}},
        11: {"type": "QSFP"       , "bus": 27, "driver": "optoe1", "abs":{ 'type': 'sysfs', 'data': PATH_I2C_CPLD3+"/qsfp28_p11_abs"}},
        ...
        16: {"type": "SFP"        , "bus": 38, "driver": "optoe2", "abs":{ 'type': 'sysfs', 'data': PATH_I2C_CPLD4+"/sfp56_p16_abs" }},
        17: {"type": "SFP"        , "bus": 39, "driver": "optoe2", "abs":{ 'type': 'sysfs', 'data': PATH_I2C_CPLD4+"/sfp56_p17_abs" }},
        18: {"type": "SFP"        , "bus": 40, "driver": "optoe2", "abs":{ 'type': 'sysfs', 'data': PATH_I2C_CPLD4+"/sfp56_p18_abs" }},
        19: {"type": "SFP"        , "bus": 41, "driver": "optoe2", "abs":{ 'type': 'sysfs', 'data': PATH_I2C_CPLD4+"/sfp56_p19_abs" }},
        20: {"type": "SFP"        , "bus": 42, "driver": "optoe2", "abs":{ 'type': 'sysfs', 'data': PATH_I2C_CPLD4+"/sfp56_p20_abs" }},
        21: {"type": "SFP"        , "bus": 43, "driver": "optoe2", "abs":{ 'type': 'sysfs', 'data': PATH_I2C_CPLD4+"/sfp56_p21_abs" }},
        22: {"type": "SFP"        , "bus": 44, "driver": "optoe2", "abs":{ 'type': 'sysfs', 'data': PATH_I2C_CPLD4+"/sfp56_p22_abs" }},
        23: {"type": "SFP"        , "bus": 45, "driver": "optoe2", "abs":{ 'type': 'sysfs', 'data': PATH_I2C_CPLD4+"/sfp56_p23_abs" }},
        24: {"type": "SFP"        , "bus": 46, "driver": "optoe2", "abs":{ 'type': 'sysfs', 'data': PATH_I2C_CPLD4+"/sfp56_p24_abs" }},
        25: {"type": "SFP"        , "bus": 47, "driver": "optoe2", "abs":{ 'type': 'sysfs', 'data': PATH_I2C_CPLD4+"/sfp56_p25_abs" }},
        26: {"type": "SFP"        , "bus": 48, "driver": "optoe2", "abs":{ 'type': 'sysfs', 'data': PATH_I2C_CPLD4+"/sfp56_p26_abs" }},
        27: {"type": "SFP"        , "bus": 49, "driver": "optoe2", "abs":{ 'type': 'sysfs', 'data': PATH_I2C_CPLD4+"/sfp56_p27_abs" }},
        28: {"type": "SFP"        , "bus": 50, "driver": "optoe2", "abs":{ 'type': 'sysfs', 'data': PATH_I2C_CPLD4+"/sfp56_p28_abs" }},
        29: {"type": "SFP"        , "bus": 51, "driver": "optoe2", "abs":{ 'type': 'sysfs', 'data': PATH_I2C_CPLD4+"/sfp56_p29_abs" }},
        30: {"type": "SFP"        , "bus": 52, "driver": "optoe2", "abs":{ 'type': 'sysfs', 'data': PATH_I2C_CPLD4+"/sfp56_p30_abs" }},
        31: {"type": "SFP"        , "bus": 53, "driver": "optoe2", "abs":{ 'type': 'sysfs', 'data': PATH_I2C_CPLD4+"/sfp56_p31_abs" }},
        32: {"type": "SFP"        , "bus": 54, "driver": "optoe2", "abs":{ 'type': 'sysfs', 'data': PATH_I2C_CPLD4+"/sfp56_p32_abs" }},
        33: {"type": "SFP"        , "bus": 55, "driver": "optoe2", "abs":{ 'type': 'sysfs', 'data': PATH_I2C_CPLD4+"/sfp56_p33_abs" }},
        34: {"type": "SFP"        , "bus": 56, "driver": "optoe2", "abs":{ 'type': 'sysfs', 'data': PATH_I2C_CPLD4+"/sfp56_p34_abs" }},
        35: {"type": "SFP"        , "bus": 57, "driver": "optoe2", "abs":{ 'type': 'sysfs', 'data': PATH_I2C_CPLD4+"/sfp56_p35_abs" }},
        36: {"type": "SFP"        , "bus": 58, "driver": "optoe2", "abs":{ 'type': 'sysfs', 'data': PATH_I2C_CPLD4+"/sfp56_p36_abs" }},
        37: {"type": "SFP"        , "bus": 59, "driver": "optoe2", "abs":{ 'type': 'sysfs', 'data': PATH_I2C_CPLD4+"/sfp56_p37_abs" }},
        38: {"type": "SFP"        , "bus": 60, "driver": "optoe2", "abs":{ 'type': 'sysfs', 'data': PATH_I2C_CPLD4+"/sfp56_p38_abs" }},
        39: {"type": "SFP"        , "bus": 61, "driver": "optoe2", "abs":{ 'type': 'sysfs', 'data': PATH_I2C_CPLD4+"/sfp56_p39_abs" }},
    }
    ...
    def init_cpld(self):
        cpld = [
            ('s9620_40dg_cpld1', 0x26, 2),
            ('s9620_40dg_cpld2', 0x27, 2),
            ('s9620_40dg_cpld3', 0x25, 6),
            ('s9620_40dg_cpld4', 0x24, 6),
        ]
    ...
    def update_dev_class(self, gpio_max=511, gpio_base=0, board=None):
        ...
        for port, config in port_conf.items():  # QSFPX ports
            ...
            if not config.get('type', '').startswith('QSFP'):
                continue
    ...
    def baseconfig(self):
        ...
        self.insmod("x86-64-ufispace-s9620-40dg-lpc")
        # version setting
        ...
        self.insmod("x86-64-ufispace-s9620-40dg-cpld")
