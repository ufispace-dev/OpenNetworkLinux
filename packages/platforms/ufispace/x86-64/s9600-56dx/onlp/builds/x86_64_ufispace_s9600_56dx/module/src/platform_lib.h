...
#define MUX_RESET_PATH          "/sys/devices/platform/x86_64_ufispace_s9600_56dx_lpc/mb_cpld/mux_reset"
...
enum onlp_thermal_id {
    ...
    ONLP_THERMAL_MAC0 = 6,
    ONLP_THERMAL_ENV_MAC1 = 7,
    ONLP_THERMAL_MAC1 = 8,
    ONLP_THERMAL_ENV_REAR0 = 9,
    ONLP_THERMAL_ENV_REAR1 = 10,
    ONLP_THERMAL_ENV_FRONT = 11,
