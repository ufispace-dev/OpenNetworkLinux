...
static onlp_thermal_info_t thermal_info[] = {
    ...
    THERMAL_INFO(ONLP_THERMAL_MAC0, "TEMP_MAC0", THERMAL_THRESHOLD_MAC_ENV),
    THERMAL_INFO(ONLP_THERMAL_ENV_MAC1, "TEMP_ENV_MAC1", THERMAL_THRESHOLD_ENV),
    THERMAL_INFO(ONLP_THERMAL_MAC1, "TEMP_MAC1", THERMAL_THRESHOLD_ENV),
