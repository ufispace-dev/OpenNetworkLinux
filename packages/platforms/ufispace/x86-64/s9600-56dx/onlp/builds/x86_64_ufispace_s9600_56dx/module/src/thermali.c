...
#define THERMAL_THRESHOLD_MAC      {100000, 105000, 110000}
...
static onlp_thermal_info_t thermal_info[] = {
    ...
    THERMAL_INFO(ONLP_THERMAL_ENV_OCXO, "TEMP_ENV_OCXO", THERMAL_THRESHOLD_ENV),
    ...
    THERMAL_INFO(ONLP_THERMAL_MAC0, "TEMP_MAC0", THERMAL_THRESHOLD_MAC),
    THERMAL_INFO(ONLP_THERMAL_ENV_MAC1, "TEMP_ENV_MAC1", THERMAL_THRESHOLD_MAC_ENV),
    THERMAL_INFO(ONLP_THERMAL_MAC1, "TEMP_MAC1", THERMAL_THRESHOLD_MAC),
    THERMAL_INFO(ONLP_THERMAL_ENV_REAR0, "TEMP_ENV_REAR0", THERMAL_THRESHOLD_ENV),
    THERMAL_INFO(ONLP_THERMAL_ENV_REAR1, "TEMP_ENV_REAR1", THERMAL_THRESHOLD_ENV),
    THERMAL_INFO(ONLP_THERMAL_ENV_FRONT, "TEMP_ENV_FRONT", THERMAL_THRESHOLD_ENV),
    THERMAL_INFO(ONLP_THERMAL_PSU_0, "PSU 0 THERMAL 1", THERMAL_THRESHOLD_PSU),
    THERMAL_INFO(ONLP_THERMAL_PSU_1, "PSU 1 THERMAL 1", THERMAL_THRESHOLD_PSU),
};
...
int ufi_bmc_thermal_info_get(onlp_thermal_info_t* info, int id)
{
    ...
    switch(id)
    {
        case ONLP_THERMAL_ENV_OCXO:
            bmc_attr_id = BMC_ATTR_ID_TEMP_ENV_OCXO;
            break;
        ...
        case ONLP_THERMAL_MAC1:
            ...
            break;
        case ONLP_THERMAL_ENV_REAR0:
            bmc_attr_id = BMC_ATTR_ID_TEMP_ENV_REAR0;
            break;
        case ONLP_THERMAL_ENV_REAR1:
            bmc_attr_id = BMC_ATTR_ID_TEMP_ENV_REAR1;
            break;
    ...
    *rv = thermal_info[sensor_id];
    ...
    switch (sensor_id) {
        case ONLP_THERMAL_CPU_PKG:
            ...
            break;
        case ONLP_THERMAL_ENV_OCXO ... ONLP_THERMAL_PSU_1:
