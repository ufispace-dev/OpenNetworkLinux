...
class OnlPlatform_x86_64_ufispace_s9600_56dx_r0(OnlPlatformUfiSpace):
    PLATFORM="x86-64-ufispace-s9600-56dx-r0"
    MODEL="S9600-56DX"
    SYS_OBJECT_ID=".9600.56"
    PORT_COUNT=56
    ...
    def baseconfig(self):
        ...
        # lpc driver
        self.insmod("x86-64-ufispace-s9600-56dx-lpc")
        ...
        i2c_muxs = [
            ...
            ('pca9548', 0x76, 20), # 9548_QSFP_24_31
            ('pca9548', 0x76, 21), # 9548_QSFP_32_39
            ('pca9548', 0x76, 22), # 9548_QSFP_40_47
        ...
        self.insmod("x86-64-ufispace-s9600-56dx-cpld")
        for i, addr in enumerate((0x30, 0x31, 0x32, 0x33, 0x34)):
            self.new_i2c_device("s9600_56dx_cpld" + str(i+1), addr, 1)
