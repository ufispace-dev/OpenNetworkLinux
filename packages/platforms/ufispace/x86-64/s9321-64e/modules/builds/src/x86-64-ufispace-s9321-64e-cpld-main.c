...
enum cpld_sysfs_attributes {
    ...
    CPLD_DBG_QSFPDD_PORT_0_15_16_31_FUSE,
    CPLD_DBG_QSFPDD_PORT_32_47_48_63_FUSE,
...
static attr_reg_map_t attr_reg[]= {
    ...
    [CPLD_DBG_QSFPDD_PORT_0_15_16_31_FUSE]      = {CPLD_DBG_QSFPDD_PORT_0_15_16_31_FUSE_REG      , MASK_ALL      , DATA_HEX},
    [CPLD_DBG_QSFPDD_PORT_32_47_48_63_FUSE]     = {CPLD_DBG_QSFPDD_PORT_32_47_48_63_FUSE_REG     , MASK_ALL      , DATA_HEX},
...
static SENSOR_DEVICE_ATTR_RW(dbg_cpld_qsfpdd_intr_fuse_0   , cpld, CPLD_DBG_QSFPDD_PORT_0_15_16_31_FUSE);
static SENSOR_DEVICE_ATTR_RW(dbg_cpld_qsfpdd_intr_fuse_1   , cpld, CPLD_DBG_QSFPDD_PORT_32_47_48_63_FUSE);
...
static struct attribute *cpld2_attributes[] = {
    ...
    _DEVICE_ATTR(cpld_qsfpdd_stuck_0),
    _DEVICE_ATTR(cpld_qsfpdd_stuck_1),
    _DEVICE_ATTR(cpld_qsfpdd_stuck_2),
    _DEVICE_ATTR(cpld_qsfpdd_stuck_3),
    ...
    _DEVICE_ATTR(cpld_qsfpdd_mask_stuck_0),
    _DEVICE_ATTR(cpld_qsfpdd_mask_stuck_1),
    _DEVICE_ATTR(cpld_qsfpdd_mask_stuck_2),
    _DEVICE_ATTR(cpld_qsfpdd_mask_stuck_3),
    ...
    _DEVICE_ATTR(cpld_qsfpdd_evt_stuck_0),
    _DEVICE_ATTR(cpld_qsfpdd_evt_stuck_1),
    _DEVICE_ATTR(cpld_qsfpdd_evt_stuck_2),
    _DEVICE_ATTR(cpld_qsfpdd_evt_stuck_3),
        ...
        struct device_attribute *da, char *buf)
{
    ...
    switch (attr->index) {
        ...
        case CPLD_DBG_QSFPDD_PORT_0_15_16_31_FUSE:
