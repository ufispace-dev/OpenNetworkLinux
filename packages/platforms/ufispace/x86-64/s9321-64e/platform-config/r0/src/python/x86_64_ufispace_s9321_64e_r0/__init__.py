...
class OnlPlatform_x86_64_ufispace_s9321_64e_r0(OnlPlatformUfiSpace):
    ...
    LEVEL_INFO=1
    LEVEL_ERR=2
    SYSFS_LPC="/sys/devices/platform/x86_64_ufispace_s9321_64e_lpc"
    ...
    def get_gpio_max(self):
        cmd = "cat /sys/devices/platform/x86_64_ufispace_s9321_64e_lpc/bsp/bsp_gpio_max"
    ...
    def baseconfig(self):
        ...
        # init EEPROM
        self.bsp_pr("Init FPGA port eeprom")
        ...
        for i, addr in enumerate((0x30, 0x31, 0x32)):
            self.new_i2c_device("s9321_64e_cpld" + str(i+1), addr, 1)
        #init FPGA
        self.new_i2c_device("s9321_64e_fpga", 0x37, 1)
        ...
        os.system("timeout 120s " + self.FS_PLTM_CFG + "/epdm_cli init -s 10G")
