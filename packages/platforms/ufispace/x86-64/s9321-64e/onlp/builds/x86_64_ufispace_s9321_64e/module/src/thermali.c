...
static onlp_thermal_info_t thermal_info[] = {
    ...
    THERMAL_INFO(ONLP_THERMAL_ENV2, "TEMP_ENV2", THERMAL_THRESHOLD_ENV),
    THERMAL_INFO(ONLP_THERMAL_ENV3, "TEMP_ENV3", THERMAL_THRESHOLD_ENV),
    THERMAL_INFO(ONLP_THERMAL_ENV4, "TEMP_ENV4", THERMAL_THRESHOLD_ENV),
    THERMAL_INFO(ONLP_THERMAL_ENV5, "TEMP_ENV5", THERMAL_THRESHOLD_ENV),
    THERMAL_INFO(ONLP_THERMAL_ENV_RISER, "TEMP_ENV_RISER", THERMAL_THRESHOLD_ENV),
    THERMAL_INFO(ONLP_THERMAL_ENV_FAN0, "TEMP_ENV_FAN0", THERMAL_THRESHOLD_ENV),
    THERMAL_INFO(ONLP_THERMAL_ENV_FAN1, "TEMP_ENV_FAN1", THERMAL_THRESHOLD_ENV),
...
int ufi_bmc_thermal_info_get(onlp_thermal_info_t* info, int id)
{
    ...
    switch(id)
    {
        ...
        case ONLP_THERMAL_ENV_RISER:
            bmc_attr_id = BMC_ATTR_ID_TEMP_ENV_RISER;
            break;
