...
const int CPLD_BASE_ADDR[] = {0x30, 0x31, 0x32, 0x37};
...
bmc_info_t bmc_cache[] =
{
    ...
    [BMC_ATTR_ID_TEMP_ENV0] = {"TEMP_ENV0", 0},
    [BMC_ATTR_ID_TEMP_ENV1] = {"TEMP_ENV1", 0},
    [BMC_ATTR_ID_TEMP_ENV2] = {"TEMP_ENV2", 0},
    [BMC_ATTR_ID_TEMP_ENV3] = {"TEMP_ENV3", 0},
    [BMC_ATTR_ID_TEMP_ENV4] = {"TEMP_ENV4", 0},
    [BMC_ATTR_ID_TEMP_ENV5] = {"TEMP_ENV5", 0},
    [BMC_ATTR_ID_TEMP_ENV_RISER] = {"TEMP_ENV_RISER", 0},
    [BMC_ATTR_ID_TEMP_ENV_FAN0] = {"TEMP_ENV_FAN0", 0},
    [BMC_ATTR_ID_TEMP_ENV_FAN1] = {"TEMP_ENV_FAN1", 0},
    [BMC_ATTR_ID_PSU0_TEMP1] = {"PSU0_TEMP1", 0},
    [BMC_ATTR_ID_PSU1_TEMP1] = {"PSU1_TEMP1", 0},
    [BMC_ATTR_ID_FAN0_RPM_FRONT] = {"FAN0_RPM_FRONT", 0},
    [BMC_ATTR_ID_FAN0_RPM_REAR] = {"FAN0_RPM_REAR", 0},
    [BMC_ATTR_ID_FAN1_RPM_FRONT] = {"FAN1_RPM_FRONT", 0},
    [BMC_ATTR_ID_FAN1_RPM_REAR] = {"FAN1_RPM_REAR", 0},
    [BMC_ATTR_ID_FAN2_RPM_FRONT] = {"FAN2_RPM_FRONT", 0},
    [BMC_ATTR_ID_FAN2_RPM_REAR] = {"FAN2_RPM_REAR", 0},
    [BMC_ATTR_ID_FAN3_RPM_FRONT] = {"FAN3_RPM_FRONT", 0},
    [BMC_ATTR_ID_FAN3_RPM_REAR] = {"FAN3_RPM_REAR", 0},
