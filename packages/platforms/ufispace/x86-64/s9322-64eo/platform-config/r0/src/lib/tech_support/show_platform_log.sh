...
SYSFS_LPC="/sys/bus/platform/devices/x86_64_ufispace_s9322_64eo_lpc"
...
function _update_gpio_max {
    ...
    GPIO_MAX=$(cat /sys/devices/platform/x86_64_ufispace_s9322_64eo_lpc/bsp/bsp_gpio_max)
...
function _update_fpga_pci_enable {
    ...
    FPGA_PCI_ENABLE=$(cat /sys/devices/platform/x86_64_ufispace_s9322_64eo_lpc/bsp/bsp_fpga_pci_enable)
...
function _check_bsp_init {
    ...
    if [ -f "/sys/devices/platform/x86_64_ufispace_s9322_64eo_lpc/bsp/bsp_gpio_max" ]; then
        BSP_INIT_FLAG=1
    else
        BSP_INIT_FLAG=0
    fi
...
function _show_board_info {
    ...
    model_id_array=($((2#00100111)))
    model_name_array=("S9322-64EO")
    model_name=""
