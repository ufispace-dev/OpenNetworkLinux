...
class OnlPlatform_x86_64_ufispace_s9322_64eo_r0(OnlPlatformUfiSpace):
    PLATFORM='x86-64-ufispace-s9322-64eo-r0'
    MODEL="S9322-64EO"
    SYS_OBJECT_ID=".9322.64"
    PORT_COUNT=64
    PORT_CONFIG="64x800"
    LEVEL_INFO=1
    LEVEL_ERR=2
    ...
    PATH_LPC="/sys/devices/platform/x86_64_ufispace_s9322_64eo_lpc"
    ...
    def init_cpld(self, board):
        cpld = [
            ('s9322_64eo_cpld1', 0x30, 1),
            ('s9322_64eo_cpld2', 0x31, 1),
            ('s9322_64eo_cpld3', 0x32, 1),
            ('s9322_64eo_fpga' , 0x37, 1),
        ]
    ...
    def baseconfig(self):
        ...
        self.insmod("x86-64-ufispace-s9322-64eo-lpc")
        ...
        if self.FPGA_PCI_ENABLE == 1:
            self.insmod("x86-64-ufispace-s9322-64eo-cpld")
        else:
            self.insmod("x86-64-ufispace-s9322-64eo-cpld", params={'mux_en': 1})
