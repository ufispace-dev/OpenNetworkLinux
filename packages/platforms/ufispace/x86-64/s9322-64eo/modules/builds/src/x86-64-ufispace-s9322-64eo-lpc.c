/*
 * A lpc driver for the ufispace_s9322_64eo
 *
...
#define DRIVER_NAME "x86_64_ufispace_s9322_64eo_lpc"
...
attr_reg_map_t attr_reg[]= {
    ...
    [ATT_MB_MUX_RESET_ALL]     = {REG_MB_MUX_RESET    , MASK_ALL      , DATA_DEC},
...
MODULE_DESCRIPTION("x86_64_ufispace_s9322_64eo_lpc driver");
