...
int get_cpu_hw_rev_id(int *rev_id, int *dev_phase, int *build_id)
{
    ...
    // ONLP_TRY(read_file_hex(rev_id, "/sys/devices/platform/x86_64_ufispace_s9322_64eo_lpc/ec/cpu_rev_hw_rev"));
    // ONLP_TRY(read_file_hex(dev_phase, "/sys/devices/platform/x86_64_ufispace_s9322_64eo_lpc/ec/cpu_rev_dev_phase"));
    // ONLP_TRY(read_file_hex(build_id, "/sys/devices/platform/x86_64_ufispace_s9322_64eo_lpc/ec/cpu_rev_build_id"));
