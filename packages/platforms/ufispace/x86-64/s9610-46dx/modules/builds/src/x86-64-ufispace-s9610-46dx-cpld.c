/*
 * A i2c cpld driver for the ufispace_s9610_46dx
 *
...
static const struct i2c_device_id cpld_id[] = {
    { "s9610_46dx_cpld1",  cpld1 },
    { "s9610_46dx_cpld2",  cpld2 },
    { "s9610_46dx_cpld3",  cpld3 },
    { "s9610_46dx_cpld4",  cpld4 },
    {}
};
...
static struct i2c_driver cpld_driver = {
    ...
    .driver = {
        .name = "x86_64_ufispace_s9610_46dx_cpld",
    },
    .probe = cpld_probe,
    .remove = cpld_remove,
    .id_table = cpld_id,
...
MODULE_DESCRIPTION("x86_64_ufispace_s9610_46dx_cpld driver");
MODULE_LICENSE("GPL");
