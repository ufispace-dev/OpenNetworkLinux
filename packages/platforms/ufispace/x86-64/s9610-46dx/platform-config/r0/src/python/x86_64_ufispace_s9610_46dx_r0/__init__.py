...
class OnlPlatform_x86_64_ufispace_s9610_46dx_r0(OnlPlatformUfiSpace):
    PLATFORM='x86-64-ufispace-s9610-46dx-r0'
    MODEL="S9610-46DX"
    SYS_OBJECT_ID=".9610.46"
    PORT_COUNT=46
    PORT_CONFIG="40x100 + 6x400"
    LEVEL_INFO=1
    LEVEL_ERR=2
    ...
    def init_dev_class(self):
        # init dev_class
        for bus in range(25, 71):  # QSFP+QSFPDD
            # get dev_class
            port = bus - 25
    ...
    def baseconfig(self):
        ...
        # lpc driver
        self.insmod("x86-64-ufispace-s9610-46dx-lpc")
        ...
        self.insmod("x86-64-ufispace-s9610-46dx-cpld")
        for i, addr in enumerate((0x30, 0x31, 0x32, 0x33)):
            self.new_i2c_device("s9610_46dx_cpld" + str(i+1), addr, 1)
