...
static onlp_led_info_t led_info[] =
{
    ...
    {
        .hdr = {
            .id =  ONLP_LED_ID_CREATE(ONLP_LED_SYS_PSU0),
    ...
    {
        .hdr = {
            .id =  ONLP_LED_ID_CREATE(ONLP_LED_SYS_PSU1),
...
static int get_node(int id, led_node_t *node)
{
    board_t board = {0};
    if(node == NULL) {
    ...
    switch(node->local_id) {
        ...
        case ONLP_LED_SYS_SYS:
            node->sysfs = SYSFS_CPLD1 "cpld_sys_led_ctrl_1";
            node->action = ACTION_LED_RO;
            node->type = TYPE_LED_ATTR_CPLD;
            node->color_mask = 0b00001101;
            node->color_obj[0].val = 0b00000000;
            node->color_obj[0].mode = ONLP_LED_MODE_OFF;
            node->color_obj[1].val = 0b00000001;
            node->color_obj[1].mode = ONLP_LED_MODE_OFF;
            node->color_obj[2].val = 0b00000100;
            node->color_obj[2].mode = ONLP_LED_MODE_OFF;
            node->color_obj[3].val = 0b00000101;
            node->color_obj[3].mode = ONLP_LED_MODE_OFF;
            node->color_obj[4].val = 0b00001001;
            node->color_obj[4].mode = ONLP_LED_MODE_GREEN;
            node->color_obj[5].val = 0b00001101;
            node->color_obj[5].mode = ONLP_LED_MODE_GREEN_BLINKING;
            node->color_obj[6].val = 0b00001000;
            node->color_obj[6].mode = ONLP_LED_MODE_YELLOW;
            node->color_obj[7].val = 0b00001100;
            node->color_obj[7].mode = ONLP_LED_MODE_YELLOW_BLINKING;
            node->color_obj[8].val = node->color_obj[4].val;
            node->color_obj[8].mode = ONLP_LED_MODE_ON;
            node->color_obj[9].val = REG_INVALID;
        ...
        case ONLP_LED_SYS_PSU0:
            node->sysfs = SYSFS_CPLD1 "cpld_sys_led_ctrl_2";
            node->action = ACTION_LED_RO;
            node->type = TYPE_LED_ATTR_CPLD;
            node->color_mask = 0b00001101;
            node->color_obj[0].val = 0b00000000;
        ...
        case ONLP_LED_SYS_ID:
            ...
            node->action = ACTION_LED_RW;
            node->type = TYPE_LED_ATTR_CPLD;
            node->color_mask = 0b00001100;
            node->color_obj[0].val = 0b00000000;
            node->color_obj[0].mode = ONLP_LED_MODE_OFF;
            node->color_obj[1].val = 0b00000100;
            node->color_obj[1].mode = ONLP_LED_MODE_OFF;
            node->color_obj[2].val = 0b00001000;
            node->color_obj[2].mode = ONLP_LED_MODE_BLUE;
            node->color_obj[3].val = 0b00001100;
            node->color_obj[3].mode = ONLP_LED_MODE_BLUE_BLINKING;
            node->color_obj[4].val = REG_INVALID;
           break;
        default:
            return ONLP_STATUS_E_INVALID;
    }
...
static int get_sys_led_info(int id, onlp_led_info_t* info)
{
    int led_val = 0;
    int i=0;
    led_node_t node = {0};
...
int onlp_ledi_info_get(onlp_oid_t id, onlp_led_info_t* rv)
{
    ...
    ONLP_TRY(get_sys_led_info(id, rv));
    return ONLP_STATUS_OK;
}
...
int onlp_ledi_status_get(onlp_oid_t id, uint32_t* rv)
{
    ...
    ONLP_TRY(onlp_ledi_init());
    ONLP_TRY(get_sys_led_info(id, &info));
    *rv = info.status;
