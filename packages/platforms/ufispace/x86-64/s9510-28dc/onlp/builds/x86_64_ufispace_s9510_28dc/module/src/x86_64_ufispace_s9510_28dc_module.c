 ...
 ************************************************************
 *
 * x86_64_ufispace_s9510_28dc_module.c
 *
 ***********************************************************/
...
{
#define UFISPACE_S9510_28DC_ENUMERATION_ENTRY(_enum_name, _desc)     AIM_DATATYPE_MAP_REGISTER(_enum_name, _enum_name##_map, _desc,                               AIM_LOG_INTERNAL);
