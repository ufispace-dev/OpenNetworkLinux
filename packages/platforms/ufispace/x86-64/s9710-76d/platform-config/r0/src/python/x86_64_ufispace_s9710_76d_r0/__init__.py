...
class OnlPlatform_x86_64_ufispace_s9710_76d_r0(OnlPlatformUfiSpace):
    ...
    def get_gpio_max(self):
        cmd = "cat /sys/devices/platform/x86_64_ufispace_s9710_76d_lpc/bsp/bsp_gpio_max"
        output = ""
        try:
    ...
    def get_gpio_base(self):
        cmd = "cat /sys/devices/platform/x86_64_ufispace_s9710_76d_lpc/bsp/bsp_gpio_base"
        output = ""
        try:
            output = subprocess.check_output(cmd.split())
        except Exception as e:
    ...
    def baseconfig(self):
        ...
        self._write("/sys/bus/i2c/devices/30-0033/cpld_evt_ctrl", 1)
        self._write("/sys/bus/i2c/devices/30-0034/cpld_evt_ctrl", 1)
