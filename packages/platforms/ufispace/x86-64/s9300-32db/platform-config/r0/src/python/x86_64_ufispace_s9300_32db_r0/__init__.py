...
class OnlPlatform_x86_64_ufispace_s9300_32db_r0(OnlPlatformUfiSpace):
    PLATFORM = 'x86-64-ufispace-s9300-32db-r0'
    MODEL = "s9300-32db"
    ...
    def check_i2c_status(self):
        sysfs_mux_reset = "/sys/devices/platform/x86_64_ufispace_s9300_32db_lpc/mb_cpld/mux_reset"
    ...
    def baseconfig(self):
        ...
        # lpc driver
        self.insmod("x86-64-ufispace-s9300-32db-lpc")
