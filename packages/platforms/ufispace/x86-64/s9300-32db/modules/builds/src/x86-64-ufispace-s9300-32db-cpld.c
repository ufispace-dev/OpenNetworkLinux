/*
 * A i2c cpld driver for the ufispace_s9300_32db
 *
...
#include "x86-64-ufispace-s9300-32db-cpld.h"
...
static const struct i2c_device_id s9300_cpld_id[] = {
    { "s9300_32db_cpld1",  cpld1 },
    { "s9300_32db_cpld2",  cpld2 },
    { "s9300_32db_cpld3",  cpld3 },
    {}
};
...
static struct i2c_driver s9300_cpld_driver = {
    ...
    .driver = {
        .name = "x86_64_ufispace_s9300_32db_cpld",
    },
