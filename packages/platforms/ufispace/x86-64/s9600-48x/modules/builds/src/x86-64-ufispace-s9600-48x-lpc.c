/*
 * A lpc driver for the ufispace_s9600_48x
 *
...
#define DRIVER_NAME "x86_64_ufispace_s9600_48x_lpc"
#define CPU_BDE 0
#define CPU_SKY 1
#define CPU_TYPE CPU_BDE
...
MODULE_DESCRIPTION("x86_64_ufispace_s9600_48x_lpc driver");
MODULE_LICENSE("GPL");
