...
typedef enum thermal_oid_e {
    ...
    THERMAL_OID_Q2CR_ENV = ONLP_THERMAL_ID_CREATE(4),
    THERMAL_OID_Q2CR_DIE = ONLP_THERMAL_ID_CREATE(5),
    THERMAL_OID_REAR_ENV_1 = ONLP_THERMAL_ID_CREATE(6),
    THERMAL_OID_REAR_ENV_2 = ONLP_THERMAL_ID_CREATE(7),
    ...
    THERMAL_OID_CPU_BOARD = ONLP_THERMAL_ID_CREATE(19),
...
typedef enum thermal_id_e {
    ...
    THERMAL_ID_Q2CR_ENV = 4,
    THERMAL_ID_Q2CR_DIE = 5,
    THERMAL_ID_REAR_ENV_1 = 6,
    THERMAL_ID_REAR_ENV_2 = 7,
    THERMAL_ID_PSU0 = 8,
    THERMAL_ID_PSU1 = 9,
    THERMAL_ID_BMC_ENV = 10,
    THERMAL_ID_ENV = 11,
    THERMAL_ID_FRONT_ENV = 12,
