...
#define XSFPX_SFPDD_NUM       (XSFPX_NUM+SFPDD_NUM)
#define PORT_NUM              (XSFPX_SFPDD_NUM+SFP_NUM)
...
#define IS_XSFPX(_node)       (_node.port_type == TYPE_QSFPDD || _node.port_type == TYPE_QSFP || _node.port_type == TYPE_OSFP)
...
// FPGA
#define FPGA_PCI_ENABLE_SYSFS "/sys/devices/platform/x86_64_ufispace_s9321_64eo_lpc/bsp/bsp_fpga_pci_enable"
...
static int get_node(int port, port_node_t *node)
{
    ...
    switch(port) {
        case 0:
            node->abs_sysfs = SYSFS_CPLD2 "cpld_osfp_intr_present_0";
            node->lpmode_sysfs = SYSFS_CPLD2 "cpld_osfp_lpmode_0";
            node->reset_sysfs = SYSFS_CPLD2 "cpld_osfp_reset_0";
            node->eeprom_bus = 17;
            node->port_type = TYPE_OSFP;
            node->cpld_bit = 0;
        ...
        case 7:
           ...
           break;
        case 8:
            node->abs_sysfs = SYSFS_CPLD2 "cpld_osfp_intr_present_1";
            node->lpmode_sysfs = SYSFS_CPLD2 "cpld_osfp_lpmode_1";
            node->reset_sysfs = SYSFS_CPLD2 "cpld_osfp_reset_1";
            node->eeprom_bus = 25;
            node->port_type = TYPE_OSFP;
            node->cpld_bit = 0;
            node->ctrl_addr = 0x1000;
        ...
        case 15:
           ...
           break;
        case 16:
            node->abs_sysfs = SYSFS_CPLD3 "cpld_osfp_intr_present_0";
            node->lpmode_sysfs = SYSFS_CPLD3 "cpld_osfp_lpmode_0";
            node->reset_sysfs = SYSFS_CPLD3 "cpld_osfp_reset_0";
            node->eeprom_bus = 49;
            node->port_type = TYPE_OSFP;
            node->cpld_bit = 0;
        ...
        case 23:
           ...
           break;
        case 24:
            node->abs_sysfs = SYSFS_CPLD3 "cpld_osfp_intr_present_1";
            node->lpmode_sysfs = SYSFS_CPLD3 "cpld_osfp_lpmode_1";
            node->reset_sysfs = SYSFS_CPLD3 "cpld_osfp_reset_1";
            node->eeprom_bus = 57;
            node->port_type = TYPE_OSFP;
            node->cpld_bit = 0;
            node->ctrl_addr = 0x3000;
        ...
        case 31:
           ...
           break;
        case 32:
            node->abs_sysfs = SYSFS_CPLD2 "cpld_osfp_intr_present_2";
            node->lpmode_sysfs = SYSFS_CPLD2 "cpld_osfp_lpmode_2";
            node->reset_sysfs = SYSFS_CPLD2 "cpld_osfp_reset_2";
            node->eeprom_bus = 33;
            node->port_type = TYPE_OSFP;
            node->cpld_bit = 0;
        ...
        case 39:
           ...
           break;
        case 40:
            node->abs_sysfs = SYSFS_CPLD2 "cpld_osfp_intr_present_3";
            node->lpmode_sysfs = SYSFS_CPLD2 "cpld_osfp_lpmode_3";
            node->reset_sysfs = SYSFS_CPLD2 "cpld_osfp_reset_3";
            node->eeprom_bus = 41;
            node->port_type = TYPE_OSFP;
            node->cpld_bit = 0;
            node->ctrl_addr = 0x2000;
        ...
        case 47:
           ...
           break;
        case 48:
            node->abs_sysfs = SYSFS_CPLD3 "cpld_osfp_intr_present_2";
            node->lpmode_sysfs = SYSFS_CPLD3 "cpld_osfp_lpmode_2";
            node->reset_sysfs = SYSFS_CPLD3 "cpld_osfp_reset_2";
            node->eeprom_bus = 65;
            node->port_type = TYPE_OSFP;
            node->cpld_bit = 0;
        ...
        case 55:
           ...
           break;
        case 56:
            node->abs_sysfs = SYSFS_CPLD3 "cpld_osfp_intr_present_3";
            node->lpmode_sysfs = SYSFS_CPLD3 "cpld_osfp_lpmode_3";
            node->reset_sysfs = SYSFS_CPLD3 "cpld_osfp_reset_3";
            node->eeprom_bus = 73;
            node->port_type = TYPE_OSFP;
            node->cpld_bit = 0;
            node->ctrl_addr = 0x4000;
...
int onlp_sfpi_dom_read(int port, uint8_t data[256])
{
    ...
    //qsfpdd/osfp 2.0 dom is on lower page 0x00
    //qsfpdd/osfp 3.0 and later dom and above is on lower page 0x00 and higher page 0x17
    ONLP_TRY(get_node(port, &node));
