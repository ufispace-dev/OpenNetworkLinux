...
SYSFS_LPC="/sys/bus/platform/devices/x86_64_ufispace_s9321_64eo_lpc"
...
function _update_gpio_max {
    ...
    GPIO_MAX=$(cat /sys/devices/platform/x86_64_ufispace_s9321_64eo_lpc/bsp/bsp_gpio_max)
...
function _update_fpga_pci_enable {
    ...
    FPGA_PCI_ENABLE=$(cat /sys/devices/platform/x86_64_ufispace_s9321_64eo_lpc/bsp/bsp_fpga_pci_enable)
...
function _check_bsp_init {
    ...
    if [ -f "/sys/devices/platform/x86_64_ufispace_s9321_64eo_lpc/bsp/bsp_gpio_max" ]; then
        BSP_INIT_FLAG=1
    else
        BSP_INIT_FLAG=0
    fi
...
function _show_board_info {
    ...
    model_id_array=($((2#00100101)))
    model_name_array=("S9321-64EO")
    model_name=""
            ...
            if _check_filepath "/sys/bus/i2c/devices/${bus_id}-0030/cpld_mac_rov" ;then
                ...
                if [ -c "/dev/i2c-${rov_i2c_bus}" ]; then
                    ...
                    do
                        ...
                        rov_controller_output_volt=$(ipmitool sdr get -c ADC2_CORE_VDDC  | cut -d , -f 2)
...
function _eeprom_pages_dump {
    ...
    if [ "${type}" !=  "${PORT_T_QSFPDD}" ] && [ "${type}" !=  "${PORT_T_QSFP}" ] && [ "${type}" !=  "${PORT_T_OSFP}" ]; then
        # Only support QSFP & QSFPDD & OSFP
        return 0
    fi
...
function _show_port_status_sysfs {
    ...
    case $PLAT in
        *$MODEL_NAME* )
            ...
            sys_port_array=(
                                "${SYSFS_CPLD2}/cpld_osfp_intr_present_0"            #0
                                "${SYSFS_CPLD2}/cpld_osfp_intr_present_1"            #1
                                "${SYSFS_CPLD3}/cpld_osfp_intr_present_0"            #2
                                "${SYSFS_CPLD3}/cpld_osfp_intr_present_1"            #3
                                "${SYSFS_CPLD2}/cpld_osfp_intr_present_2"            #4
                                "${SYSFS_CPLD2}/cpld_osfp_intr_present_3"            #5
                                "${SYSFS_CPLD3}/cpld_osfp_intr_present_2"            #6
                                "${SYSFS_CPLD3}/cpld_osfp_intr_present_3"            #7
                                "${SYSFS_FPGA}/fpga_sfp28_intr_present"              #8
                                "${SYSFS_FPGA}/fpga_sfp28_rx_los"                    #9
                                "${SYSFS_FPGA}/fpga_sfp28_tx_fault"                  #10
                                "${SYSFS_CPLD2}/cpld_osfp_reset_0"                   #11
                                "${SYSFS_CPLD2}/cpld_osfp_reset_1"                   #12
                                "${SYSFS_CPLD3}/cpld_osfp_reset_0"                   #13
                                "${SYSFS_CPLD3}/cpld_osfp_reset_1"                   #14
                                "${SYSFS_CPLD2}/cpld_osfp_reset_2"                   #15
                                "${SYSFS_CPLD2}/cpld_osfp_reset_3"                   #16
                                "${SYSFS_CPLD3}/cpld_osfp_reset_2"                   #17
                                "${SYSFS_CPLD3}/cpld_osfp_reset_3"                   #18
                                "${SYSFS_CPLD2}/cpld_osfp_lpmode_0"                  #19
                                "${SYSFS_CPLD2}/cpld_osfp_lpmode_1"                  #20
                                "${SYSFS_CPLD3}/cpld_osfp_lpmode_0"                  #21
                                "${SYSFS_CPLD3}/cpld_osfp_lpmode_1"                  #22
                                "${SYSFS_CPLD2}/cpld_osfp_lpmode_2"                  #23
                                "${SYSFS_CPLD2}/cpld_osfp_lpmode_3"                  #24
                                "${SYSFS_CPLD3}/cpld_osfp_lpmode_2"                  #25
                                "${SYSFS_CPLD3}/cpld_osfp_lpmode_3"                  #26
                                "${SYSFS_FPGA}/fpga_sfp28_tx_dis"                    #27
                                "${SYSFS_CPLD2}/cpld_osfp_intr_port_0"               #28
                                "${SYSFS_CPLD2}/cpld_osfp_intr_port_1"               #29
                                "${SYSFS_CPLD3}/cpld_osfp_intr_port_0"               #30
                                "${SYSFS_CPLD3}/cpld_osfp_intr_port_1"               #31
                                "${SYSFS_CPLD2}/cpld_osfp_intr_port_2"               #32
                                "${SYSFS_CPLD2}/cpld_osfp_intr_port_3"               #33
                                "${SYSFS_CPLD3}/cpld_osfp_intr_port_2"               #34
                                "${SYSFS_CPLD3}/cpld_osfp_intr_port_3"               #35
...
function _show_cpld_interrupt_sysfs {
    ...
    case $PLAT in
        *$MODEL_NAME* )
            ...
            sysfs_array=("cpld_osfp_intr_port" "cpld_osfp_intr_present" "cpld_osfp_intr_fuse")
            sysfs_desc_array=("OSFP Port" "OSFP Present" "OSFP Fuse")
            # MB CPLD Interrupt
            # CPLD 1
...
function _show_system_led_sysfs {
    ...
    case $PLAT in
        *$MODEL_NAME* )
            local sysfs_attr=(
                "cpld_system_led_sync"    #0
                "cpld_system_led_sys"     #1
                "cpld_system_led_fan"     #2
                "cpld_system_led_psu_0"   #3
                "cpld_system_led_psu_1"   #4
