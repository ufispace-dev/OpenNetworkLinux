/*
 * A lpc driver for the ufispace_s9310_32d
 *
...
#define REG_MB_MUX_RESET                  (REG_BASE_MB + 0x22)
#define REG_MB_MUX_CTRL                   (REG_BASE_MB + 0x42)
...
MODULE_DESCRIPTION("x86_64_ufispace_s9310_32d_lpc driver");
MODULE_LICENSE("GPL");
