...
#define PSU_FAN_RPM_MAX_AC       33000
#define PSU_FAN_RPM_MAX_DC       33000
...
onlp_fan_info_t fan_info[] = {
    ...
    {
        .hdr = {
            .id = ONLP_FAN_ID_CREATE(ONLP_PSU_0_FAN1),
    ...
    {
        .hdr = {
            .id = ONLP_FAN_ID_CREATE(ONLP_PSU_1_FAN1),
...
static int get_node(int id, fan_node_t *node)
{
    ...
    switch(node->local_id) {
        case ONLP_FAN_0_F:
            ...
            node->rpm = BMC_ATTR_ID_FAN0_RPM_FRONT;
        ...
        case ONLP_FAN_0_R:
            node->present = BMC_ATTR_ID_FAN0_PRSNT_L;
            node->rpm = BMC_ATTR_ID_FAN0_RPM_REAR;
            node->dir = BMC_OEM_IDX_INVALID;
            node->fru_id = BMC_FRU_IDX_FAN_TRAY_0;
            node->type = TYPE_FANTRAY;
        ...
        case ONLP_FAN_1_F:
            ...
            node->rpm = BMC_ATTR_ID_FAN1_RPM_FRONT;
            node->dir = BMC_OEM_IDX_INVALID;
        ...
        case ONLP_FAN_1_R:
            node->present = BMC_ATTR_ID_FAN1_PRSNT_L;
            node->rpm = BMC_ATTR_ID_FAN1_RPM_REAR;
            node->dir = BMC_OEM_IDX_INVALID;
            node->fru_id = BMC_FRU_IDX_FAN_TRAY_1;
            node->type = TYPE_FANTRAY;
            node->max_rpm1 = SYS_FAN_REAR_MAX_RPM;
        ...
        case ONLP_FAN_2_F:
            ...
            node->rpm = BMC_ATTR_ID_FAN2_RPM_FRONT;
            node->dir = BMC_OEM_IDX_INVALID;
        ...
        case ONLP_FAN_2_R:
            node->present = BMC_ATTR_ID_FAN2_PRSNT_L;
            node->rpm = BMC_ATTR_ID_FAN2_RPM_REAR;
            node->dir = BMC_OEM_IDX_INVALID;
            node->fru_id = BMC_FRU_IDX_FAN_TRAY_2;
            node->type = TYPE_FANTRAY;
            node->max_rpm1 = SYS_FAN_REAR_MAX_RPM;
        ...
        case ONLP_FAN_3_F:
            ...
            node->rpm = BMC_ATTR_ID_FAN3_RPM_FRONT;
            node->dir = BMC_OEM_IDX_INVALID;
        ...
        case ONLP_FAN_3_R:
            node->present = BMC_ATTR_ID_FAN3_PRSNT_L;
            node->rpm = BMC_ATTR_ID_FAN3_RPM_REAR;
            node->dir = BMC_OEM_IDX_INVALID;
            node->fru_id = BMC_FRU_IDX_FAN_TRAY_3;
            node->type = TYPE_FANTRAY;
            node->max_rpm1 = SYS_FAN_REAR_MAX_RPM;
           ...
           node->rpm = BMC_ATTR_ID_FAN4_RPM_FRONT;
           node->dir = BMC_OEM_IDX_INVALID;
       ...
       case ONLP_FAN_4_R:
           node->present = BMC_ATTR_ID_FAN4_PRSNT_L;
           node->rpm = BMC_ATTR_ID_FAN4_RPM_REAR;
           node->dir = BMC_OEM_IDX_INVALID;
           node->fru_id = BMC_FRU_IDX_FAN_TRAY_4;
           node->type = TYPE_FANTRAY;
           node->max_rpm1 = SYS_FAN_REAR_MAX_RPM;
          break;
        case ONLP_PSU_0_FAN1:
