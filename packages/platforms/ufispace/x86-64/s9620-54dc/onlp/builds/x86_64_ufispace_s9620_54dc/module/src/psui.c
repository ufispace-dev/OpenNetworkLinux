...
static onlp_psu_info_t psu_info[] =
{
    { }, /* Not used */
    {
        .hdr = {
            ...
            .poid = POID_0,
            .coids = {
                ONLP_FAN_ID_CREATE(ONLP_PSU_0_FAN1),
    ...
    },
    {
        .hdr = {
            ...
            .poid = POID_0,
            .coids = {
                ONLP_FAN_ID_CREATE(ONLP_PSU_1_FAN1),
...
static psu_support_info_t psu_support_list[] =
{
    ...
    {"FSPGROUP", "YNEE0750HM-2A01P10", ONLP_PSU_TYPE_AC  , ONLP_FAN_STATUS_F2B},
    {"FSPGROUP", "YNEE0750JM-2A01N01", ONLP_PSU_TYPE_DC48, ONLP_FAN_STATUS_F2B}
};
