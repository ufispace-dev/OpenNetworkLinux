...
// FPGA
#define FPGA_PCI_ENABLE_SYSFS "/sys/devices/platform/x86_64_ufispace_s9620_54dc_lpc/bsp/bsp_fpga_pci_enable"
#define FPGA_RESOURCE "/sys/devices/pci0000:00/0000:00:14.0/0000:06:00.0/resource4"
...
static int get_node(int port, port_node_t *node)
{
    ...
    switch(port) {
        case 0:
            node->abs_sysfs = SYSFS_CPLD2 "sfp28_p0_abs";
            node->rxlos_sysfs = SYSFS_CPLD2 "sfp28_p0_rx_los";
            node->txfault_sysfs = SYSFS_CPLD2 "sfp28_p0_tx_flt";
            node->txdis_sysfs = SYSFS_CPLD2 "sfp28_p0_tx_dis";
            node->eeprom_bus = 18;
            ...
            break;
        case 1:
            node->abs_sysfs = SYSFS_CPLD2 "sfp28_p1_abs";
            node->rxlos_sysfs = SYSFS_CPLD2 "sfp28_p1_rx_los";
            node->txfault_sysfs = SYSFS_CPLD2 "sfp28_p1_tx_flt";
            node->txdis_sysfs = SYSFS_CPLD2 "sfp28_p1_tx_dis";
            node->eeprom_bus = 19;
            node->port_type = TYPE_SFP;
            node->cpld_bit = 1;
            node->ctrl_addr = 0x1000;
            ...
            break;
        case 2:
            node->abs_sysfs = SYSFS_CPLD2 "sfp28_p2_abs";
            node->rxlos_sysfs = SYSFS_CPLD2 "sfp28_p2_rx_los";
            node->txfault_sysfs = SYSFS_CPLD2 "sfp28_p2_tx_flt";
            node->txdis_sysfs = SYSFS_CPLD2 "sfp28_p2_tx_dis";
            node->eeprom_bus = 20;
            node->port_type = TYPE_SFP;
            node->cpld_bit = 2;
            node->ctrl_addr = 0x1000;
            ...
            break;
        case 3:
            node->abs_sysfs = SYSFS_CPLD2 "sfp28_p3_abs";
            node->rxlos_sysfs = SYSFS_CPLD2 "sfp28_p3_rx_los";
            node->txfault_sysfs = SYSFS_CPLD2 "sfp28_p3_tx_flt";
            node->txdis_sysfs = SYSFS_CPLD2 "sfp28_p3_tx_dis";
            node->eeprom_bus = 21;
            node->port_type = TYPE_SFP;
            node->cpld_bit = 3;
            node->ctrl_addr = 0x1000;
            ...
            break;
        case 4:
            node->abs_sysfs = SYSFS_CPLD2 "sfp28_p4_abs";
            node->rxlos_sysfs = SYSFS_CPLD2 "sfp28_p4_rx_los";
            node->txfault_sysfs = SYSFS_CPLD2 "sfp28_p4_tx_flt";
            node->txdis_sysfs = SYSFS_CPLD2 "sfp28_p4_tx_dis";
            node->eeprom_bus = 22;
            node->port_type = TYPE_SFP;
            node->cpld_bit = 4;
            node->ctrl_addr = 0x1000;
            ...
            break;
        case 5:
            node->abs_sysfs = SYSFS_CPLD2 "sfp28_p5_abs";
            node->rxlos_sysfs = SYSFS_CPLD2 "sfp28_p5_rx_los";
            node->txfault_sysfs = SYSFS_CPLD2 "sfp28_p5_tx_flt";
            node->txdis_sysfs = SYSFS_CPLD2 "sfp28_p5_tx_dis";
            node->eeprom_bus = 23;
            node->port_type = TYPE_SFP;
            node->cpld_bit = 5;
            node->ctrl_addr = 0x1000;
            ...
            break;
        case 6:
            node->abs_sysfs = SYSFS_CPLD2 "sfp28_p6_abs";
            node->rxlos_sysfs = SYSFS_CPLD2 "sfp28_p6_rx_los";
            node->txfault_sysfs = SYSFS_CPLD2 "sfp28_p6_tx_flt";
            node->txdis_sysfs = SYSFS_CPLD2 "sfp28_p6_tx_dis";
            node->eeprom_bus = 24;
            node->port_type = TYPE_SFP;
            node->cpld_bit = 6;
            node->ctrl_addr = 0x1000;
            ...
            break;
        case 7:
            node->abs_sysfs = SYSFS_CPLD2 "sfp28_p7_abs";
            node->rxlos_sysfs = SYSFS_CPLD2 "sfp28_p7_rx_los";
            node->txfault_sysfs = SYSFS_CPLD2 "sfp28_p7_tx_flt";
            node->txdis_sysfs = SYSFS_CPLD2 "sfp28_p7_tx_dis";
            node->eeprom_bus = 25;
            node->port_type = TYPE_SFP;
            node->cpld_bit = 7;
            node->ctrl_addr = 0x1000;
            ...
            break;
        case 8:
            node->abs_sysfs = SYSFS_CPLD2 "sfp28_p8_abs";
            node->rxlos_sysfs = SYSFS_CPLD2 "sfp28_p8_rx_los";
            node->txfault_sysfs = SYSFS_CPLD2 "sfp28_p8_tx_flt";
            node->txdis_sysfs = SYSFS_CPLD2 "sfp28_p8_tx_dis";
            node->eeprom_bus = 26;
            node->port_type = TYPE_SFP;
            node->cpld_bit = 0;
            node->ctrl_addr = 0x1000;
            ...
            break;
        case 9:
            node->abs_sysfs = SYSFS_CPLD2 "sfp28_p9_abs";
            node->rxlos_sysfs = SYSFS_CPLD2 "sfp28_p9_rx_los";
            node->txfault_sysfs = SYSFS_CPLD2 "sfp28_p9_tx_flt";
            node->txdis_sysfs = SYSFS_CPLD2 "sfp28_p9_tx_dis";
            node->eeprom_bus = 27;
            node->port_type = TYPE_SFP;
            node->cpld_bit = 1;
            node->ctrl_addr = 0x1000;
            ...
            break;
        case 10:
            node->abs_sysfs = SYSFS_CPLD2 "sfp28_p10_abs";
            node->rxlos_sysfs = SYSFS_CPLD2 "sfp28_p10_rx_los";
            node->txfault_sysfs = SYSFS_CPLD2 "sfp28_p10_tx_flt";
            node->txdis_sysfs = SYSFS_CPLD2 "sfp28_p10_tx_dis";
            node->eeprom_bus = 28;
            node->port_type = TYPE_SFP;
            node->cpld_bit = 2;
            node->ctrl_addr = 0x1000;
            ...
            break;
        case 11:
            node->abs_sysfs = SYSFS_CPLD2 "sfp28_p11_abs";
            node->rxlos_sysfs = SYSFS_CPLD2 "sfp28_p11_rx_los";
            node->txfault_sysfs = SYSFS_CPLD2 "sfp28_p11_tx_flt";
            node->txdis_sysfs = SYSFS_CPLD2 "sfp28_p11_tx_dis";
            node->eeprom_bus = 29;
            node->port_type = TYPE_SFP;
            node->cpld_bit = 3;
            node->ctrl_addr = 0x1000;
            ...
            break;
        case 12:
            node->abs_sysfs = SYSFS_CPLD2 "sfp28_p12_abs";
            node->rxlos_sysfs = SYSFS_CPLD2 "sfp28_p12_rx_los";
            node->txfault_sysfs = SYSFS_CPLD2 "sfp28_p12_tx_flt";
            node->txdis_sysfs = SYSFS_CPLD2 "sfp28_p12_tx_dis";
            node->eeprom_bus = 30;
            node->port_type = TYPE_SFP;
            node->cpld_bit = 4;
            node->ctrl_addr = 0x1000;
            ...
            break;
        case 13:
            node->abs_sysfs = SYSFS_CPLD2 "sfp28_p13_abs";
            node->rxlos_sysfs = SYSFS_CPLD2 "sfp28_p13_rx_los";
            node->txfault_sysfs = SYSFS_CPLD2 "sfp28_p13_tx_flt";
            node->txdis_sysfs = SYSFS_CPLD2 "sfp28_p13_tx_dis";
            node->eeprom_bus = 31;
            node->port_type = TYPE_SFP;
            node->cpld_bit = 5;
            node->ctrl_addr = 0x1000;
            ...
            break;
        case 14:
            node->abs_sysfs = SYSFS_CPLD2 "sfp28_p14_abs";
            node->rxlos_sysfs = SYSFS_CPLD2 "sfp28_p14_rx_los";
            node->txfault_sysfs = SYSFS_CPLD2 "sfp28_p14_tx_flt";
            node->txdis_sysfs = SYSFS_CPLD2 "sfp28_p14_tx_dis";
            node->eeprom_bus = 32;
            node->port_type = TYPE_SFP;
            node->cpld_bit = 6;
            node->ctrl_addr = 0x1000;
            ...
            break;
        case 15:
            node->abs_sysfs = SYSFS_CPLD2 "sfp28_p15_abs";
            node->rxlos_sysfs = SYSFS_CPLD2 "sfp28_p15_rx_los";
            node->txfault_sysfs = SYSFS_CPLD2 "sfp28_p15_tx_flt";
            node->txdis_sysfs = SYSFS_CPLD2 "sfp28_p15_tx_dis";
            node->eeprom_bus = 33;
            node->port_type = TYPE_SFP;
            node->cpld_bit = 7;
            node->ctrl_addr = 0x1000;
            ...
            break;
        case 16:
            node->abs_sysfs = SYSFS_CPLD2 "sfp28_p16_abs";
            node->rxlos_sysfs = SYSFS_CPLD2 "sfp28_p16_rx_los";
            node->txfault_sysfs = SYSFS_CPLD2 "sfp28_p16_tx_flt";
            node->txdis_sysfs = SYSFS_CPLD2 "sfp28_p16_tx_dis";
            node->eeprom_bus = 34;
            node->port_type = TYPE_SFP;
            node->cpld_bit = 0;
            ...
            break;
        case 17:
            node->abs_sysfs = SYSFS_CPLD2 "sfp28_p17_abs";
            node->rxlos_sysfs = SYSFS_CPLD2 "sfp28_p17_rx_los";
            node->txfault_sysfs = SYSFS_CPLD2 "sfp28_p17_tx_flt";
            node->txdis_sysfs = SYSFS_CPLD2 "sfp28_p17_tx_dis";
            node->eeprom_bus = 35;
            node->port_type = TYPE_SFP;
            node->cpld_bit = 1;
            node->ctrl_addr = 0x2000;
            ...
            break;
        case 18:
            node->abs_sysfs = SYSFS_CPLD2 "sfp28_p18_abs";
            node->rxlos_sysfs = SYSFS_CPLD2 "sfp28_p18_rx_los";
            node->txfault_sysfs = SYSFS_CPLD2 "sfp28_p18_tx_flt";
            node->txdis_sysfs = SYSFS_CPLD2 "sfp28_p18_tx_dis";
            node->eeprom_bus = 36;
            node->port_type = TYPE_SFP;
            node->cpld_bit = 2;
            node->ctrl_addr = 0x2000;
            ...
            break;
        case 19:
            node->abs_sysfs = SYSFS_CPLD2 "sfp28_p19_abs";
            node->rxlos_sysfs = SYSFS_CPLD2 "sfp28_p19_rx_los";
            node->txfault_sysfs = SYSFS_CPLD2 "sfp28_p19_tx_flt";
            node->txdis_sysfs = SYSFS_CPLD2 "sfp28_p19_tx_dis";
            node->eeprom_bus = 37;
            node->port_type = TYPE_SFP;
            node->cpld_bit = 3;
            node->ctrl_addr = 0x2000;
            ...
            break;
        case 20:
            node->abs_sysfs = SYSFS_CPLD2 "sfp28_p20_abs";
            node->rxlos_sysfs = SYSFS_CPLD2 "sfp28_p20_rx_los";
            node->txfault_sysfs = SYSFS_CPLD2 "sfp28_p20_tx_flt";
            node->txdis_sysfs = SYSFS_CPLD2 "sfp28_p20_tx_dis";
            node->eeprom_bus = 38;
            node->port_type = TYPE_SFP;
            node->cpld_bit = 4;
            node->ctrl_addr = 0x2000;
            ...
            break;
        case 21:
            node->abs_sysfs = SYSFS_CPLD2 "sfp28_p21_abs";
            node->rxlos_sysfs = SYSFS_CPLD2 "sfp28_p21_rx_los";
            node->txfault_sysfs = SYSFS_CPLD2 "sfp28_p21_tx_flt";
            node->txdis_sysfs = SYSFS_CPLD2 "sfp28_p21_tx_dis";
            node->eeprom_bus = 39;
            node->port_type = TYPE_SFP;
            node->cpld_bit = 5;
            node->ctrl_addr = 0x2000;
            ...
            break;
        case 22:
            node->abs_sysfs = SYSFS_CPLD2 "sfp28_p22_abs";
            node->rxlos_sysfs = SYSFS_CPLD2 "sfp28_p22_rx_los";
            node->txfault_sysfs = SYSFS_CPLD2 "sfp28_p22_tx_flt";
            node->txdis_sysfs = SYSFS_CPLD2 "sfp28_p22_tx_dis";
            node->eeprom_bus = 40;
            node->port_type = TYPE_SFP;
            node->cpld_bit = 6;
            node->ctrl_addr = 0x2000;
            ...
            break;
        case 23:
            node->abs_sysfs = SYSFS_CPLD2 "sfp28_p23_abs";
            node->rxlos_sysfs = SYSFS_CPLD2 "sfp28_p23_rx_los";
            node->txfault_sysfs = SYSFS_CPLD2 "sfp28_p23_tx_flt";
            node->txdis_sysfs = SYSFS_CPLD2 "sfp28_p23_tx_dis";
            node->eeprom_bus = 41;
            node->port_type = TYPE_SFP;
            node->cpld_bit = 7;
            node->ctrl_addr = 0x2000;
            ...
            break;
        case 24:
            node->abs_sysfs = SYSFS_CPLD2 "sfp28_p24_abs";
            node->rxlos_sysfs = SYSFS_CPLD2 "sfp28_p24_rx_los";
            node->txfault_sysfs = SYSFS_CPLD2 "sfp28_p24_tx_flt";
            node->txdis_sysfs = SYSFS_CPLD2 "sfp28_p24_tx_dis";
            node->eeprom_bus = 42;
            node->port_type = TYPE_SFP;
            node->cpld_bit = 0;
            node->ctrl_addr = 0x2000;
            ...
            break;
        case 25:
            node->abs_sysfs = SYSFS_CPLD2 "sfp28_p25_abs";
            node->rxlos_sysfs = SYSFS_CPLD2 "sfp28_p25_rx_los";
            node->txfault_sysfs = SYSFS_CPLD2 "sfp28_p25_tx_flt";
            node->txdis_sysfs = SYSFS_CPLD2 "sfp28_p25_tx_dis";
            node->eeprom_bus = 43;
            node->port_type = TYPE_SFP;
            node->cpld_bit = 1;
            node->ctrl_addr = 0x2000;
            ...
            break;
        case 26:
            node->abs_sysfs = SYSFS_CPLD2 "sfp28_p26_abs";
            node->rxlos_sysfs = SYSFS_CPLD2 "sfp28_p26_rx_los";
            node->txfault_sysfs = SYSFS_CPLD2 "sfp28_p26_tx_flt";
            node->txdis_sysfs = SYSFS_CPLD2 "sfp28_p26_tx_dis";
            node->eeprom_bus = 44;
            node->port_type = TYPE_SFP;
            node->cpld_bit = 2;
            node->ctrl_addr = 0x2000;
            ...
            break;
        case 27:
            node->abs_sysfs = SYSFS_CPLD2 "sfp28_p27_abs";
            node->rxlos_sysfs = SYSFS_CPLD2 "sfp28_p27_rx_los";
            node->txfault_sysfs = SYSFS_CPLD2 "sfp28_p27_tx_flt";
            node->txdis_sysfs = SYSFS_CPLD2 "sfp28_p27_tx_dis";
            node->eeprom_bus = 45;
            node->port_type = TYPE_SFP;
            node->cpld_bit = 3;
            node->ctrl_addr = 0x2000;
            ...
            break;
        case 28:
            node->abs_sysfs = SYSFS_CPLD3 "sfp28_p28_abs";
            node->rxlos_sysfs = SYSFS_CPLD3 "sfp28_p28_rx_los";
            node->txfault_sysfs = SYSFS_CPLD3 "sfp28_p28_tx_flt";
            node->txdis_sysfs = SYSFS_CPLD3 "sfp28_p28_tx_dis";
            node->eeprom_bus = 46;
            node->port_type = TYPE_SFP;
            node->cpld_bit = 0;
            ...
            break;
        case 29:
            node->abs_sysfs = SYSFS_CPLD3 "sfp28_p29_abs";
            node->rxlos_sysfs = SYSFS_CPLD3 "sfp28_p29_rx_los";
            node->txfault_sysfs = SYSFS_CPLD3 "sfp28_p29_tx_flt";
            node->txdis_sysfs = SYSFS_CPLD3 "sfp28_p29_tx_dis";
            node->eeprom_bus = 47;
            node->port_type = TYPE_SFP;
            node->cpld_bit = 1;
            node->ctrl_addr = 0x3000;
            ...
            break;
        case 30:
            node->abs_sysfs = SYSFS_CPLD3 "sfp28_p30_abs";
            node->rxlos_sysfs = SYSFS_CPLD3 "sfp28_p30_rx_los";
            node->txfault_sysfs = SYSFS_CPLD3 "sfp28_p30_tx_flt";
            node->txdis_sysfs = SYSFS_CPLD3 "sfp28_p30_tx_dis";
            node->eeprom_bus = 48;
            node->port_type = TYPE_SFP;
            node->cpld_bit = 2;
            node->ctrl_addr = 0x3000;
            ...
            break;
        case 31:
            node->abs_sysfs = SYSFS_CPLD3 "sfp28_p31_abs";
            node->rxlos_sysfs = SYSFS_CPLD3 "sfp28_p31_rx_los";
            node->txfault_sysfs = SYSFS_CPLD3 "sfp28_p31_tx_flt";
            node->txdis_sysfs = SYSFS_CPLD3 "sfp28_p31_tx_dis";
            node->eeprom_bus = 49;
            node->port_type = TYPE_SFP;
            node->cpld_bit = 3;
            node->ctrl_addr = 0x3000;
            ...
            break;
        case 32:
            node->abs_sysfs = SYSFS_CPLD3 "sfp28_p32_abs";
            node->rxlos_sysfs = SYSFS_CPLD3 "sfp28_p32_rx_los";
            node->txfault_sysfs = SYSFS_CPLD3 "sfp28_p32_tx_flt";
            node->txdis_sysfs = SYSFS_CPLD3 "sfp28_p32_tx_dis";
            node->eeprom_bus = 50;
            node->port_type = TYPE_SFP;
            node->cpld_bit = 4;
            node->ctrl_addr = 0x3000;
            ...
            break;
        case 33:
            node->abs_sysfs = SYSFS_CPLD3 "sfp28_p33_abs";
            node->rxlos_sysfs = SYSFS_CPLD3 "sfp28_p33_rx_los";
            node->txfault_sysfs = SYSFS_CPLD3 "sfp28_p33_tx_flt";
            node->txdis_sysfs = SYSFS_CPLD3 "sfp28_p33_tx_dis";
            node->eeprom_bus = 51;
            node->port_type = TYPE_SFP;
            node->cpld_bit = 5;
            node->ctrl_addr = 0x3000;
            ...
            break;
        case 34:
            node->abs_sysfs = SYSFS_CPLD3 "sfp28_p34_abs";
            node->rxlos_sysfs = SYSFS_CPLD3 "sfp28_p34_rx_los";
            node->txfault_sysfs = SYSFS_CPLD3 "sfp28_p34_tx_flt";
            node->txdis_sysfs = SYSFS_CPLD3 "sfp28_p34_tx_dis";
            node->eeprom_bus = 52;
            node->port_type = TYPE_SFP;
            node->cpld_bit = 6;
            node->ctrl_addr = 0x3000;
            ...
            break;
        case 35:
            node->abs_sysfs = SYSFS_CPLD3 "sfp28_p35_abs";
            node->rxlos_sysfs = SYSFS_CPLD3 "sfp28_p35_rx_los";
            node->txfault_sysfs = SYSFS_CPLD3 "sfp28_p35_tx_flt";
            node->txdis_sysfs = SYSFS_CPLD3 "sfp28_p35_tx_dis";
            node->eeprom_bus = 53;
            node->port_type = TYPE_SFP;
            node->cpld_bit = 7;
            node->ctrl_addr = 0x3000;
            ...
            break;
        case 36:
            node->abs_sysfs = SYSFS_CPLD3 "sfp28_p36_abs";
            node->rxlos_sysfs = SYSFS_CPLD3 "sfp28_p36_rx_los";
            node->txfault_sysfs = SYSFS_CPLD3 "sfp28_p36_tx_flt";
            node->txdis_sysfs = SYSFS_CPLD3 "sfp28_p36_tx_dis";
            node->eeprom_bus = 54;
            node->port_type = TYPE_SFP;
            node->cpld_bit = 0;
            node->ctrl_addr = 0x3000;
            ...
            break;
        case 37:
            node->abs_sysfs = SYSFS_CPLD3 "sfp28_p37_abs";
            node->rxlos_sysfs = SYSFS_CPLD3 "sfp28_p37_rx_los";
            node->txfault_sysfs = SYSFS_CPLD3 "sfp28_p37_tx_flt";
            node->txdis_sysfs = SYSFS_CPLD3 "sfp28_p37_tx_dis";
            node->eeprom_bus = 55;
            node->port_type = TYPE_SFP;
            node->cpld_bit = 1;
            node->ctrl_addr = 0x3000;
            ...
            break;
        case 38:
            node->abs_sysfs = SYSFS_CPLD3 "sfp28_p38_abs";
            node->rxlos_sysfs = SYSFS_CPLD3 "sfp28_p38_rx_los";
            node->txfault_sysfs = SYSFS_CPLD3 "sfp28_p38_tx_flt";
            node->txdis_sysfs = SYSFS_CPLD3 "sfp28_p38_tx_dis";
            node->eeprom_bus = 56;
            node->port_type = TYPE_SFP;
            node->cpld_bit = 2;
            node->ctrl_addr = 0x3000;
            ...
            break;
        case 39:
            node->abs_sysfs = SYSFS_CPLD3 "sfp28_p39_abs";
            node->rxlos_sysfs = SYSFS_CPLD3 "sfp28_p39_rx_los";
            node->txfault_sysfs = SYSFS_CPLD3 "sfp28_p39_tx_flt";
            node->txdis_sysfs = SYSFS_CPLD3 "sfp28_p39_tx_dis";
            node->eeprom_bus = 57;
            node->port_type = TYPE_SFP;
            node->cpld_bit = 3;
            node->ctrl_addr = 0x3000;
            ...
            break;
        case 40:
            node->abs_sysfs = SYSFS_CPLD3 "sfp56_p40_abs";
            node->rxlos_sysfs = SYSFS_CPLD3 "sfp56_p40_rx_los";
            node->txfault_sysfs = SYSFS_CPLD3 "sfp56_p40_tx_flt";
            node->txdis_sysfs = SYSFS_CPLD3 "sfp56_p40_tx_dis";
            node->eeprom_bus = 58;
            node->port_type = TYPE_SFP;
            node->cpld_bit = 4;
            node->ctrl_addr = 0x3000;
            ...
            break;
        case 41:
            node->abs_sysfs = SYSFS_CPLD3 "sfp56_p41_abs";
            node->rxlos_sysfs = SYSFS_CPLD3 "sfp56_p41_rx_los";
            node->txfault_sysfs = SYSFS_CPLD3 "sfp56_p41_tx_flt";
            node->txdis_sysfs = SYSFS_CPLD3 "sfp56_p41_tx_dis";
            node->eeprom_bus = 59;
            node->port_type = TYPE_SFP;
            node->cpld_bit = 5;
            node->ctrl_addr = 0x3000;
            ...
            break;
        case 42:
            node->abs_sysfs = SYSFS_CPLD3 "sfp56_p42_abs";
            node->rxlos_sysfs = SYSFS_CPLD3 "sfp56_p42_rx_los";
            node->txfault_sysfs = SYSFS_CPLD3 "sfp56_p42_tx_flt";
            node->txdis_sysfs = SYSFS_CPLD3 "sfp56_p42_tx_dis";
            node->eeprom_bus = 60;
            node->port_type = TYPE_SFP;
            node->cpld_bit = 6;
            node->ctrl_addr = 0x3000;
            ...
            break;
        case 43:
            node->abs_sysfs = SYSFS_CPLD3 "sfp56_p43_abs";
            node->rxlos_sysfs = SYSFS_CPLD3 "sfp56_p43_rx_los";
            node->txfault_sysfs = SYSFS_CPLD3 "sfp56_p43_tx_flt";
            node->txdis_sysfs = SYSFS_CPLD3 "sfp56_p43_tx_dis";
            node->eeprom_bus = 61;
            node->port_type = TYPE_SFP;
            node->cpld_bit = 7;
            node->ctrl_addr = 0x3000;
            ...
            break;
        case 44:
            node->abs_sysfs = SYSFS_CPLD3 "sfp56_p44_abs";
            node->rxlos_sysfs = SYSFS_CPLD3 "sfp56_p44_rx_los";
            node->txfault_sysfs = SYSFS_CPLD3 "sfp56_p44_tx_flt";
            node->txdis_sysfs = SYSFS_CPLD3 "sfp56_p44_tx_dis";
            node->eeprom_bus = 62;
            node->port_type = TYPE_SFP;
            node->cpld_bit = 0;
            ...
            break;
        case 45:
            node->abs_sysfs = SYSFS_CPLD3 "sfp56_p45_abs";
            node->rxlos_sysfs = SYSFS_CPLD3 "sfp56_p45_rx_los";
            node->txfault_sysfs = SYSFS_CPLD3 "sfp56_p45_tx_flt";
            node->txdis_sysfs = SYSFS_CPLD3 "sfp56_p45_tx_dis";
            node->eeprom_bus = 63;
            node->port_type = TYPE_SFP;
            node->cpld_bit = 1;
            node->ctrl_addr = 0x4000;
            ...
            break;
        case 46:
            node->abs_sysfs = SYSFS_CPLD3 "sfp56_p46_abs";
            node->rxlos_sysfs = SYSFS_CPLD3 "sfp56_p46_rx_los";
            node->txfault_sysfs = SYSFS_CPLD3 "sfp56_p46_tx_flt";
            node->txdis_sysfs = SYSFS_CPLD3 "sfp56_p46_tx_dis";
            node->eeprom_bus = 64;
            node->port_type = TYPE_SFP;
            node->cpld_bit = 2;
            node->ctrl_addr = 0x4000;
            ...
            break;
        case 47:
            node->abs_sysfs = SYSFS_CPLD3 "sfp56_p47_abs";
            node->rxlos_sysfs = SYSFS_CPLD3 "sfp56_p47_rx_los";
            node->txfault_sysfs = SYSFS_CPLD3 "sfp56_p47_tx_flt";
            node->txdis_sysfs = SYSFS_CPLD3 "sfp56_p47_tx_dis";
            node->eeprom_bus = 65;
            node->port_type = TYPE_SFP;
            node->cpld_bit = 3;
            node->ctrl_addr = 0x4000;
            ...
            break;
        case 48:
            node->abs_sysfs = SYSFS_CPLD3 "qsfp28_p48_abs";
            node->lpmode_sysfs = SYSFS_CPLD3 "qsfp28_p48_lp_mode";
            node->reset_sysfs = SYSFS_CPLD3 "qsfp28_p48_rst";
            node->eeprom_bus = 66;
            ...
            break;
        case 49:
            node->abs_sysfs = SYSFS_CPLD3 "qsfp28_p49_abs";
            node->lpmode_sysfs = SYSFS_CPLD3 "qsfp28_p49_lp_mode";
            node->reset_sysfs = SYSFS_CPLD3 "qsfp28_p49_rst";
            node->eeprom_bus = 67;
            node->port_type = TYPE_QSFP;
            node->cpld_bit = 5;
            node->ctrl_addr = 0x4000; 
            ...
            break;
        case 50:
            node->abs_sysfs = SYSFS_CPLD3 "qsfp28_p50_abs";
            node->lpmode_sysfs = SYSFS_CPLD3 "qsfp28_p50_lp_mode";
            node->reset_sysfs = SYSFS_CPLD3 "qsfp28_p50_rst";
            node->eeprom_bus = 68;
            node->port_type = TYPE_QSFP;
            node->cpld_bit = 6;
            node->ctrl_addr = 0x4000; 
            ...
            break;
        case 51:
            node->abs_sysfs = SYSFS_CPLD3 "qsfp28_p51_abs";
            node->lpmode_sysfs = SYSFS_CPLD3 "qsfp28_p51_lp_mode";
            node->reset_sysfs = SYSFS_CPLD3 "qsfp28_p51_rst";
            node->eeprom_bus = 69;
            node->port_type = TYPE_QSFP;
            node->cpld_bit = 7;
            node->ctrl_addr = 0x4000; 
            ...
            break;
        case 52:
            node->abs_sysfs = SYSFS_CPLD3 "qsfpdd_p52_abs";
            node->lpmode_sysfs = SYSFS_CPLD3 "qsfpdd_p52_lp_mode";
            node->reset_sysfs = SYSFS_CPLD3 "qsfpdd_p52_rst";
            node->eeprom_bus = 70;
            ...
            break;
        case 53:
            node->abs_sysfs = SYSFS_CPLD3 "qsfpdd_p53_abs";
            node->lpmode_sysfs = SYSFS_CPLD3 "qsfpdd_p53_lp_mode";
            node->reset_sysfs = SYSFS_CPLD3 "qsfpdd_p53_rst";
            node->eeprom_bus = 71;
            node->port_type = TYPE_QSFPDD;
            node->cpld_bit = 9;
            node->ctrl_addr = 0x4000; 
...
int onlp_sfpi_dev_class_update_port(int port)
{
    ...
    if (!IS_QSFPX(node)) { //For QSFPX only, skip other ports
        return ONLP_STATUS_E_UNSUPPORTED;
...
int onlp_sfpi_dev_class_update(int port)
{
    ...
    for (int i = QSFPX_START; i < QSFPX_START + QSFPX_NUM; ++i) {
...
int onlp_sfpi_eeprom_read(int port, uint8_t data[256])
{
    ...
    if (is_fpga_pci_enable()) {
        ...
        size = snprintf(sysfs_path, sizeof(sysfs_path),
            SYS_FMT, node.eeprom_bus, EEPROM_ADDR, SYSFS_EEPROM);
