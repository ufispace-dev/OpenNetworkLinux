...
#define BMC_ATTR_NAME_TEMP_ENV_FRONT        "TEMP_ENV_FRONT"
#define BMC_ATTR_NAME_TEMP_ENV_MB           "TEMP_ENV_MB"
#define BMC_ATTR_NAME_TEMP_ENV_PHY          "TEMP_ENV_PHY"
#define BMC_ATTR_NAME_TEMP_ENV_REAR         "TEMP_ENV_REAR"
...
enum bmc_attr_id {
    ...
    BMC_ATTR_ID_TEMP_ENV_MB,
    BMC_ATTR_ID_TEMP_ENV_PHY,
