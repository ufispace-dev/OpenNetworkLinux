...
/* This is definitions for x86-64-ufispace-s9620-54dc */
/* OID map*/
/*
 * [01] CHASSIS
...
static onlp_oid_t __onlp_oid_info[] = {
    ...
    ONLP_THERMAL_ID_CREATE(ONLP_THERMAL_U78),
    ONLP_THERMAL_ID_CREATE(ONLP_THERMAL_U36),
    ONLP_THERMAL_ID_CREATE(ONLP_THERMAL_U52),
    ONLP_THERMAL_ID_CREATE(ONLP_THERMAL_U9),
...
static int get_platform_info(onlp_platform_info_t* pi)
{
    ...
    char mb_fpga_ver[ONLP_CONFIG_INFO_STR_MAX] = {'\0'};
    ONLP_TRY(onlp_file_read((uint8_t*)&mb_fpga_ver, ONLP_CONFIG_INFO_STR_MAX -1, &len, SYSFS_FPGA_VER_H));
...
{
    return "x86-64-ufispace-s9620-54dc-r0";
}
