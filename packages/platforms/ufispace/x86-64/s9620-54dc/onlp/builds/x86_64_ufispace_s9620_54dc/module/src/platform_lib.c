...
bmc_info_t bmc_cache[] =
{
    ...
    [BMC_ATTR_ID_FAN4_RPM_FRONT]   = {HW_PLAT_ALL, BMC_ATTR_NAME_FAN4_RPM_FRONT    , BMC_DATA_FLOAT , 0},             
    [BMC_ATTR_ID_FAN4_RPM_REAR]    = {HW_PLAT_ALL, BMC_ATTR_NAME_FAN4_RPM_REAR     , BMC_DATA_FLOAT , 0},            
    ...
    [BMC_ATTR_ID_TEMP_ENV_FRONT]   = {HW_PLAT_ALL, BMC_ATTR_NAME_TEMP_ENV_FRONT    , BMC_DATA_FLOAT , 0},
    [BMC_ATTR_ID_TEMP_ENV_MB]      = {HW_PLAT_ALL, BMC_ATTR_NAME_TEMP_ENV_MB       , BMC_DATA_FLOAT , 0},
    [BMC_ATTR_ID_TEMP_ENV_PHY]     = {HW_PLAT_ALL, BMC_ATTR_NAME_TEMP_ENV_PHY      , BMC_DATA_FLOAT , 0},
    [BMC_ATTR_ID_TEMP_ENV_REAR]    = {HW_PLAT_ALL, BMC_ATTR_NAME_TEMP_ENV_REAR     , BMC_DATA_FLOAT , 0},
    ...
    [BMC_ATTR_ID_FAN3_PRSNT_L]     = {HW_PLAT_ALL, BMC_ATTR_NAME_FAN3_PRSNT_L      , BMC_DATA_BOOL  , 0}, 
    [BMC_ATTR_ID_FAN4_PRSNT_L]     = {HW_PLAT_ALL, BMC_ATTR_NAME_FAN4_PRSNT_L      , BMC_DATA_BOOL  , 0},                     
    [BMC_ATTR_ID_PSU0_PRSNT_L]     = {HW_PLAT_ALL, BMC_ATTR_NAME_PSU0_PRSNT_L      , BMC_DATA_BOOL  , 0},           
    [BMC_ATTR_ID_PSU0_PWROK_H]     = {HW_PLAT_ALL, BMC_ATTR_NAME_PSU0_PWROK_H      , BMC_DATA_BOOL  , 0},           
    [BMC_ATTR_ID_PSU1_PRSNT_L]     = {HW_PLAT_ALL, BMC_ATTR_NAME_PSU1_PRSNT_L      , BMC_DATA_BOOL  , 0},           
    [BMC_ATTR_ID_PSU1_PWROK_H]     = {HW_PLAT_ALL, BMC_ATTR_NAME_PSU1_PWROK_H      , BMC_DATA_BOOL  , 0}            
...
int get_gpio_base(int *gpio_base)
{
    ...
    if(read_file_hex(gpio_base, LPC_BSP_PATH "bsp_gpio_base") != ONLP_STATUS_OK)
    {
        *gpio_base = 512;
        rv = ONLP_STATUS_E_INVALID;
    }
