...
bmc_info_t bmc_cache[] =
{
    ...
    [BMC_ATTR_ID_TEMP_U78]         = {HW_PLAT_ALL, BMC_ATTR_NAME_TEMP_U78          , BMC_DATA_FLOAT , 0},       
    [BMC_ATTR_ID_TEMP_U36]         = {HW_PLAT_ALL, BMC_ATTR_NAME_TEMP_U36          , BMC_DATA_FLOAT , 0},       
    [BMC_ATTR_ID_TEMP_U52]         = {HW_PLAT_ALL, BMC_ATTR_NAME_TEMP_U52          , BMC_DATA_FLOAT , 0},       
    [BMC_ATTR_ID_TEMP_U9]          = {HW_PLAT_ALL, BMC_ATTR_NAME_TEMP_U9           , BMC_DATA_FLOAT , 0},      
