...
class OnlPlatform_x86_64_ufispace_s9110_32x_r0(OnlPlatformUfiSpace):
    ...
    PLTM_PREFIX=VENDOR_PREFIX + "s9110-32x-"
    ...
    LEVEL_INFO=1
    LEVEL_ERR=2
    SYSFS_LPC="/sys/devices/platform/x86_64_ufispace_s9110_32x_lpc"
    ...
    def init_port_eeprom(self):
        ...
        with open(PORT_CFG, 'r') as yaml_file:
    ...
    def init_cpld(self):
        bus = 2
        addrs = (0x30, 0x31)
        dev_name_prefix = "s9110_32x_cpld"
    ...
    def init_mux(self, bus_i801, bus_ismt):
        ...
        i2c_muxs = [
            ...
            ('pca9548', 0x72, bus_i801),  # 9548_ROOT_QSFP
            ('pca9548', 0x73, 10),        # 9548_CHILD_QSFP_0_7
            ('pca9548', 0x73, 12),        # 9548_CHILD_QSFP_8_15
            ('pca9548', 0x73, 14),        # 9548_CHILD_QSFP_16_23
            ('pca9548', 0x73, 16),        # 9548_CHILD_QSFP_24_31
            ('pca9548', 0x73, 17),        # 9548_CHILD_SFP_48_53
        ]
