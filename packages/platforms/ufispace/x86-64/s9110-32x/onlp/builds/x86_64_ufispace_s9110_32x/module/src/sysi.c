 ...
 *            |----[05]ONLP_THERMAL_ENV_PSUCASE
 *            |----[06]ONLP_THERMAL_ENV_BMC
 *            |----[09]ONLP_THERMAL_DC_VDD_TEMP1
 *            |----[10]ONLP_THERMAL_DC_VDD_TEMP2
 *            |----[11]ONLP_THERMAL_DC_P3V3_TEMP1
 *            |----[12]ONLP_THERMAL_DC_P3V3_TEMP2
 *            |
 *            |----[01] ONLP_LED_SYS_SYS
 *            |----[02] ONLP_LED_SYS_FAN
 *            |----[03] ONLP_LED_SYS_PSU_0
...
static onlp_oid_t __onlp_oid_info[] = {
    ...
    ONLP_THERMAL_ID_CREATE(ONLP_THERMAL_ENV_PSUCASE),
    ONLP_THERMAL_ID_CREATE(ONLP_THERMAL_ENV_BMC),
    ONLP_THERMAL_ID_CREATE(ONLP_THERMAL_DC_VDD_TEMP1),
    ONLP_THERMAL_ID_CREATE(ONLP_THERMAL_DC_VDD_TEMP2),
    ONLP_THERMAL_ID_CREATE(ONLP_THERMAL_DC_P3V3_TEMP1),
    ONLP_THERMAL_ID_CREATE(ONLP_THERMAL_DC_P3V3_TEMP2),
