/*
 * A i2c cpld driver for the ufispace_s9311_64d
 *
...
#include "x86-64-ufispace-s9311-64d-cpld-main.h"
...
static port_block_map_t ports_block_map[] = {
    ...
    [64] = {.reg = CPLD_MGMT_PORT_STUCK_REG, .evt_reg = CPLD_MGMT_PORT_STUCK_EVENT_REG, .mask = MASK_0000_1000, PORT_NONE_BLOCK},
