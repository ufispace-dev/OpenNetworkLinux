...
enum cpld_sysfs_attributes
{
    ...
    DBG_CPLD_MISC_INTR,
    /* mgmt port status/control */
    CPLD_MGMT_PORT_0_PRES,
    CPLD_MGMT_PORT_1_PRES,
    CPLD_MGMT_PORT_0_TX_FAULT,
    CPLD_MGMT_PORT_1_TX_FAULT,
    CPLD_MGMT_PORT_0_RX_LOS,
    CPLD_MGMT_PORT_1_RX_LOS,
    CPLD_MGMT_PORT_0_PRES_MASK,
    CPLD_MGMT_PORT_1_PRES_MASK,
    CPLD_MGMT_PORT_0_TX_FAULT_MASK,
    CPLD_MGMT_PORT_1_TX_FAULT_MASK,
    CPLD_MGMT_PORT_0_RX_LOS_MASK,
    CPLD_MGMT_PORT_1_RX_LOS_MASK,
    CPLD_MGMT_PORT_0_PRES_EVENT,
    CPLD_MGMT_PORT_1_PRES_EVENT,
    CPLD_MGMT_PORT_0_TX_FAULT_EVENT,
    CPLD_MGMT_PORT_1_TX_FAULT_EVENT,
    CPLD_MGMT_PORT_0_RX_LOS_EVENT,
    CPLD_MGMT_PORT_1_RX_LOS_EVENT,
    CPLD_MGMT_PORT_0_TX_DIS,
    CPLD_MGMT_PORT_1_TX_DIS,
    CPLD_MGMT_PORT_0_RX_RS,
    CPLD_MGMT_PORT_1_RX_RS,
    CPLD_MGMT_PORT_0_TX_RS,
    CPLD_MGMT_PORT_1_TX_RS,

    // CPLD 2 and CPLD 3
    /* qsfpdd port status/control */
    ...
    CPLD_QSFPDD_PORT_0_7_16_23_FUSE,
    CPLD_QSFPDD_PORT_8_15_24_31_FUSE,
    CPLD_QSFPDD_PORT_32_39_48_55_FUSE,
    CPLD_QSFPDD_PORT_40_47_56_63_FUSE,
    ...
    CPLD_QSFPDD_PORT_0_7_16_23_FUSE_MASK,
    CPLD_QSFPDD_PORT_8_15_24_31_FUSE_MASK,
    CPLD_QSFPDD_PORT_32_39_48_55_FUSE_MASK,
    CPLD_QSFPDD_PORT_40_47_56_63_FUSE_MASK,
    ...
    CPLD_QSFPDD_PORT_0_7_16_23_FUSE_EVENT,
    CPLD_QSFPDD_PORT_8_15_24_31_FUSE_EVENT,
    CPLD_QSFPDD_PORT_32_39_48_55_FUSE_EVENT,
    CPLD_QSFPDD_PORT_40_47_56_63_FUSE_EVENT,
    ...
    CPLD_DBG_QSFPDD_PORT_0_7_16_23_FUSE,
    CPLD_DBG_QSFPDD_PORT_8_15_24_31_FUSE,
    CPLD_DBG_QSFPDD_PORT_32_39_48_55_FUSE,
    CPLD_DBG_QSFPDD_PORT_40_47_56_63_FUSE,
    CPLD_MGMT_PORT_0_STUCK,
    CPLD_MGMT_PORT_1_STUCK,
    CPLD_MGMT_PORT_0_STUCK_MASK,
    CPLD_MGMT_PORT_1_STUCK_MASK,
    CPLD_MGMT_PORT_0_STUCK_EVENT,
    CPLD_MGMT_PORT_1_STUCK_EVENT,
...
static attr_reg_map_t attr_reg[] = {
    ...
    [CPLD_ID] = {CPLD_ID_REG, MASK_ALL, DATA_DEC, REG_WP_DIS},
    [CPLD_BUILD_VER] = {CPLD_BUILD_REG, MASK_ALL, DATA_DEC, REG_WP_DIS},
    [CPLD_VERSION_H] = {NONE_REG, MASK_NONE, DATA_UNK, REG_WP_DIS},
    [CPLD_EVT_CTRL] = {CPLD_EVT_CTRL_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_WRITE_PROTECT] = {CPLD_WRITE_PROTECT_1_REG, MASK_0000_0001, DATA_HEX, REG_WP_DIS},

    // CPLD 1
    [CPLD_BOARD_ID_0] = {CPLD_BOARD_ID_0_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_BOARD_ID_1] = {CPLD_BOARD_ID_1_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_MAC_INTR] = {CPLD_MAC_INTR_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_CPLDX_INTR] = {CPLD_CPLDX_INTR_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_MAC_THERMAL_INTR] = {CPLD_THERMAL_INTR_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_MISC_INTR] = {CPLD_MISC_INTR_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_CPU_INTR] = {CPLD_CPU_INTR_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_MAC_MASK] = {CPLD_MAC_MASK_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_CPLDX_MASK] = {CPLD_CPLDX_MASK_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_MAC_THERMAL_MASK] = {CPLD_THERMAL_MASK_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_MISC_MASK] = {CPLD_MISC_MASK_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_CPU_MASK] = {CPLD_CPU_MASK_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_MAC_EVT] = {CPLD_MAC_EVT_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_CPLDX_EVT] = {CPLD_CPLDX_EVT_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_MAC_THERMAL_EVT] = {CPLD_THERMAL_EVT_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_MISC_EVT] = {CPLD_MISC_EVT_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_CPU_EVT] = {CPLD_CPU_EVT_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_MAC_RESET] = {CPLD_MAC_RESET_REG, MASK_ALL, DATA_HEX, REG_WP_EN},
    [CPLD_BMC_RESET] = {CPLD_BMC_RESET_REG, MASK_ALL, DATA_HEX, REG_WP_EN},
    [CPLD_USB_RESET] = {CPLD_USB_RESET_REG, MASK_ALL, DATA_HEX, REG_WP_EN},
    [CPLD_MUX_RESET] = {CPLD_MUX_RESET_REG, MASK_ALL, DATA_HEX, REG_WP_EN},
    [CPLD_MISC_RESET] = {CPLD_MISC_RESET_REG, MASK_ALL, DATA_HEX, REG_WP_EN},
    [CPLD_PUSH_BUTTON_CTRL] = {CPLD_PUSH_BUTTON_CTRL_REG, MASK_ALL, DATA_HEX, REG_WP_EN},
    [CPLD_BRD_PRESENT] = {CPLD_BRD_PRESENT_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_PSU_STATUS] = {CPLD_PSU_STATUS_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_SYSTEM_PWR] = {CPLD_SYSTEM_PWR_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_MAC_SYNCE] = {CPLD_MAC_SYNCE_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_MAC_ROV] = {CPLD_MAC_ROV_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_MUX_CTRL] = {CPLD_MUX_CTRL_REG, MASK_ALL, DATA_HEX, REG_WP_EN},
    [CPLD_SYSTEM_LED_SYS] = {CPLD_SYSTEM_LED_SYS_FAN_REG, MASK_0000_1111, DATA_HEX, REG_WP_DIS},
    [CPLD_SYSTEM_LED_FAN] = {CPLD_SYSTEM_LED_SYS_FAN_REG, MASK_1111_0000, DATA_HEX, REG_WP_DIS},
    [CPLD_SYSTEM_LED_PSU_0] = {CPLD_SYSTEM_LED_PSU_REG, MASK_0000_1111, DATA_HEX, REG_WP_DIS},
    [CPLD_SYSTEM_LED_PSU_1] = {CPLD_SYSTEM_LED_PSU_REG, MASK_1111_0000, DATA_HEX, REG_WP_DIS},
    [CPLD_SYSTEM_LED_SYNC] = {CPLD_SYSTEM_LED_SYNC_ID_REG, MASK_0000_1111, DATA_HEX, REG_WP_DIS},
    [CPLD_SYSTEM_LED_ID] = {CPLD_SYSTEM_LED_SYNC_ID_REG, MASK_1111_0000, DATA_HEX, REG_WP_DIS},
    [CPLD_MGMT_PORT_0_LED_STATUS] = {CPLD_SFP_PORT_0_1_LED_REG, MASK_0000_1101, DATA_DEC, REG_WP_DIS},
    [CPLD_MGMT_PORT_0_LED_SPEED] = {CPLD_SFP_PORT_0_1_LED_REG, MASK_0000_0010, DATA_DEC, REG_WP_DIS},
    [CPLD_MGMT_PORT_1_LED_STATUS] = {CPLD_SFP_PORT_0_1_LED_REG, MASK_1101_0000, DATA_DEC, REG_WP_DIS},
    [CPLD_MGMT_PORT_1_LED_SPEED] = {CPLD_SFP_PORT_0_1_LED_REG, MASK_0010_0000, DATA_DEC, REG_WP_DIS},
    [CPLD_PORT_LED_CLR] = {CPLD_PORT_LED_CLR_REG, MASK_0000_0001, DATA_DEC, REG_WP_DIS},
    [CPLD_MISC_PWR] = {CPLD_MISC_PWR_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [DBG_CPLD_MAC_INTR] = {DBG_CPLD_MAC_INTR_REG, MASK_ALL, DATA_HEX, REG_WP_EN},
    [DBG_CPLD_CPLDX_INTR] = {DBG_CPLD_CPLDX_INTR_REG, MASK_ALL, DATA_HEX, REG_WP_EN},
    [DBG_CPLD_MAC_THERMAL_INTR] = {DBG_CPLD_THERMAL_INTR_REG, MASK_ALL, DATA_HEX, REG_WP_EN},
    [DBG_CPLD_MISC_INTR] = {DBG_CPLD_MISC_INTR_REG, MASK_ALL, DATA_HEX, REG_WP_EN},
    [CPLD_MGMT_PORT_0_PRES] = {CPLD_SFP_PORT_STATUS_REG, MASK_0000_0001, DATA_HEX, REG_WP_DIS},
    [CPLD_MGMT_PORT_1_PRES] = {CPLD_SFP_PORT_STATUS_REG, MASK_0001_0000, DATA_HEX, REG_WP_DIS},
    [CPLD_MGMT_PORT_0_TX_FAULT] = {CPLD_SFP_PORT_STATUS_REG, MASK_0000_0010, DATA_HEX, REG_WP_DIS},
    [CPLD_MGMT_PORT_1_TX_FAULT] = {CPLD_SFP_PORT_STATUS_REG, MASK_0010_0000, DATA_HEX, REG_WP_DIS},
    [CPLD_MGMT_PORT_0_RX_LOS] = {CPLD_SFP_PORT_STATUS_REG, MASK_0000_0100, DATA_HEX, REG_WP_DIS},
    [CPLD_MGMT_PORT_1_RX_LOS] = {CPLD_SFP_PORT_STATUS_REG, MASK_0100_0000, DATA_HEX, REG_WP_DIS},
    [CPLD_MGMT_PORT_0_PRES_MASK] = {CPLD_SFP_PORT_STATUS_MASK_REG, MASK_0000_0001, DATA_HEX, REG_WP_DIS},
    [CPLD_MGMT_PORT_1_PRES_MASK] = {CPLD_SFP_PORT_STATUS_MASK_REG, MASK_0001_0000, DATA_HEX, REG_WP_DIS},
    [CPLD_MGMT_PORT_0_TX_FAULT_MASK] = {CPLD_SFP_PORT_STATUS_MASK_REG, MASK_0000_0010, DATA_HEX, REG_WP_DIS},
    [CPLD_MGMT_PORT_1_TX_FAULT_MASK] = {CPLD_SFP_PORT_STATUS_MASK_REG, MASK_0010_0000, DATA_HEX, REG_WP_DIS},
    [CPLD_MGMT_PORT_0_RX_LOS_MASK] = {CPLD_SFP_PORT_STATUS_MASK_REG, MASK_0000_0100, DATA_HEX, REG_WP_DIS},
    [CPLD_MGMT_PORT_1_RX_LOS_MASK] = {CPLD_SFP_PORT_STATUS_MASK_REG, MASK_0100_0000, DATA_HEX, REG_WP_DIS},
    [CPLD_MGMT_PORT_0_PRES_EVENT] = {CPLD_SFP_PORT_STATUS_EVT_REG, MASK_0000_0001, DATA_HEX, REG_WP_DIS},
    [CPLD_MGMT_PORT_1_PRES_EVENT] = {CPLD_SFP_PORT_STATUS_EVT_REG, MASK_0001_0000, DATA_HEX, REG_WP_DIS},
    [CPLD_MGMT_PORT_0_TX_FAULT_EVENT] = {CPLD_SFP_PORT_STATUS_EVT_REG, MASK_0000_0010, DATA_HEX, REG_WP_DIS},
    [CPLD_MGMT_PORT_1_TX_FAULT_EVENT] = {CPLD_SFP_PORT_STATUS_EVT_REG, MASK_0010_0000, DATA_HEX, REG_WP_DIS},
    [CPLD_MGMT_PORT_0_RX_LOS_EVENT] = {CPLD_SFP_PORT_STATUS_EVT_REG, MASK_0000_0100, DATA_HEX, REG_WP_DIS},
    [CPLD_MGMT_PORT_1_RX_LOS_EVENT] = {CPLD_SFP_PORT_STATUS_EVT_REG, MASK_0100_0000, DATA_HEX, REG_WP_DIS},
    [CPLD_MGMT_PORT_0_TX_DIS] = {CPLD_SFP_PORT_CTRL_REG, MASK_0000_0001, DATA_HEX, REG_WP_EN},
    [CPLD_MGMT_PORT_1_TX_DIS] = {CPLD_SFP_PORT_CTRL_REG, MASK_0001_0000, DATA_HEX, REG_WP_EN},
    [CPLD_MGMT_PORT_0_RX_RS] = {CPLD_SFP_PORT_CTRL_REG, MASK_0000_0010, DATA_HEX, REG_WP_EN},
    [CPLD_MGMT_PORT_1_RX_RS] = {CPLD_SFP_PORT_CTRL_REG, MASK_0010_0000, DATA_HEX, REG_WP_EN},
    [CPLD_MGMT_PORT_0_TX_RS] = {CPLD_SFP_PORT_CTRL_REG, MASK_0000_0100, DATA_HEX, REG_WP_EN},
    [CPLD_MGMT_PORT_1_TX_RS] = {CPLD_SFP_PORT_CTRL_REG, MASK_0100_0000, DATA_HEX, REG_WP_EN},

    // CPLD 2/3
    [CPLD_QSFPDD_PORT_0_7_16_23_INTR] = {CPLD_QSFPDD_PORT_0_7_16_23_INTR_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_QSFPDD_PORT_8_15_24_31_INTR] = {CPLD_QSFPDD_PORT_8_15_24_31_INTR_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_QSFPDD_PORT_32_39_48_55_INTR] = {CPLD_QSFPDD_PORT_32_39_48_55_INTR_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_QSFPDD_PORT_40_47_56_63_INTR] = {CPLD_QSFPDD_PORT_40_47_56_63_INTR_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_QSFPDD_PORT_0_7_16_23_PRES] = {CPLD_QSFPDD_PORT_0_7_16_23_PRES_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_QSFPDD_PORT_8_15_24_31_PRES] = {CPLD_QSFPDD_PORT_8_15_24_31_PRES_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_QSFPDD_PORT_32_39_48_55_PRES] = {CPLD_QSFPDD_PORT_32_39_48_55_PRES_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_QSFPDD_PORT_40_47_56_63_PRES] = {CPLD_QSFPDD_PORT_40_47_56_63_PRES_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_QSFPDD_PORT_0_7_16_23_FUSE] = {CPLD_QSFPDD_PORT_0_7_16_23_FUSE_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_QSFPDD_PORT_8_15_24_31_FUSE] = {CPLD_QSFPDD_PORT_8_15_24_31_FUSE_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_QSFPDD_PORT_32_39_48_55_FUSE] = {CPLD_QSFPDD_PORT_32_39_48_55_FUSE_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_QSFPDD_PORT_40_47_56_63_FUSE] = {CPLD_QSFPDD_PORT_40_47_56_63_FUSE_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_QSFPDD_PORT_0_7_16_23_STUCK] = {CPLD_QSFPDD_PORT_0_7_16_23_STUCK_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_QSFPDD_PORT_8_15_24_31_STUCK] = {CPLD_QSFPDD_PORT_8_15_24_31_STUCK_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_QSFPDD_PORT_32_39_48_55_STUCK] = {CPLD_QSFPDD_PORT_32_39_48_55_STUCK_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_QSFPDD_PORT_40_47_56_63_STUCK] = {CPLD_QSFPDD_PORT_40_47_56_63_STUCK_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_QSFPDD_PORT_0_7_16_23_INTR_MASK] = {CPLD_QSFPDD_PORT_0_7_16_23_INTR_MASK_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_QSFPDD_PORT_8_15_24_31_INTR_MASK] = {CPLD_QSFPDD_PORT_8_15_24_31_INTR_MASK_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_QSFPDD_PORT_32_39_48_55_INTR_MASK] = {CPLD_QSFPDD_PORT_32_39_48_55_INTR_MASK_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_QSFPDD_PORT_40_47_56_63_INTR_MASK] = {CPLD_QSFPDD_PORT_40_47_56_63_INTR_MASK_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_QSFPDD_PORT_0_7_16_23_PRES_MASK] = {CPLD_QSFPDD_PORT_0_7_16_23_PRES_MASK_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_QSFPDD_PORT_8_15_24_31_PRES_MASK] = {CPLD_QSFPDD_PORT_8_15_24_31_PRES_MASK_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_QSFPDD_PORT_32_39_48_55_PRES_MASK] = {CPLD_QSFPDD_PORT_32_39_48_55_PRES_MASK_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_QSFPDD_PORT_40_47_56_63_PRES_MASK] = {CPLD_QSFPDD_PORT_40_47_56_63_PRES_MASK_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_QSFPDD_PORT_0_7_16_23_FUSE_MASK] = {CPLD_QSFPDD_PORT_0_7_16_23_FUSE_MASK_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_QSFPDD_PORT_8_15_24_31_FUSE_MASK] = {CPLD_QSFPDD_PORT_8_15_24_31_FUSE_MASK_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_QSFPDD_PORT_32_39_48_55_FUSE_MASK] = {CPLD_QSFPDD_PORT_32_39_48_55_FUSE_MASK_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_QSFPDD_PORT_40_47_56_63_FUSE_MASK] = {CPLD_QSFPDD_PORT_40_47_56_63_FUSE_MASK_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_QSFPDD_PORT_0_7_16_23_STUCK_MASK] = {CPLD_QSFPDD_PORT_0_7_16_23_STUCK_MASK_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_QSFPDD_PORT_8_15_24_31_STUCK_MASK] = {CPLD_QSFPDD_PORT_8_15_24_31_STUCK_MASK_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_QSFPDD_PORT_32_39_48_55_STUCK_MASK] = {CPLD_QSFPDD_PORT_32_39_48_55_STUCK_MASK_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_QSFPDD_PORT_40_47_56_63_STUCK_MASK] = {CPLD_QSFPDD_PORT_40_47_56_63_STUCK_MASK_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_QSFPDD_PORT_0_7_16_23_INTR_EVENT] = {CPLD_QSFPDD_PORT_0_7_16_23_INTR_EVENT_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_QSFPDD_PORT_8_15_24_31_INTR_EVENT] = {CPLD_QSFPDD_PORT_8_15_24_31_INTR_EVENT_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_QSFPDD_PORT_32_39_48_55_INTR_EVENT] = {CPLD_QSFPDD_PORT_32_39_48_55_INTR_EVENT_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_QSFPDD_PORT_40_47_56_63_INTR_EVENT] = {CPLD_QSFPDD_PORT_40_47_56_63_INTR_EVENT_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_QSFPDD_PORT_0_7_16_23_PRES_EVENT] = {CPLD_QSFPDD_PORT_0_7_16_23_PRES_EVENT_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_QSFPDD_PORT_8_15_24_31_PRES_EVENT] = {CPLD_QSFPDD_PORT_8_15_24_31_PRES_EVENT_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_QSFPDD_PORT_32_39_48_55_PRES_EVENT] = {CPLD_QSFPDD_PORT_32_39_48_55_PRES_EVENT_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_QSFPDD_PORT_40_47_56_63_PRES_EVENT] = {CPLD_QSFPDD_PORT_40_47_56_63_PRES_EVENT_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_QSFPDD_PORT_0_7_16_23_FUSE_EVENT] = {CPLD_QSFPDD_PORT_0_7_16_23_FUSE_EVENT_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_QSFPDD_PORT_8_15_24_31_FUSE_EVENT] = {CPLD_QSFPDD_PORT_8_15_24_31_FUSE_EVENT_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_QSFPDD_PORT_32_39_48_55_FUSE_EVENT] = {CPLD_QSFPDD_PORT_32_39_48_55_FUSE_EVENT_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_QSFPDD_PORT_40_47_56_63_FUSE_EVENT] = {CPLD_QSFPDD_PORT_40_47_56_63_FUSE_EVENT_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_QSFPDD_PORT_0_7_16_23_STUCK_EVENT] = {CPLD_QSFPDD_PORT_0_7_16_23_STUCK_EVENT_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_QSFPDD_PORT_8_15_24_31_STUCK_EVENT] = {CPLD_QSFPDD_PORT_8_15_24_31_STUCK_EVENT_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_QSFPDD_PORT_32_39_48_55_STUCK_EVENT] = {CPLD_QSFPDD_PORT_32_39_48_55_STUCK_EVENT_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_QSFPDD_PORT_40_47_56_63_STUCK_EVENT] = {CPLD_QSFPDD_PORT_40_47_56_63_STUCK_EVENT_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_QSFPDD_PORT_0_7_16_23_RST] = {CPLD_QSFPDD_PORT_0_7_16_23_RST_REG, MASK_ALL, DATA_HEX, REG_WP_EN},
    [CPLD_QSFPDD_PORT_8_15_24_31_RST] = {CPLD_QSFPDD_PORT_8_15_24_31_RST_REG, MASK_ALL, DATA_HEX, REG_WP_EN},
    [CPLD_QSFPDD_PORT_32_39_48_55_RST] = {CPLD_QSFPDD_PORT_32_39_48_55_RST_REG, MASK_ALL, DATA_HEX, REG_WP_EN},
    [CPLD_QSFPDD_PORT_40_47_56_63_RST] = {CPLD_QSFPDD_PORT_40_47_56_63_RST_REG, MASK_ALL, DATA_HEX, REG_WP_EN},
    [CPLD_QSFPDD_PORT_0_7_16_23_LPMODE] = {CPLD_QSFPDD_PORT_0_7_16_23_LPMODE_REG, MASK_ALL, DATA_HEX, REG_WP_EN},
    [CPLD_QSFPDD_PORT_8_15_24_31_LPMODE] = {CPLD_QSFPDD_PORT_8_15_24_31_LPMODE_REG, MASK_ALL, DATA_HEX, REG_WP_EN},
    [CPLD_QSFPDD_PORT_32_39_48_55_LPMODE] = {CPLD_QSFPDD_PORT_32_39_48_55_LPMODE_REG, MASK_ALL, DATA_HEX, REG_WP_EN},
    [CPLD_QSFPDD_PORT_40_47_56_63_LPMODE] = {CPLD_QSFPDD_PORT_40_47_56_63_LPMODE_REG, MASK_ALL, DATA_HEX, REG_WP_EN},
    [CPLD_I2C_CONTROL] = {CPLD_I2C_CONTROL_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_I2C_RELAY] = {CPLD_I2C_RELAY_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    [CPLD_DBG_QSFPDD_PORT_0_7_16_23_INTR] = {CPLD_DBG_QSFPDD_PORT_0_7_16_23_INTR_REG, MASK_ALL, DATA_HEX, REG_WP_EN},
    [CPLD_DBG_QSFPDD_PORT_8_15_24_31_INTR] = {CPLD_DBG_QSFPDD_PORT_8_15_24_31_INTR_REG, MASK_ALL, DATA_HEX, REG_WP_EN},
    [CPLD_DBG_QSFPDD_PORT_32_39_48_55_INTR] = {CPLD_DBG_QSFPDD_PORT_32_39_48_55_INTR_REG, MASK_ALL, DATA_HEX, REG_WP_EN},
    [CPLD_DBG_QSFPDD_PORT_40_47_56_63_INTR] = {CPLD_DBG_QSFPDD_PORT_40_47_56_63_INTR_REG, MASK_ALL, DATA_HEX, REG_WP_EN},
    [CPLD_DBG_QSFPDD_PORT_0_7_16_23_PRES] = {CPLD_DBG_QSFPDD_PORT_0_7_16_23_PRES_REG, MASK_ALL, DATA_HEX, REG_WP_EN},
    [CPLD_DBG_QSFPDD_PORT_8_15_24_31_PRES] = {CPLD_DBG_QSFPDD_PORT_8_15_24_31_PRES_REG, MASK_ALL, DATA_HEX, REG_WP_EN},
    [CPLD_DBG_QSFPDD_PORT_32_39_48_55_PRES] = {CPLD_DBG_QSFPDD_PORT_32_39_48_55_PRES_REG, MASK_ALL, DATA_HEX, REG_WP_EN},
    [CPLD_DBG_QSFPDD_PORT_40_47_56_63_PRES] = {CPLD_DBG_QSFPDD_PORT_40_47_56_63_PRES_REG, MASK_ALL, DATA_HEX, REG_WP_EN},
    [CPLD_DBG_QSFPDD_PORT_0_7_16_23_FUSE] = {CPLD_DBG_QSFPDD_PORT_0_7_16_23_FUSE_REG, MASK_ALL, DATA_HEX, REG_WP_EN},
    [CPLD_DBG_QSFPDD_PORT_8_15_24_31_FUSE] = {CPLD_DBG_QSFPDD_PORT_8_15_24_31_FUSE_REG, MASK_ALL, DATA_HEX, REG_WP_EN},
    [CPLD_DBG_QSFPDD_PORT_32_39_48_55_FUSE] = {CPLD_DBG_QSFPDD_PORT_32_39_48_55_FUSE_REG, MASK_ALL, DATA_HEX, REG_WP_EN},
    [CPLD_DBG_QSFPDD_PORT_40_47_56_63_FUSE] = {CPLD_DBG_QSFPDD_PORT_40_47_56_63_FUSE_REG, MASK_ALL, DATA_HEX, REG_WP_EN},
    [CPLD_MGMT_PORT_0_STUCK] = {CPLD_MGMT_PORT_STUCK_REG, MASK_0000_1000, DATA_HEX, REG_WP_DIS},
    [CPLD_MGMT_PORT_1_STUCK] = {CPLD_MGMT_PORT_STUCK_REG, MASK_0001_0000, DATA_HEX, REG_WP_DIS},
    [CPLD_MGMT_PORT_0_STUCK_MASK] = {CPLD_MGMT_PORT_STUCK_MASK_REG, MASK_0000_1000, DATA_HEX, REG_WP_DIS},
    [CPLD_MGMT_PORT_1_STUCK_MASK] = {CPLD_MGMT_PORT_STUCK_MASK_REG, MASK_0001_0000, DATA_HEX, REG_WP_DIS},
    [CPLD_MGMT_PORT_0_STUCK_EVENT] = {CPLD_MGMT_PORT_STUCK_EVENT_REG, MASK_0000_1000, DATA_HEX, REG_WP_DIS},
    [CPLD_MGMT_PORT_1_STUCK_EVENT] = {CPLD_MGMT_PORT_STUCK_EVENT_REG, MASK_0001_0000, DATA_HEX, REG_WP_DIS},

    // FPGA
    [FPGA_MINOR_VER] = {FPGA_VERSION_REG, MASK_0011_1111, DATA_DEC, REG_WP_DIS},
    [FPGA_MAJOR_VER] = {FPGA_VERSION_REG, MASK_1100_0000, DATA_DEC, REG_WP_DIS},
    [FPGA_BUILD] = {FPGA_BUILD_REG, MASK_ALL, DATA_DEC, REG_WP_DIS},
    [FPGA_VERSION_H] = {NONE_REG, MASK_NONE, DATA_UNK, REG_WP_DIS},
    [FPGA_CHIP] = {FPGA_CHIP_REG, MASK_ALL, DATA_DEC, REG_WP_DIS},
    [FPGA_LAN_PORT_RELAY] = {FPGA_LAN_PORT_RELAY_REG, MASK_ALL, DATA_HEX, REG_WP_DIS},
    ...
    [BSP_WP_ACCESS_COUNT] = {NONE_REG, MASK_NONE, DATA_UNK, REG_WP_DIS},
};
...
static const struct i2c_device_id cpld_id[] = {
    {"s9311_64d_cpld1", cpld1},
    {"s9311_64d_cpld2", cpld2},
    {"s9311_64d_cpld3", cpld3},
    {"s9311_64d_fpga", fpga},
    {}};
...
static SENSOR_DEVICE_ATTR_RO(cpld_cpu_evt, cpld, CPLD_CPU_EVT);
...
static SENSOR_DEVICE_ATTR_RW(cpld_mux_reset, cpld, CPLD_MUX_RESET);
static SENSOR_DEVICE_ATTR_RW(cpld_misc_reset, cpld, CPLD_MISC_RESET);
static SENSOR_DEVICE_ATTR_RW(cpld_push_button_ctrl, cpld, CPLD_PUSH_BUTTON_CTRL);
...
static SENSOR_DEVICE_ATTR_RO(cpld_mgmt_port_pres_0, cpld, CPLD_MGMT_PORT_0_PRES);
static SENSOR_DEVICE_ATTR_RO(cpld_mgmt_port_pres_1, cpld, CPLD_MGMT_PORT_1_PRES);
static SENSOR_DEVICE_ATTR_RO(cpld_mgmt_port_tx_fault_0, cpld, CPLD_MGMT_PORT_0_TX_FAULT);
static SENSOR_DEVICE_ATTR_RO(cpld_mgmt_port_tx_fault_1, cpld, CPLD_MGMT_PORT_1_TX_FAULT);
static SENSOR_DEVICE_ATTR_RO(cpld_mgmt_port_rx_los_0, cpld, CPLD_MGMT_PORT_0_RX_LOS);
static SENSOR_DEVICE_ATTR_RO(cpld_mgmt_port_rx_los_1, cpld, CPLD_MGMT_PORT_1_RX_LOS);
static SENSOR_DEVICE_ATTR_RW(cpld_mgmt_port_pres_mask_0, cpld, CPLD_MGMT_PORT_0_PRES_MASK);
static SENSOR_DEVICE_ATTR_RW(cpld_mgmt_port_pres_mask_1, cpld, CPLD_MGMT_PORT_1_PRES_MASK);
static SENSOR_DEVICE_ATTR_RW(cpld_mgmt_port_tx_fault_mask_0, cpld, CPLD_MGMT_PORT_0_TX_FAULT_MASK);
static SENSOR_DEVICE_ATTR_RW(cpld_mgmt_port_tx_fault_mask_1, cpld, CPLD_MGMT_PORT_1_TX_FAULT_MASK);
static SENSOR_DEVICE_ATTR_RW(cpld_mgmt_port_rx_los_mask_0, cpld, CPLD_MGMT_PORT_0_RX_LOS_MASK);
static SENSOR_DEVICE_ATTR_RW(cpld_mgmt_port_rx_los_mask_1, cpld, CPLD_MGMT_PORT_1_RX_LOS_MASK);
static SENSOR_DEVICE_ATTR_RO(cpld_mgmt_port_pres_evt_0, cpld, CPLD_MGMT_PORT_0_PRES_EVENT);
static SENSOR_DEVICE_ATTR_RO(cpld_mgmt_port_pres_evt_1, cpld, CPLD_MGMT_PORT_1_PRES_EVENT);
static SENSOR_DEVICE_ATTR_RO(cpld_mgmt_port_tx_fault_evt_0, cpld, CPLD_MGMT_PORT_0_TX_FAULT_EVENT);
static SENSOR_DEVICE_ATTR_RO(cpld_mgmt_port_tx_fault_evt_1, cpld, CPLD_MGMT_PORT_1_TX_FAULT_EVENT);
static SENSOR_DEVICE_ATTR_RO(cpld_mgmt_port_rx_los_evt_0, cpld, CPLD_MGMT_PORT_0_RX_LOS_EVENT);
static SENSOR_DEVICE_ATTR_RO(cpld_mgmt_port_rx_los_evt_1, cpld, CPLD_MGMT_PORT_1_RX_LOS_EVENT);
static SENSOR_DEVICE_ATTR_RW(cpld_mgmt_port_tx_dis_0, cpld, CPLD_MGMT_PORT_0_TX_DIS);
static SENSOR_DEVICE_ATTR_RW(cpld_mgmt_port_tx_dis_1, cpld, CPLD_MGMT_PORT_1_TX_DIS);
static SENSOR_DEVICE_ATTR_RW(cpld_mgmt_port_rx_rs_0, cpld, CPLD_MGMT_PORT_0_RX_RS);
static SENSOR_DEVICE_ATTR_RW(cpld_mgmt_port_rx_rs_1, cpld, CPLD_MGMT_PORT_1_RX_RS);
static SENSOR_DEVICE_ATTR_RW(cpld_mgmt_port_tx_rs_0, cpld, CPLD_MGMT_PORT_0_TX_RS);
static SENSOR_DEVICE_ATTR_RW(cpld_mgmt_port_tx_rs_1, cpld, CPLD_MGMT_PORT_1_TX_RS);
...
static SENSOR_DEVICE_ATTR_RO(cpld_qsfpdd_intr_fuse_0, cpld, CPLD_QSFPDD_PORT_0_7_16_23_FUSE);
static SENSOR_DEVICE_ATTR_RO(cpld_qsfpdd_intr_fuse_1, cpld, CPLD_QSFPDD_PORT_8_15_24_31_FUSE);
static SENSOR_DEVICE_ATTR_RO(cpld_qsfpdd_intr_fuse_2, cpld, CPLD_QSFPDD_PORT_32_39_48_55_FUSE);
static SENSOR_DEVICE_ATTR_RO(cpld_qsfpdd_intr_fuse_3, cpld, CPLD_QSFPDD_PORT_40_47_56_63_FUSE);
...
static SENSOR_DEVICE_ATTR_RW(cpld_qsfpdd_mask_fuse_0, cpld, CPLD_QSFPDD_PORT_0_7_16_23_FUSE_MASK);
static SENSOR_DEVICE_ATTR_RW(cpld_qsfpdd_mask_fuse_1, cpld, CPLD_QSFPDD_PORT_8_15_24_31_FUSE_MASK);
static SENSOR_DEVICE_ATTR_RW(cpld_qsfpdd_mask_fuse_2, cpld, CPLD_QSFPDD_PORT_32_39_48_55_FUSE_MASK);
static SENSOR_DEVICE_ATTR_RW(cpld_qsfpdd_mask_fuse_3, cpld, CPLD_QSFPDD_PORT_40_47_56_63_FUSE_MASK);
...
static SENSOR_DEVICE_ATTR_RO(cpld_qsfpdd_evt_fuse_0, cpld, CPLD_QSFPDD_PORT_0_7_16_23_FUSE_EVENT);
static SENSOR_DEVICE_ATTR_RO(cpld_qsfpdd_evt_fuse_1, cpld, CPLD_QSFPDD_PORT_8_15_24_31_FUSE_EVENT);
static SENSOR_DEVICE_ATTR_RO(cpld_qsfpdd_evt_fuse_2, cpld, CPLD_QSFPDD_PORT_32_39_48_55_FUSE_EVENT);
static SENSOR_DEVICE_ATTR_RO(cpld_qsfpdd_evt_fuse_3, cpld, CPLD_QSFPDD_PORT_40_47_56_63_FUSE_EVENT);
...
static SENSOR_DEVICE_ATTR_RW(dbg_cpld_qsfpdd_intr_fuse_0, cpld, CPLD_DBG_QSFPDD_PORT_0_7_16_23_FUSE);
static SENSOR_DEVICE_ATTR_RW(dbg_cpld_qsfpdd_intr_fuse_1, cpld, CPLD_DBG_QSFPDD_PORT_8_15_24_31_FUSE);
static SENSOR_DEVICE_ATTR_RW(dbg_cpld_qsfpdd_intr_fuse_2, cpld, CPLD_DBG_QSFPDD_PORT_32_39_48_55_FUSE);
static SENSOR_DEVICE_ATTR_RW(dbg_cpld_qsfpdd_intr_fuse_3, cpld, CPLD_DBG_QSFPDD_PORT_40_47_56_63_FUSE);
static SENSOR_DEVICE_ATTR_RO(cpld_mgmt_port_stuck_0, cpld, CPLD_MGMT_PORT_0_STUCK);
static SENSOR_DEVICE_ATTR_RO(cpld_mgmt_port_stuck_1, cpld, CPLD_MGMT_PORT_1_STUCK);
static SENSOR_DEVICE_ATTR_RW(cpld_mgmt_port_stuck_mask_0, cpld, CPLD_MGMT_PORT_0_STUCK_MASK);
static SENSOR_DEVICE_ATTR_RW(cpld_mgmt_port_stuck_mask_1, cpld, CPLD_MGMT_PORT_1_STUCK_MASK);
static SENSOR_DEVICE_ATTR_RO(cpld_mgmt_port_stuck_evt_0, cpld, CPLD_MGMT_PORT_0_STUCK_EVENT);
static SENSOR_DEVICE_ATTR_RO(cpld_mgmt_port_stuck_evt_1, cpld, CPLD_MGMT_PORT_1_STUCK_EVENT);
// FPGA
...
static struct attribute *cpld1_attributes[] = {
    ...
    _DEVICE_ATTR(cpld_mgmt_port_pres_0),
    _DEVICE_ATTR(cpld_mgmt_port_pres_1),
    _DEVICE_ATTR(cpld_mgmt_port_tx_fault_0),
    _DEVICE_ATTR(cpld_mgmt_port_tx_fault_1),
    _DEVICE_ATTR(cpld_mgmt_port_rx_los_0),
    _DEVICE_ATTR(cpld_mgmt_port_rx_los_1),
    _DEVICE_ATTR(cpld_mgmt_port_pres_mask_0),
    _DEVICE_ATTR(cpld_mgmt_port_pres_mask_1),
    _DEVICE_ATTR(cpld_mgmt_port_tx_fault_mask_0),
    _DEVICE_ATTR(cpld_mgmt_port_tx_fault_mask_1),
    _DEVICE_ATTR(cpld_mgmt_port_rx_los_mask_0),
    _DEVICE_ATTR(cpld_mgmt_port_rx_los_mask_1),
    _DEVICE_ATTR(cpld_mgmt_port_pres_evt_0),
    _DEVICE_ATTR(cpld_mgmt_port_pres_evt_1),
    _DEVICE_ATTR(cpld_mgmt_port_tx_fault_evt_0),
    _DEVICE_ATTR(cpld_mgmt_port_tx_fault_evt_1),
    _DEVICE_ATTR(cpld_mgmt_port_rx_los_evt_0),
    _DEVICE_ATTR(cpld_mgmt_port_rx_los_evt_1),
    _DEVICE_ATTR(cpld_mgmt_port_tx_dis_0),
    _DEVICE_ATTR(cpld_mgmt_port_tx_dis_1),
    _DEVICE_ATTR(cpld_mgmt_port_rx_rs_0),
    _DEVICE_ATTR(cpld_mgmt_port_rx_rs_1),
    _DEVICE_ATTR(cpld_mgmt_port_tx_rs_0),
    _DEVICE_ATTR(cpld_mgmt_port_tx_rs_1),
...
static struct attribute *cpld2_attributes[] = {
    ...
    _DEVICE_ATTR(cpld_mgmt_port_stuck_0),
    _DEVICE_ATTR(cpld_mgmt_port_stuck_1),
    _DEVICE_ATTR(cpld_mgmt_port_stuck_mask_0),
    _DEVICE_ATTR(cpld_mgmt_port_stuck_mask_1),
    _DEVICE_ATTR(cpld_mgmt_port_stuck_evt_0),
    _DEVICE_ATTR(cpld_mgmt_port_stuck_evt_1),
    NULL};
                         ...
                         struct device_attribute *da, char *buf)
{
    ...
    case CPLD_MGMT_PORT_0_PRES:
    case CPLD_MGMT_PORT_1_PRES:
    case CPLD_MGMT_PORT_0_TX_FAULT:
    case CPLD_MGMT_PORT_1_TX_FAULT:
    case CPLD_MGMT_PORT_0_RX_LOS:
    case CPLD_MGMT_PORT_1_RX_LOS:
    case CPLD_MGMT_PORT_0_PRES_MASK:
    case CPLD_MGMT_PORT_1_PRES_MASK:
    case CPLD_MGMT_PORT_0_TX_FAULT_MASK:
    case CPLD_MGMT_PORT_1_TX_FAULT_MASK:
    case CPLD_MGMT_PORT_0_RX_LOS_MASK:
    case CPLD_MGMT_PORT_1_RX_LOS_MASK:
    case CPLD_MGMT_PORT_0_PRES_EVENT:
    case CPLD_MGMT_PORT_1_PRES_EVENT:
    case CPLD_MGMT_PORT_0_TX_FAULT_EVENT:
    case CPLD_MGMT_PORT_1_TX_FAULT_EVENT:
    case CPLD_MGMT_PORT_0_RX_LOS_EVENT:
    case CPLD_MGMT_PORT_1_RX_LOS_EVENT:
    case CPLD_MGMT_PORT_0_TX_DIS:
    case CPLD_MGMT_PORT_1_TX_DIS:
    case CPLD_MGMT_PORT_0_RX_RS:
    case CPLD_MGMT_PORT_1_RX_RS:
    case CPLD_MGMT_PORT_0_TX_RS:
    case CPLD_MGMT_PORT_1_TX_RS:
    ...
    case CPLD_QSFPDD_PORT_0_7_16_23_FUSE:
    case CPLD_QSFPDD_PORT_8_15_24_31_FUSE:
    case CPLD_QSFPDD_PORT_32_39_48_55_FUSE:
    case CPLD_QSFPDD_PORT_40_47_56_63_FUSE:
    ...
    case CPLD_QSFPDD_PORT_0_7_16_23_FUSE_MASK:
    case CPLD_QSFPDD_PORT_8_15_24_31_FUSE_MASK:
    case CPLD_QSFPDD_PORT_32_39_48_55_FUSE_MASK:
    case CPLD_QSFPDD_PORT_40_47_56_63_FUSE_MASK:
    ...
    case CPLD_QSFPDD_PORT_0_7_16_23_FUSE_EVENT:
    case CPLD_QSFPDD_PORT_8_15_24_31_FUSE_EVENT:
    case CPLD_QSFPDD_PORT_32_39_48_55_FUSE_EVENT:
    case CPLD_QSFPDD_PORT_40_47_56_63_FUSE_EVENT:
    ...
    case CPLD_DBG_QSFPDD_PORT_0_7_16_23_FUSE:
    case CPLD_DBG_QSFPDD_PORT_8_15_24_31_FUSE:
    case CPLD_DBG_QSFPDD_PORT_32_39_48_55_FUSE:
    case CPLD_DBG_QSFPDD_PORT_40_47_56_63_FUSE:
    case CPLD_MGMT_PORT_0_STUCK:
    case CPLD_MGMT_PORT_1_STUCK:
    case CPLD_MGMT_PORT_0_STUCK_MASK:
    case CPLD_MGMT_PORT_1_STUCK_MASK:
    case CPLD_MGMT_PORT_0_STUCK_EVENT:
    case CPLD_MGMT_PORT_1_STUCK_EVENT:
...
{
    int ret = 0;
    u8 reg_wp = CPLD_WRITE_PROTECT_1_REG;
    u8 reg_wp_val = 0;
    u8 reg_wp_mask = 0x01;
    u8 current_wp = 0;
...
static struct i2c_driver cpld_driver = {
    ...
    .driver = {
        .name = "x86_64_ufispace_s9311_64d_cpld",
    },
    .probe = cpld_probe,
    .remove = cpld_remove,
    .id_table = cpld_id,
...
MODULE_DESCRIPTION("x86_64_ufispace_s9311_64d_cpld driver");
