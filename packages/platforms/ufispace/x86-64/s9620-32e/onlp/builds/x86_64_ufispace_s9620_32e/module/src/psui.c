...
{
    {"DELTA", "DPS-3200AB-20 F", ONLP_PSU_TYPE_AC  , ONLP_FAN_STATUS_F2B},
    {"DELTA", "DPS-3200AB-21 D", ONLP_PSU_TYPE_DC48, ONLP_FAN_STATUS_F2B},
    {"DELTA", "DTQ3000AN12C12", ONLP_PSU_TYPE_AC   , ONLP_FAN_STATUS_F2B},
    {"DELTA", "DTQ3001DS12L1P", ONLP_PSU_TYPE_DC48 , ONLP_FAN_STATUS_F2B},
};
...
static int get_node(int id, psu_node_t* node)
{
    ...
    switch(node->local_id) {
        case ONLP_PSU_0:
            node->sysfs_abs   = SYSFS_CPLD1 "psu_0_prsnt";
            node->sysfs_pwrgd = SYSFS_CPLD1 "psu_0_pg";
            ...
            break;
        case ONLP_PSU_1:
            node->sysfs_abs   = SYSFS_CPLD1 "psu_1_prsnt";
            node->sysfs_pwrgd = SYSFS_CPLD1 "psu_1_pg";
