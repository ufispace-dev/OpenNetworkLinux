...
bmc_info_t bmc_cache[] =
{
    ...
    [BMC_ATTR_ID_TEMP_ENV_CPU]   = {HW_PLAT_ALPHA, BMC_ATTR_NAME_TEMP_ENV_CPU , BMC_DATA_FLOAT, 0},
    ...
    [BMC_ATTR_ID_TEMP_ENV_EXT0]  = {HW_PLAT_ALL, BMC_ATTR_NAME_TEMP_ENV_EXT0  , BMC_DATA_FLOAT, 0},
    ...
    [BMC_ATTR_ID_TEMP_ENV_MAC0]  = {HW_PLAT_BETA | HW_PLAT_PVT, BMC_ATTR_NAME_TEMP_ENV_MAC0  , BMC_DATA_FLOAT, 0},
    [BMC_ATTR_ID_TEMP_ENV_MAC1]  = {HW_PLAT_BETA | HW_PLAT_PVT, BMC_ATTR_NAME_TEMP_ENV_MAC1  , BMC_DATA_FLOAT, 0},
    [BMC_ATTR_ID_TEMP_MAC0]      = {HW_PLAT_BETA | HW_PLAT_PVT, BMC_ATTR_NAME_TEMP_MAC0      , BMC_DATA_FLOAT, 0},
    [BMC_ATTR_ID_TEMP_MAC1]      = {HW_PLAT_BETA | HW_PLAT_PVT, BMC_ATTR_NAME_TEMP_MAC1      , BMC_DATA_FLOAT, 0},
...
int read_bmc_fru(int fru_id, bmc_fru_t *data)
{
    ...
    if(bmc_cache_expired == 1 || fru->init_done == 0 || bmc_cache_change == 1) {
        ...
        while(fgets(line,BMC_FRU_LINE_SIZE, fp) != NULL) {
            ...
            key = strsep(&line_ptr, ":");
            // Use separator '\n' instead of ':' to handle multiple ':' in line_ptr
            val = strsep(&line_ptr, "\n");
