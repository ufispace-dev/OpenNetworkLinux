...
#define SYS_FAN_FRONT_MAX_RPM 16300
#define SYS_FAN_REAR_MAX_RPM  15500
#define PSU_FAN_RPM_MAX_AC    29500
#define PSU_FAN_RPM_MAX_DC    29500
...
static int get_node(int id, fan_node_t *node)
{
    ...
    switch(node->local_id) {
        case ONLP_FAN_0_F:
            node->present = BMC_ATTR_ID_FAN0_PRSNT_H;
        ...
        case ONLP_FAN_0_R:
           ...
           break;
        case ONLP_FAN_1_F:
            node->present = BMC_ATTR_ID_FAN1_PRSNT_H;
        ...
        case ONLP_FAN_1_R:
           ...
           break;
        case ONLP_FAN_2_F:
            node->present = BMC_ATTR_ID_FAN2_PRSNT_H;
        ...
        case ONLP_FAN_2_R:
           ...
           break;
        case ONLP_FAN_3_F:
            node->present = BMC_ATTR_ID_FAN3_PRSNT_H;
