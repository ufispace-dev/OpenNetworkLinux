/*
 * A lpc driver for the ufispace_s9720_56ed
 *
...
#define DRIVER_NAME "x86_64_ufispace_s9720_56ed_lpc"

/* LPC registers */

#define REG_BASE_BDE_CONFIG               0x500
#define REG_BASE_CPLD1                    0xE00
#define REG_BASE_CPU_CPLD                 0x600     
...
#define MUX_RST_REG                       (REG_BASE_CPLD1 + 0x46)
#define MISC_RST_REG                      (REG_BASE_CPLD1 + 0x47)
#define MUX_CTRL_REG                      (REG_BASE_CPLD1 + 0x5C)
//CPU_CPLD
#define CPU_CPLD_VERSION_REG              (REG_BASE_CPU_CPLD + 0x00)            
#define CPU_CPLD_BUILD_REG                (REG_BASE_CPU_CPLD + 0xE0)     
#define CPU_STATUS_1_REG                  (REG_BASE_CPU_CPLD + 0x02)   
#define CPU_CTRL_1_REG                    (REG_BASE_CPU_CPLD + 0x03) 
...
attr_reg_map_t attr_reg[]= {
    ...
    [MB_I2C_MUX_RST]       =         {MUX_RST_REG               , MASK_0000_0100, DATA_HEX},        
    ...
    //CPU_CPLD
    [CPU_CPLD_VERSION]     =         {CPU_CPLD_VERSION_REG      , MASK_ALL      , DATA_HEX},
    [CPU_CPLD_MINOR_VER]   =         {CPU_CPLD_VERSION_REG      , MASK_0011_1111, DATA_DEC},
    [CPU_CPLD_MAJOR_VER]   =         {CPU_CPLD_VERSION_REG      , MASK_1100_0000, DATA_DEC},
    [CPU_CPLD_BUILD_VER]   =         {CPU_CPLD_BUILD_REG        , MASK_ALL      , DATA_DEC},
    [CPU_CPLD_VERSION_H]   =         {REG_NONE                  , MASK_NONE     , DATA_UNK},
    [CPU_BIOS_BOOT_ROM]    =         {CPU_STATUS_1_REG          , MASK_1000_0000, DATA_DEC},
    [CPU_BIOS_BOOT_CFG]    =         {CPU_CTRL_1_REG            , MASK_1000_0000, DATA_DEC},
        ...
        struct device_attribute *da, char *buf)
{
    ...
    switch (attr->index) {
        case CPLD_VERSION_H:
            ...
            break;
        case CPU_CPLD_VERSION_H:
            attr_major = CPU_CPLD_MAJOR_VER;
            attr_minor = CPU_CPLD_MINOR_VER;
            attr_build = CPU_CPLD_BUILD_VER;
            break;
        ...
        struct device_attribute *da, char *buf)
{
    ...
    switch (attr->index) {
        ...
        case MB_I2C_MUX_RST:
        //CPU_CPLD
        case CPU_CPLD_VERSION:
        case CPU_CPLD_MINOR_VER:
        case CPU_CPLD_MAJOR_VER:
        case CPU_CPLD_BUILD_VER:
        case CPU_CPLD_VERSION_H:
        case CPU_BIOS_BOOT_ROM:
        case CPU_BIOS_BOOT_CFG:
...
static SENSOR_DEVICE_ATTR_RW(cpld_ioexp_rst      , lpc_callback     , CPLD_IOEXP_RST);
static SENSOR_DEVICE_ATTR_RW(fan_i2c_mux_rst     , lpc_callback     , FAN_I2C_MUX_RST);
static SENSOR_DEVICE_ATTR_RW(cpld_25gphy_rst     , lpc_callback     , CPLD_25GPHY_RST);
static SENSOR_DEVICE_ATTR_RW(i210_rst            , lpc_callback     , I210_RST);
static SENSOR_DEVICE_ATTR_RW(top_i2c_mux_rst     , lpc_callback     , TOP_I2C_MUX_RST);
static SENSOR_DEVICE_ATTR_RW(rc32312_1_rst       , lpc_callback     , RC32312_1_RST);
static SENSOR_DEVICE_ATTR_RW(rc32312_2_rst       , lpc_callback     , RC32312_2_RST);
static SENSOR_DEVICE_ATTR_RW(rc32312_3_rst       , lpc_callback     , RC32312_3_RST);
static SENSOR_DEVICE_ATTR_RW(mux_ctrl            , lpc_callback     , MUX_CTRL);
static SENSOR_DEVICE_ATTR_RW(mb_i2c_mux_rst      , lpc_callback     , MB_I2C_MUX_RST);
//SENSOR_DEVICE_ATTR - CPU_CPLD
static SENSOR_DEVICE_ATTR_RO(cpu_cpld_version    , lpc_callback       , CPU_CPLD_VERSION);
static SENSOR_DEVICE_ATTR_RO(cpu_cpld_minor_ver  , lpc_callback       , CPU_CPLD_MINOR_VER);
static SENSOR_DEVICE_ATTR_RO(cpu_cpld_major_ver  , lpc_callback       , CPU_CPLD_MAJOR_VER);
static SENSOR_DEVICE_ATTR_RO(cpu_cpld_build_ver  , lpc_callback       , CPU_CPLD_BUILD_VER);
static SENSOR_DEVICE_ATTR_RO(cpu_cpld_version_h  , cpld_version_h     , CPU_CPLD_VERSION_H);
static SENSOR_DEVICE_ATTR_RO(boot_rom            , lpc_callback       , CPU_BIOS_BOOT_ROM);
static SENSOR_DEVICE_ATTR_RO(boot_cfg            , lpc_callback       , CPU_BIOS_BOOT_CFG);
...
MODULE_DESCRIPTION("x86_64_ufispace_s9720_56ed_lpc driver");
