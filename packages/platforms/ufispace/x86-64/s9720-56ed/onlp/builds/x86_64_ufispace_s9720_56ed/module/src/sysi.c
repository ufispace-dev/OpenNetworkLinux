...
/* This is definitions for x86-64-ufispace-s9720-56ed */
/* OID map*/
/*
 * [01] CHASSIS
...
static onlp_oid_t __onlp_oid_info[] = {
    ...
    ONLP_THERMAL_ID_CREATE(ONLP_THERMAL_ENV_TOP0),
    ONLP_THERMAL_ID_CREATE(ONLP_THERMAL_ENV_TOP1),
...
#define SYSFS_CPU_CPLD_VER_H    LPC_CPU_CPLD "cpu_cpld_version_h"
...
{
    return "x86-64-ufispace-s9720-56ed-r0";
}
