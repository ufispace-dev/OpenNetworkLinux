...
static onlp_thermal_info_t thermal_info[] = {
    ...
    {
        .hdr = {
            .id = ONLP_THERMAL_ID_CREATE(ONLP_THERMAL_ENV_TOP0),
            .description = "TEMP_ENV_TOP0",
            .poid = POID_0,
        },
        .status = ONLP_THERMAL_STATUS_PRESENT,
        .caps = (ONLP_THERMAL_CAPS_ALL)
    ...
    {
        .hdr = {
            .id = ONLP_THERMAL_ID_CREATE(ONLP_THERMAL_ENV_TOP1),
            .description = "TEMP_ENV_TOP1",
            .poid = POID_0,
        },
        .status = ONLP_THERMAL_STATUS_PRESENT,
        .caps = (ONLP_THERMAL_CAPS_ALL)
...
static const thrm_attr_t thrm_attr[] = {
    ...
    [ONLP_THERMAL_ENV2]         =  {TYPE_THRM_ATTR_BMC  , BMC_ATTR_ID_TEMP_ENV2},   
    [ONLP_THERMAL_ENV3]         =  {TYPE_THRM_ATTR_BMC  , BMC_ATTR_ID_TEMP_ENV3},   
    [ONLP_THERMAL_ENV4]         =  {TYPE_THRM_ATTR_BMC  , BMC_ATTR_ID_TEMP_ENV4},   
    [ONLP_THERMAL_ENV5]         =  {TYPE_THRM_ATTR_BMC  , BMC_ATTR_ID_TEMP_ENV5},   
    [ONLP_THERMAL_ENV_EXT0]     =  {TYPE_THRM_ATTR_BMC  , BMC_ATTR_ID_TEMP_ENV_EXT0},       
    [ONLP_THERMAL_ENV_TOP0]     =  {TYPE_THRM_ATTR_BMC  , BMC_ATTR_ID_TEMP_ENV_TOP0},       
    [ONLP_THERMAL_ENV_TOP1]     =  {TYPE_THRM_ATTR_BMC  , BMC_ATTR_ID_TEMP_ENV_TOP1},       
    [ONLP_THERMAL_ENV_FAN0]     =  {TYPE_THRM_ATTR_BMC  , BMC_ATTR_ID_TEMP_ENV_FAN0},       
    [ONLP_THERMAL_ENV_FAN1]     =  {TYPE_THRM_ATTR_BMC  , BMC_ATTR_ID_TEMP_ENV_FAN1},       
    [ONLP_THERMAL_ENV_MAC0]     =  {TYPE_THRM_ATTR_BMC  , BMC_ATTR_ID_TEMP_ENV_MAC0},       
    [ONLP_THERMAL_ENV_MAC1]     =  {TYPE_THRM_ATTR_BMC  , BMC_ATTR_ID_TEMP_ENV_MAC1},
    [ONLP_THERMAL_MAC0]         =  {TYPE_THRM_ATTR_BMC  , BMC_ATTR_ID_TEMP_MAC0},       
    [ONLP_THERMAL_MAC1]         =  {TYPE_THRM_ATTR_BMC  , BMC_ATTR_ID_TEMP_MAC1},
    [ONLP_THERMAL_PSU0_TEMP1]   =  {TYPE_THRM_ATTR_BMC  , BMC_ATTR_ID_PSU0_TEMP1},
    [ONLP_THERMAL_PSU1_TEMP1]   =  {TYPE_THRM_ATTR_BMC  , BMC_ATTR_ID_PSU1_TEMP1},   
...
static int get_bmc_thermal_info(int local_id, onlp_thermal_info_t* info)
{
    ...
    *info = thermal_info[local_id];
    ...
    /* present */
    if(local_id == ONLP_THERMAL_PSU0_TEMP1 || local_id == ONLP_THERMAL_PSU1_TEMP1) {
