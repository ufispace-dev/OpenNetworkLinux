...
static const fan_attr_t fan_attr[] = {
    ...
    [ONLP_FAN_0_F]     = { BMC_ATTR_ID_FAN0_PRSNT_H , BMC_ATTR_ID_FAN0_RPM_FRONT , BMC_FRU_IDX_INVALID, BMC_FRU_IDX_INVALID},
    [ONLP_FAN_0_R]     = { BMC_ATTR_ID_FAN0_PRSNT_H , BMC_ATTR_ID_FAN0_RPM_REAR  , BMC_FRU_IDX_INVALID, BMC_FRU_IDX_INVALID},
    [ONLP_FAN_1_F]     = { BMC_ATTR_ID_FAN1_PRSNT_H , BMC_ATTR_ID_FAN1_RPM_FRONT , BMC_FRU_IDX_INVALID, BMC_FRU_IDX_INVALID},
    [ONLP_FAN_1_R]     = { BMC_ATTR_ID_FAN1_PRSNT_H , BMC_ATTR_ID_FAN1_RPM_REAR  , BMC_FRU_IDX_INVALID, BMC_FRU_IDX_INVALID},
    [ONLP_FAN_2_F]     = { BMC_ATTR_ID_FAN2_PRSNT_H , BMC_ATTR_ID_FAN2_RPM_FRONT , BMC_FRU_IDX_INVALID, BMC_FRU_IDX_INVALID},
    [ONLP_FAN_2_R]     = { BMC_ATTR_ID_FAN2_PRSNT_H , BMC_ATTR_ID_FAN2_RPM_REAR  , BMC_FRU_IDX_INVALID, BMC_FRU_IDX_INVALID},
    [ONLP_FAN_3_F]     = { BMC_ATTR_ID_FAN3_PRSNT_H , BMC_ATTR_ID_FAN3_RPM_FRONT , BMC_FRU_IDX_INVALID, BMC_FRU_IDX_INVALID},
    [ONLP_FAN_3_R]     = { BMC_ATTR_ID_FAN3_PRSNT_H , BMC_ATTR_ID_FAN3_RPM_REAR  , BMC_FRU_IDX_INVALID, BMC_FRU_IDX_INVALID},
