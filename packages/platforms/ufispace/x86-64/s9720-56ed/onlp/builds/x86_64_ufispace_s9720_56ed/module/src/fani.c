...
#define SYS_FAN_FRONT_RPM_MAX    12000
#define SYS_FAN_REAR_RPM_MAX     11300
...
static const fan_attr_t fan_attr[] = {
    ...
    [ONLP_FAN_0_F]     = { BMC_ATTR_ID_FAN0_PRSNT_H , BMC_ATTR_ID_FAN0_RPM_FRONT , BMC_FRU_IDX_INVALID, BMC_FRU_IDX_FAN_TRAY_0},
    [ONLP_FAN_0_R]     = { BMC_ATTR_ID_FAN0_PRSNT_H , BMC_ATTR_ID_FAN0_RPM_REAR  , BMC_FRU_IDX_INVALID, BMC_FRU_IDX_FAN_TRAY_0},
    [ONLP_FAN_1_F]     = { BMC_ATTR_ID_FAN1_PRSNT_H , BMC_ATTR_ID_FAN1_RPM_FRONT , BMC_FRU_IDX_INVALID, BMC_FRU_IDX_FAN_TRAY_1},
    [ONLP_FAN_1_R]     = { BMC_ATTR_ID_FAN1_PRSNT_H , BMC_ATTR_ID_FAN1_RPM_REAR  , BMC_FRU_IDX_INVALID, BMC_FRU_IDX_FAN_TRAY_1},
    [ONLP_FAN_2_F]     = { BMC_ATTR_ID_FAN2_PRSNT_H , BMC_ATTR_ID_FAN2_RPM_FRONT , BMC_FRU_IDX_INVALID, BMC_FRU_IDX_FAN_TRAY_2},
    [ONLP_FAN_2_R]     = { BMC_ATTR_ID_FAN2_PRSNT_H , BMC_ATTR_ID_FAN2_RPM_REAR  , BMC_FRU_IDX_INVALID, BMC_FRU_IDX_FAN_TRAY_2},
    [ONLP_FAN_3_F]     = { BMC_ATTR_ID_FAN3_PRSNT_H , BMC_ATTR_ID_FAN3_RPM_FRONT , BMC_FRU_IDX_INVALID, BMC_FRU_IDX_FAN_TRAY_3},
    [ONLP_FAN_3_R]     = { BMC_ATTR_ID_FAN3_PRSNT_H , BMC_ATTR_ID_FAN3_RPM_REAR  , BMC_FRU_IDX_INVALID, BMC_FRU_IDX_FAN_TRAY_3},
    [ONLP_PSU_0_FAN]   = { BMC_ATTR_ID_PSU0_PRSNT_L , BMC_ATTR_ID_PSU0_FAN       , BMC_FRU_IDX_INVALID, BMC_FRU_IDX_INVALID},
    [ONLP_PSU_1_FAN]   = { BMC_ATTR_ID_PSU1_PRSNT_L , BMC_ATTR_ID_PSU1_FAN       , BMC_FRU_IDX_INVALID, BMC_FRU_IDX_INVALID},
};
...
static int get_bmc_fan_info(int local_id, onlp_fan_info_t* info)
{
    ...
    float data=0;
    int sys_max_fan_front_speed = SYS_FAN_FRONT_RPM_MAX;
    int sys_max_fan_rear_speed = SYS_FAN_REAR_RPM_MAX;
    ...
    *info = fan_info[local_id];
    ...
    if(info->status & ONLP_FAN_STATUS_PRESENT) {
        ...
        switch(local_id) {
            ...
            case ONLP_FAN_3_F:
            {
                sys_max_fan_front_speed = SYS_FAN_FRONT_RPM_MAX;
                percentage = (info->rpm*100)/sys_max_fan_front_speed;
            ...
            case ONLP_FAN_3_R:
            {
                sys_max_fan_rear_speed = SYS_FAN_REAR_RPM_MAX;
                percentage = (info->rpm*100)/sys_max_fan_rear_speed;
                info->percentage = (percentage >= 100) ? 100:percentage;
                info->status |= (rpm == 0) ? ONLP_FAN_STATUS_FAILED : 0;
                break;
            }
