...
/*  led attribute            action          attr              color blink onoff */
    [ONLP_LED_SYS_SYNC]    = {ACTION_LED_RW, CPLD_LED_SYNC    ,0     ,2    ,3},
    [ONLP_LED_SYS_SYS]     = {ACTION_LED_RW, CPLD_LED_SYS     ,0     ,2    ,3},
    [ONLP_LED_SYS_FAN]     = {ACTION_LED_RO, CPLD_LED_FAN     ,0     ,2    ,3},
    [ONLP_LED_SYS_PSU0]    = {ACTION_LED_RO, CPLD_LED_PSU_0   ,0     ,2    ,3},
    [ONLP_LED_SYS_PSU1]    = {ACTION_LED_RO, CPLD_LED_PSU_1   ,0     ,2    ,3},
};
...
static int get_led_sysfs(cpld_attr_idx_t idx, char** str)
{
    ...
    switch(idx) {
        case CPLD_LED_PSU_0:
            *str = SYSFS_CPLD1 "psu_0_led_status";
            break;
        case CPLD_LED_PSU_1:
            *str = SYSFS_CPLD1 "psu_1_led_status";
            break;
        case CPLD_LED_SYS:
           *str =  SYSFS_CPLD1 "system_led_status";
           break;
        case CPLD_LED_SYNC:
