/*
 * A i2c cpld driver for the ufispace_s9610_48dx
 *
...
#include "x86-64-ufispace-s9610-48dx-cpld.h"
...
enum cpld_sysfs_attributes {
    ...
    //CPLD 2-3
    CPLD_QSFP_INTR_PORT_0,
    CPLD_QSFP_INTR_PORT_1,
    CPLD_QSFP_INTR_PORT_2,
    CPLD_QSFP_INTR_PRESENT_0,
    CPLD_QSFP_INTR_PRESENT_1,
    CPLD_QSFP_INTR_PRESENT_2,
    CPLD_QSFP_INTR_FUSE_0,
    CPLD_QSFP_INTR_FUSE_1,
    CPLD_QSFP_INTR_FUSE_2,
    CPLD_QSFP_MASK_PORT_0,
    CPLD_QSFP_MASK_PORT_1,
    CPLD_QSFP_MASK_PORT_2,
    CPLD_QSFP_MASK_PRESENT_0,
    CPLD_QSFP_MASK_PRESENT_1,
    CPLD_QSFP_MASK_PRESENT_2,
    CPLD_QSFP_MASK_FUSE_0,
    CPLD_QSFP_MASK_FUSE_1,
    CPLD_QSFP_MASK_FUSE_2,
    CPLD_QSFP_EVT_PORT_0,
    CPLD_QSFP_EVT_PORT_1,
    CPLD_QSFP_EVT_PORT_2,
    CPLD_QSFP_EVT_PRESENT_0,
    CPLD_QSFP_EVT_PRESENT_1,
    CPLD_QSFP_EVT_PRESENT_2,
    CPLD_QSFP_EVT_FUSE_0,
    CPLD_QSFP_EVT_FUSE_1,
    CPLD_QSFP_EVT_FUSE_2,
    CPLD_QSFP_RESET_0,
    CPLD_QSFP_RESET_1,
    CPLD_QSFP_RESET_2,
    CPLD_QSFP_LPMODE_0,
    ...
    CPLD_QSFP_LED_4,
    CPLD_SFPDD_LED,
    DBG_CPLD_QSFP_INTR_PORT_0,
    DBG_CPLD_QSFP_INTR_PORT_1,
    DBG_CPLD_QSFP_INTR_PORT_2,
    DBG_CPLD_QSFP_INTR_PRESENT_0,
    DBG_CPLD_QSFP_INTR_PRESENT_1,
    DBG_CPLD_QSFP_INTR_PRESENT_2,
    DBG_CPLD_QSFP_INTR_FUSE_0,
    DBG_CPLD_QSFP_INTR_FUSE_1,
    DBG_CPLD_QSFP_INTR_FUSE_2,
    ...
    CPLD_GBOX_INTR_2,
    CPLD_PHY_MASK,
    CPLD_GBOX_MASK_INTR_0,
    CPLD_GBOX_MASK_INTR_1,
    CPLD_GBOX_MASK_INTR_2,
    CPLD_QSFPDD_INTR_PORT,
    CPLD_QSFPDD_INTR_PRESENT,
    CPLD_QSFPDD_INTR_FUSE,
    CPLD_QSFPDD_MASK_PORT,
    CPLD_QSFPDD_MASK_PRESENT,
    CPLD_QSFPDD_MASK_FUSE,
    CPLD_QSFPDD_EVT_PORT,
    CPLD_QSFPDD_EVT_PRESENT,
    CPLD_QSFPDD_EVT_FUSE,
    CPLD_SFPDD_INTR_PRESENT,
    CPLD_SFPDD_MASK_PRESENT,
    CPLD_SFPDD_EVT_PRESENT,
    CPLD_SFP28_INTR_PRESENT,
    CPLD_SFP28_MASK_PRESENT,
    ...
    CPLD_GBOX_SERBOOT_0,
    CPLD_GBOX_SERBOOT_1,
    CPLD_SFPDD_28_TX_FAULT,
    CPLD_SFPDD_28_RX_LOS,
    CPLD_SFPDD_28_MASK_TX_FAULT,
    CPLD_SFPDD_28_MASK_RX_LOS,
    CPLD_SFPDD_28_EVT_TX_FAULT,
    ...
    DBG_CPLD_PHY_INTR,
    DBG_CPLD_GBOX_INTR_0,
    DBG_CPLD_GBOX_INTR_1,
    DBG_CPLD_GBOX_INTR_2,
...
static const struct i2c_device_id cpld_id[] = {
    { "s9610_48dx_cpld1",  cpld1 },
    { "s9610_48dx_cpld2",  cpld2 },
    { "s9610_48dx_cpld3",  cpld3 },
    { "s9610_48dx_cpld4",  cpld4 },
    {}
};
...
static _SENSOR_DEVICE_ATTR_RW(cpld_i2c_mux_qsfpdd_reset, cpld_callback, CPLD_I2C_MUX_QSFPDD_RESET);
...
static _SENSOR_DEVICE_ATTR_RW(cpld_mgmt_p2_led,      cpld_callback, CPLD_MGMT_P2_LED);
static _SENSOR_DEVICE_ATTR_RW(cpld_mgmt_p3_led,      cpld_callback, CPLD_MGMT_P3_LED);
...
static _SENSOR_DEVICE_ATTR_RO(cpld_qsfp_intr_port_0, cpld_callback, CPLD_QSFP_INTR_PORT_0);
static _SENSOR_DEVICE_ATTR_RO(cpld_qsfp_intr_port_1, cpld_callback, CPLD_QSFP_INTR_PORT_1);
static _SENSOR_DEVICE_ATTR_RO(cpld_qsfp_intr_port_2, cpld_callback, CPLD_QSFP_INTR_PORT_2);

static _SENSOR_DEVICE_ATTR_RO(cpld_qsfp_intr_present_0, cpld_callback, CPLD_QSFP_INTR_PRESENT_0);
static _SENSOR_DEVICE_ATTR_RO(cpld_qsfp_intr_present_1, cpld_callback, CPLD_QSFP_INTR_PRESENT_1);
static _SENSOR_DEVICE_ATTR_RO(cpld_qsfp_intr_present_2, cpld_callback, CPLD_QSFP_INTR_PRESENT_2);

static _SENSOR_DEVICE_ATTR_RO(cpld_qsfp_intr_fuse_0, cpld_callback, CPLD_QSFP_INTR_FUSE_0);
static _SENSOR_DEVICE_ATTR_RO(cpld_qsfp_intr_fuse_1, cpld_callback, CPLD_QSFP_INTR_FUSE_1);
static _SENSOR_DEVICE_ATTR_RO(cpld_qsfp_intr_fuse_2, cpld_callback, CPLD_QSFP_INTR_FUSE_2);

static _SENSOR_DEVICE_ATTR_RW(cpld_qsfp_mask_port_0, cpld_callback, CPLD_QSFP_MASK_PORT_0);
static _SENSOR_DEVICE_ATTR_RW(cpld_qsfp_mask_port_1, cpld_callback, CPLD_QSFP_MASK_PORT_1);
static _SENSOR_DEVICE_ATTR_RW(cpld_qsfp_mask_port_2, cpld_callback, CPLD_QSFP_MASK_PORT_2);

static _SENSOR_DEVICE_ATTR_RW(cpld_qsfp_mask_present_0, cpld_callback, CPLD_QSFP_MASK_PRESENT_0);
static _SENSOR_DEVICE_ATTR_RW(cpld_qsfp_mask_present_1, cpld_callback, CPLD_QSFP_MASK_PRESENT_1);
static _SENSOR_DEVICE_ATTR_RW(cpld_qsfp_mask_present_2, cpld_callback, CPLD_QSFP_MASK_PRESENT_2);

static _SENSOR_DEVICE_ATTR_RW(cpld_qsfp_mask_fuse_0, cpld_callback, CPLD_QSFP_MASK_FUSE_0);
static _SENSOR_DEVICE_ATTR_RW(cpld_qsfp_mask_fuse_1, cpld_callback, CPLD_QSFP_MASK_FUSE_1);
static _SENSOR_DEVICE_ATTR_RW(cpld_qsfp_mask_fuse_2, cpld_callback, CPLD_QSFP_MASK_FUSE_2);

static _SENSOR_DEVICE_ATTR_RO(cpld_qsfp_evt_port_0, cpld_callback, CPLD_QSFP_EVT_PORT_0);
static _SENSOR_DEVICE_ATTR_RO(cpld_qsfp_evt_port_1, cpld_callback, CPLD_QSFP_EVT_PORT_1);
static _SENSOR_DEVICE_ATTR_RO(cpld_qsfp_evt_port_2, cpld_callback, CPLD_QSFP_EVT_PORT_2);

static _SENSOR_DEVICE_ATTR_RO(cpld_qsfp_evt_present_0, cpld_callback, CPLD_QSFP_EVT_PRESENT_0);
static _SENSOR_DEVICE_ATTR_RO(cpld_qsfp_evt_present_1, cpld_callback, CPLD_QSFP_EVT_PRESENT_1);
static _SENSOR_DEVICE_ATTR_RO(cpld_qsfp_evt_present_2, cpld_callback, CPLD_QSFP_EVT_PRESENT_2);

static _SENSOR_DEVICE_ATTR_RO(cpld_qsfp_evt_fuse_0, cpld_callback, CPLD_QSFP_EVT_FUSE_0);
static _SENSOR_DEVICE_ATTR_RO(cpld_qsfp_evt_fuse_1, cpld_callback, CPLD_QSFP_EVT_FUSE_1);
static _SENSOR_DEVICE_ATTR_RO(cpld_qsfp_evt_fuse_2, cpld_callback, CPLD_QSFP_EVT_FUSE_2);


static _SENSOR_DEVICE_ATTR_RW(cpld_qsfp_reset_0, cpld_callback, CPLD_QSFP_RESET_0);
static _SENSOR_DEVICE_ATTR_RW(cpld_qsfp_reset_1, cpld_callback, CPLD_QSFP_RESET_1);
static _SENSOR_DEVICE_ATTR_RW(cpld_qsfp_reset_2, cpld_callback, CPLD_QSFP_RESET_2);

static _SENSOR_DEVICE_ATTR_RW(cpld_qsfp_lpmode_0, cpld_callback, CPLD_QSFP_LPMODE_0);
static _SENSOR_DEVICE_ATTR_RW(cpld_qsfp_lpmode_1, cpld_callback, CPLD_QSFP_LPMODE_1);
static _SENSOR_DEVICE_ATTR_RW(cpld_qsfp_lpmode_2, cpld_callback, CPLD_QSFP_LPMODE_2);

static _SENSOR_DEVICE_ATTR_RW(cpld_qsfp_led_0, cpld_callback, CPLD_QSFP_LED_0);
static _SENSOR_DEVICE_ATTR_RW(cpld_qsfp_led_1, cpld_callback, CPLD_QSFP_LED_1);
static _SENSOR_DEVICE_ATTR_RW(cpld_qsfp_led_2, cpld_callback, CPLD_QSFP_LED_2);
static _SENSOR_DEVICE_ATTR_RW(cpld_qsfp_led_3, cpld_callback, CPLD_QSFP_LED_3);
static _SENSOR_DEVICE_ATTR_RW(cpld_qsfp_led_4, cpld_callback, CPLD_QSFP_LED_4);
static _SENSOR_DEVICE_ATTR_RW(cpld_sfpdd_led, cpld_callback, CPLD_SFPDD_LED);

static _SENSOR_DEVICE_ATTR_RW(dbg_cpld_qsfp_intr_port_0, cpld_callback, DBG_CPLD_QSFP_INTR_PORT_0);
static _SENSOR_DEVICE_ATTR_RW(dbg_cpld_qsfp_intr_port_1, cpld_callback, DBG_CPLD_QSFP_INTR_PORT_1);
static _SENSOR_DEVICE_ATTR_RW(dbg_cpld_qsfp_intr_port_2, cpld_callback, DBG_CPLD_QSFP_INTR_PORT_2);

static _SENSOR_DEVICE_ATTR_RW(dbg_cpld_qsfp_intr_present_0, cpld_callback, DBG_CPLD_QSFP_INTR_PRESENT_0);
static _SENSOR_DEVICE_ATTR_RW(dbg_cpld_qsfp_intr_present_1, cpld_callback, DBG_CPLD_QSFP_INTR_PRESENT_1);
static _SENSOR_DEVICE_ATTR_RW(dbg_cpld_qsfp_intr_present_2, cpld_callback, DBG_CPLD_QSFP_INTR_PRESENT_2);

static _SENSOR_DEVICE_ATTR_RW(dbg_cpld_qsfp_intr_fuse_0, cpld_callback, DBG_CPLD_QSFP_INTR_FUSE_0);
static _SENSOR_DEVICE_ATTR_RW(dbg_cpld_qsfp_intr_fuse_1, cpld_callback, DBG_CPLD_QSFP_INTR_FUSE_1);
static _SENSOR_DEVICE_ATTR_RW(dbg_cpld_qsfp_intr_fuse_2, cpld_callback, DBG_CPLD_QSFP_INTR_FUSE_2);

//CPLD 4
static _SENSOR_DEVICE_ATTR_RO(cpld_phy_intr, cpld_callback, CPLD_PHY_INTR);
static _SENSOR_DEVICE_ATTR_RO(cpld_gbox_intr_0, cpld_callback, CPLD_GBOX_INTR_0);
static _SENSOR_DEVICE_ATTR_RO(cpld_gbox_intr_1, cpld_callback, CPLD_GBOX_INTR_1);
static _SENSOR_DEVICE_ATTR_RO(cpld_gbox_intr_2, cpld_callback, CPLD_GBOX_INTR_2);


static _SENSOR_DEVICE_ATTR_RW(cpld_phy_mask, cpld_callback, CPLD_PHY_MASK);
static _SENSOR_DEVICE_ATTR_RW(cpld_gbox_mask_intr_0, cpld_callback, CPLD_GBOX_MASK_INTR_0);
static _SENSOR_DEVICE_ATTR_RW(cpld_gbox_mask_intr_1, cpld_callback, CPLD_GBOX_MASK_INTR_1);
static _SENSOR_DEVICE_ATTR_RW(cpld_gbox_mask_intr_2, cpld_callback, CPLD_GBOX_MASK_INTR_2);

static _SENSOR_DEVICE_ATTR_RO(dbg_cpld_phy_intr,   cpld_callback, DBG_CPLD_PHY_INTR);
static _SENSOR_DEVICE_ATTR_RO(dbg_cpld_gbox_intr_0, cpld_callback, DBG_CPLD_GBOX_INTR_0);
static _SENSOR_DEVICE_ATTR_RO(dbg_cpld_gbox_intr_1, cpld_callback, DBG_CPLD_GBOX_INTR_1);
static _SENSOR_DEVICE_ATTR_RO(dbg_cpld_gbox_intr_2, cpld_callback, DBG_CPLD_GBOX_INTR_2);

//CPLD 4 QSFPDD
static _SENSOR_DEVICE_ATTR_RO(cpld_qsfpdd_intr_port, cpld_callback, CPLD_QSFPDD_INTR_PORT);
static _SENSOR_DEVICE_ATTR_RO(cpld_qsfpdd_intr_present, cpld_callback, CPLD_QSFPDD_INTR_PRESENT);
static _SENSOR_DEVICE_ATTR_RO(cpld_qsfpdd_intr_fuse, cpld_callback, CPLD_QSFPDD_INTR_FUSE);
static _SENSOR_DEVICE_ATTR_RW(cpld_qsfpdd_mask_port, cpld_callback, CPLD_QSFPDD_MASK_PORT);
static _SENSOR_DEVICE_ATTR_RW(cpld_qsfpdd_mask_present, cpld_callback, CPLD_QSFPDD_MASK_PRESENT);
static _SENSOR_DEVICE_ATTR_RW(cpld_qsfpdd_mask_fuse, cpld_callback, CPLD_QSFPDD_MASK_FUSE);
static _SENSOR_DEVICE_ATTR_RO(cpld_qsfpdd_evt_port, cpld_callback, CPLD_QSFPDD_EVT_PORT);
static _SENSOR_DEVICE_ATTR_RO(cpld_qsfpdd_evt_present, cpld_callback, CPLD_QSFPDD_EVT_PRESENT);
static _SENSOR_DEVICE_ATTR_RO(cpld_qsfpdd_evt_fuse, cpld_callback, CPLD_QSFPDD_EVT_FUSE);
static _SENSOR_DEVICE_ATTR_RO(cpld_sfpdd_intr_present, cpld_callback, CPLD_SFPDD_INTR_PRESENT);
static _SENSOR_DEVICE_ATTR_RW(cpld_sfpdd_mask_present, cpld_callback, CPLD_SFPDD_MASK_PRESENT);
static _SENSOR_DEVICE_ATTR_RO(cpld_sfpdd_evt_present, cpld_callback, CPLD_SFPDD_EVT_PRESENT);
static _SENSOR_DEVICE_ATTR_RO(cpld_sfp28_intr_present, cpld_callback, CPLD_SFP28_INTR_PRESENT);
static _SENSOR_DEVICE_ATTR_RW(cpld_sfp28_mask_present, cpld_callback, CPLD_SFP28_MASK_PRESENT);
...
static _SENSOR_DEVICE_ATTR_RW(cpld_sfp28_led_2, cpld_callback, CPLD_SFP28_LED_2);
static _SENSOR_DEVICE_ATTR_RW(cpld_sfp28_led_3, cpld_callback, CPLD_SFP28_LED_3);
static _SENSOR_DEVICE_ATTR_RO(cpld_brd_present, cpld_callback, CPLD_BRD_PRESENT);
static _SENSOR_DEVICE_ATTR_RW(cpld_gbox_serboot_0, cpld_callback, CPLD_GBOX_SERBOOT_0);
static _SENSOR_DEVICE_ATTR_RW(cpld_gbox_serboot_1, cpld_callback, CPLD_GBOX_SERBOOT_1);
static _SENSOR_DEVICE_ATTR_RO(cpld_sfpdd_28_tx_fault, cpld_callback, CPLD_SFPDD_28_TX_FAULT);
static _SENSOR_DEVICE_ATTR_RO(cpld_sfpdd_28_rx_los, cpld_callback, CPLD_SFPDD_28_RX_LOS);
static _SENSOR_DEVICE_ATTR_RW(cpld_sfpdd_28_mask_tx_fault,   cpld_callback, CPLD_SFPDD_28_MASK_TX_FAULT);
static _SENSOR_DEVICE_ATTR_RW(cpld_sfpdd_28_mask_rx_los,   cpld_callback, CPLD_SFPDD_28_MASK_RX_LOS);
static _SENSOR_DEVICE_ATTR_RO(cpld_sfpdd_28_evt_tx_fault,    cpld_callback, CPLD_SFPDD_28_EVT_TX_FAULT);
...
static struct attribute *cpld1_attributes[] = {
    ...
    _DEVICE_ATTR(cpld_i2c_mux_qsfpdd_reset),
    ...
    _DEVICE_ATTR(cpld_mgmt_p2_led),
    _DEVICE_ATTR(cpld_mgmt_p3_led),
...
static struct attribute *cpld2_attributes[] = {
    ...
    _DEVICE_ATTR(cpld_qsfp_intr_port_0),
    _DEVICE_ATTR(cpld_qsfp_intr_port_1),
    _DEVICE_ATTR(cpld_qsfp_intr_port_2),

    _DEVICE_ATTR(cpld_qsfp_intr_present_0),
    _DEVICE_ATTR(cpld_qsfp_intr_present_1),
    _DEVICE_ATTR(cpld_qsfp_intr_present_2),

    _DEVICE_ATTR(cpld_qsfp_intr_fuse_0),
    _DEVICE_ATTR(cpld_qsfp_intr_fuse_1),
    _DEVICE_ATTR(cpld_qsfp_intr_fuse_2),

    _DEVICE_ATTR(cpld_qsfp_mask_port_0),
    _DEVICE_ATTR(cpld_qsfp_mask_port_1),
    _DEVICE_ATTR(cpld_qsfp_mask_port_2),

    _DEVICE_ATTR(cpld_qsfp_mask_present_0),
    _DEVICE_ATTR(cpld_qsfp_mask_present_1),
    _DEVICE_ATTR(cpld_qsfp_mask_present_2),

    _DEVICE_ATTR(cpld_qsfp_mask_fuse_0),
    _DEVICE_ATTR(cpld_qsfp_mask_fuse_1),
    _DEVICE_ATTR(cpld_qsfp_mask_fuse_2),

    _DEVICE_ATTR(cpld_qsfp_evt_port_0),
    _DEVICE_ATTR(cpld_qsfp_evt_port_1),
    _DEVICE_ATTR(cpld_qsfp_evt_port_2),

    _DEVICE_ATTR(cpld_qsfp_evt_present_0),
    _DEVICE_ATTR(cpld_qsfp_evt_present_1),
    _DEVICE_ATTR(cpld_qsfp_evt_present_2),

    _DEVICE_ATTR(cpld_qsfp_evt_fuse_0),
    _DEVICE_ATTR(cpld_qsfp_evt_fuse_1),
    _DEVICE_ATTR(cpld_qsfp_evt_fuse_2),

    _DEVICE_ATTR(cpld_evt_ctrl),

    _DEVICE_ATTR(cpld_qsfp_reset_0),
    _DEVICE_ATTR(cpld_qsfp_reset_1),
    _DEVICE_ATTR(cpld_qsfp_reset_2),

    _DEVICE_ATTR(cpld_qsfp_lpmode_0),
    _DEVICE_ATTR(cpld_qsfp_lpmode_1),
    _DEVICE_ATTR(cpld_qsfp_lpmode_2),

    _DEVICE_ATTR(cpld_qsfp_led_0),
    _DEVICE_ATTR(cpld_qsfp_led_1),
    _DEVICE_ATTR(cpld_qsfp_led_2),
    _DEVICE_ATTR(cpld_qsfp_led_3),
    _DEVICE_ATTR(cpld_qsfp_led_4),

    _DEVICE_ATTR(cpld_sfpdd_led),

    _DEVICE_ATTR(dbg_cpld_qsfp_intr_port_0),
    _DEVICE_ATTR(dbg_cpld_qsfp_intr_port_1),
    _DEVICE_ATTR(dbg_cpld_qsfp_intr_port_2),

    _DEVICE_ATTR(dbg_cpld_qsfp_intr_present_0),
    _DEVICE_ATTR(dbg_cpld_qsfp_intr_present_1),
    _DEVICE_ATTR(dbg_cpld_qsfp_intr_present_2),

    _DEVICE_ATTR(dbg_cpld_qsfp_intr_fuse_0),
...
static struct attribute *cpld4_attributes[] = {
    ...
    _DEVICE_ATTR(cpld_gbox_intr_0),
    _DEVICE_ATTR(cpld_gbox_intr_1),
    _DEVICE_ATTR(cpld_gbox_intr_2),
    _DEVICE_ATTR(cpld_phy_mask),
    _DEVICE_ATTR(cpld_gbox_mask_intr_0),
    _DEVICE_ATTR(cpld_gbox_mask_intr_1),
    _DEVICE_ATTR(cpld_gbox_mask_intr_2),

    _DEVICE_ATTR(cpld_qsfpdd_intr_port),
    _DEVICE_ATTR(cpld_qsfpdd_intr_present),
    _DEVICE_ATTR(cpld_qsfpdd_intr_fuse),
    _DEVICE_ATTR(cpld_qsfpdd_mask_port),
    _DEVICE_ATTR(cpld_qsfpdd_mask_present),
    _DEVICE_ATTR(cpld_qsfpdd_mask_fuse),
    _DEVICE_ATTR(cpld_qsfpdd_evt_port),
    _DEVICE_ATTR(cpld_qsfpdd_evt_present),
    _DEVICE_ATTR(cpld_qsfpdd_evt_fuse),
    _DEVICE_ATTR(cpld_sfpdd_intr_present),
    _DEVICE_ATTR(cpld_sfpdd_mask_present),
    _DEVICE_ATTR(cpld_sfpdd_evt_present),
    _DEVICE_ATTR(cpld_sfp28_intr_present),
    _DEVICE_ATTR(cpld_sfp28_mask_present),
    _DEVICE_ATTR(cpld_sfp28_evt_present),
    ...
    _DEVICE_ATTR(cpld_sfp28_led_2),
    _DEVICE_ATTR(cpld_sfp28_led_3),
    _DEVICE_ATTR(cpld_brd_present),
    _DEVICE_ATTR(cpld_gbox_serboot_0),
    _DEVICE_ATTR(cpld_gbox_serboot_1),
    _DEVICE_ATTR(cpld_sfpdd_28_tx_fault),
    _DEVICE_ATTR(cpld_sfpdd_28_rx_los),
    _DEVICE_ATTR(cpld_sfpdd_28_mask_tx_fault),
    _DEVICE_ATTR(cpld_sfpdd_28_mask_rx_los),
    _DEVICE_ATTR(cpld_sfpdd_28_evt_tx_fault),
    ...
    _DEVICE_ATTR(dbg_cpld_gbox_intr_0),
    _DEVICE_ATTR(dbg_cpld_gbox_intr_1),
    _DEVICE_ATTR(dbg_cpld_gbox_intr_2),


    _DEVICE_ATTR(dbg_cpld_qsfpdd_intr_port),
    _DEVICE_ATTR(dbg_cpld_qsfpdd_intr_present),
    _DEVICE_ATTR(dbg_cpld_qsfpdd_intr_fuse),
        ...
        struct device_attribute *da, char *buf)
{
    ...
    switch (attr->index) {
        ...
        case CPLD_CPLDX_RESET:
            ...
            break;
        case CPLD_I2C_MUX_QSFPDD_RESET:
            reg = CPLD_I2C_MUX_QSFPDD_RESET_REG;
            break;
        ...
        case CPLD_MGMT_P0_LED:
            reg = CPLD_MGMT_0_1_LED_CTRL_REG;
            mask = MASK_LB;
            break;
        case CPLD_MGMT_P1_LED:
            ...
            mask = MASK_HB;
            break;
        case CPLD_MGMT_P2_LED:
            reg = CPLD_MGMT_2_3_LED_CTRL_REG;
            mask = MASK_LB;
            break;
        case CPLD_MGMT_P3_LED:
            reg = CPLD_MGMT_2_3_LED_CTRL_REG;
            mask = MASK_HB;
            break;
        case CPLD_QSFP_INTR_PORT_0 ... CPLD_QSFP_INTR_PORT_2:
            reg = CPLD_QSFP_INTR_PORT_BASE_REG +
                 (attr->index - CPLD_QSFP_INTR_PORT_0);
            break;
        case CPLD_QSFP_INTR_PRESENT_0 ... CPLD_QSFP_INTR_PRESENT_2:
            reg = CPLD_QSFP_INTR_PRESENT_BASE_REG +
                 (attr->index - CPLD_QSFP_INTR_PRESENT_0);
            break;
        case CPLD_QSFP_INTR_FUSE_0 ... CPLD_QSFP_INTR_FUSE_2:
            reg = CPLD_QSFP_INTR_FUSE_BASE_REG +
                 (attr->index - CPLD_QSFP_INTR_FUSE_0);
            break;
        case CPLD_QSFP_MASK_PORT_0 ... CPLD_QSFP_MASK_PORT_2:
            reg = CPLD_QSFP_MASK_PORT_BASE_REG +
                 (attr->index - CPLD_QSFP_MASK_PORT_0);
            break;
        case CPLD_QSFP_MASK_PRESENT_0 ... CPLD_QSFP_MASK_PRESENT_2:
            reg = CPLD_QSFP_MASK_PRESENT_BASE_REG +
                 (attr->index - CPLD_QSFP_MASK_PRESENT_0);
            break;
        case CPLD_QSFP_MASK_FUSE_0 ... CPLD_QSFP_MASK_FUSE_2:
            reg = CPLD_QSFP_MASK_FUSE_BASE_REG +
                 (attr->index - CPLD_QSFP_MASK_FUSE_0);
            break;
        case CPLD_QSFP_EVT_PORT_0 ... CPLD_QSFP_EVT_PORT_2:
            reg = CPLD_QSFP_EVT_PORT_BASE_REG +
                 (attr->index - CPLD_QSFP_EVT_PORT_0);
            break;
        case CPLD_QSFP_EVT_PRESENT_0 ... CPLD_QSFP_EVT_PRESENT_2:
            reg = CPLD_QSFP_EVT_PRESENT_BASE_REG +
                 (attr->index - CPLD_QSFP_EVT_PRESENT_0);
            break;
        case CPLD_QSFP_EVT_FUSE_0 ... CPLD_QSFP_EVT_FUSE_2:
            reg = CPLD_QSFP_EVT_FUSE_BASE_REG +
                 (attr->index - CPLD_QSFP_EVT_FUSE_0);
            break;
        case CPLD_QSFP_RESET_0 ... CPLD_QSFP_RESET_2:
            reg = CPLD_QSFP_RESET_BASE_REG +
                 (attr->index - CPLD_QSFP_RESET_0);
            break;
        case CPLD_QSFP_LPMODE_0 ... CPLD_QSFP_LPMODE_2:
            reg = CPLD_QSFP_LPMODE_BASE_REG +
                 (attr->index - CPLD_QSFP_LPMODE_0);
            break;
        case CPLD_QSFP_LED_0 ... CPLD_QSFP_LED_4:
            reg = CPLD_QSFP_LED_BASE_REG +
                 (attr->index - CPLD_QSFP_LED_0);
            break;
        case CPLD_SFPDD_LED:
        ...
        case DBG_CPLD_MISC_INTR:
            ...
            break;
        case DBG_CPLD_QSFP_INTR_PORT_0 ... DBG_CPLD_QSFP_INTR_PORT_2:
            reg = DBG_CPLD_QSFP_INTR_PORT_BASE_REG +
                 (attr->index - DBG_CPLD_QSFP_INTR_PORT_0);
            break;
        case DBG_CPLD_QSFP_INTR_PRESENT_0 ... DBG_CPLD_QSFP_INTR_PRESENT_2:
            reg = DBG_CPLD_QSFP_INTR_PRESENT_BASE_REG +
                 (attr->index - DBG_CPLD_QSFP_INTR_PRESENT_0);
            break;
        case DBG_CPLD_QSFP_INTR_FUSE_0 ... DBG_CPLD_QSFP_INTR_FUSE_2:
            reg = DBG_CPLD_QSFP_INTR_FUSE_BASE_REG +
                 (attr->index - DBG_CPLD_QSFP_INTR_FUSE_0);
            break;
        //CPLD 4
        case CPLD_PHY_INTR:
            reg = CPLD_PHY_INTR_REG;
            break;
        case CPLD_GBOX_INTR_0 ... CPLD_GBOX_INTR_2:
        ...
        case CPLD_PHY_MASK:
            ...
            break;
        case CPLD_GBOX_MASK_INTR_0 ... CPLD_GBOX_MASK_INTR_2:
            reg = CPLD_GBOX_INTR_BASE_REG +
                 (attr->index - CPLD_GBOX_MASK_INTR_0);
            break;
        case CPLD_QSFPDD_INTR_PORT:
            reg = CPLD_QSFPDD_INTR_PORT_REG;
            break;
        case CPLD_QSFPDD_INTR_PRESENT:
            reg = CPLD_QSFPDD_INTR_PRESENT_REG;
            break;
        case CPLD_QSFPDD_INTR_FUSE:
            reg = CPLD_QSFPDD_INTR_FUSE_REG;
            break;
        case CPLD_QSFPDD_MASK_PORT:
            reg = CPLD_QSFPDD_MASK_PORT_REG;
            break;
        case CPLD_QSFPDD_MASK_PRESENT:
            reg = CPLD_QSFPDD_MASK_PRESENT_REG;
            break;
        case CPLD_QSFPDD_MASK_FUSE:
            reg = CPLD_QSFPDD_MASK_FUSE_REG;
            break;
        case CPLD_QSFPDD_EVT_PORT:
            reg = CPLD_QSFPDD_EVT_PORT_REG;
            break;
        case CPLD_QSFPDD_EVT_PRESENT:
            reg = CPLD_QSFPDD_EVT_PRESENT_REG;
            break;
        case CPLD_QSFPDD_EVT_FUSE:
            reg = CPLD_QSFPDD_EVT_FUSE_REG;
            break;
        case CPLD_SFPDD_INTR_PRESENT:
            reg = CPLD_SFPDD_INTR_PRESENT_REG;
            break;
        case CPLD_SFPDD_MASK_PRESENT:
            reg = CPLD_SFPDD_MASK_PRESENT_REG;
            break;
        case CPLD_SFPDD_EVT_PRESENT:
            reg = CPLD_SFPDD_EVT_PRESENT_REG;
            break;
        case CPLD_SFP28_INTR_PRESENT:
            reg = CPLD_SFP28_INTR_PRESENT_REG;
            break;
        case CPLD_SFP28_MASK_PRESENT:
            reg = CPLD_SFP28_MASK_PRESENT_REG;
            break;
        case CPLD_SFP28_EVT_PRESENT:
            reg = CPLD_SFP28_EVT_PRESENT_REG;
            break;
        case CPLD_QSFPDD_RESET:
            reg = CPLD_QSFPDD_RESET_REG;
            break;
        ...
        case CPLD_SFP28_LED_1:
            ...
            break;
        case CPLD_SFP28_LED_2:
            reg = CPLD_SFP28_LED_REG;
            mask = CPLD_SFP28_LED_2_MASK;
            break;
        case CPLD_SFP28_LED_3:
            reg = CPLD_SFP28_LED_REG;
            mask = CPLD_SFP28_LED_3_MASK;
            break;
        case CPLD_GBOX_SERBOOT_0 ... CPLD_GBOX_SERBOOT_1:
            reg = CPLD_GBOX_SERBOOT_BASE_REG +
                 (attr->index - CPLD_GBOX_SERBOOT_0);
            break;
        case CPLD_SFPDD_28_TX_FAULT:
            reg = CPLD_SFPDD_28_TX_FAULT_REG;
            break;
        case CPLD_SFPDD_28_RX_LOS:
            reg = CPLD_SFPDD_28_RX_LOS_REG;
            break;
        case CPLD_SFPDD_28_MASK_TX_FAULT:
            reg = CPLD_SFPDD_28_MASK_TX_FAULT_REG;
            break;
        case CPLD_SFPDD_28_MASK_RX_LOS:
            reg = CPLD_SFPDD_28_MASK_RX_LOS_REG;
            break;
        case CPLD_SFPDD_28_EVT_TX_FAULT:
            reg = CPLD_SFPDD_28_EVT_TX_FAULT_REG;
            break;
        case CPLD_SFPDD_28_TX_DIS:
            reg = CPLD_SFPDD_28_TX_DIS_REG;
            break;
        case CPLD_SFPDD_RATE_CAP:
            reg = CPLD_SFPDD_RATE_CAP_REG;
            break;
        ...
        case DBG_CPLD_PHY_INTR:
            ...
            break;
        case DBG_CPLD_GBOX_INTR_0 ... DBG_CPLD_GBOX_INTR_2:
            reg = DBG_CPLD_GBOX_INTR_BASE_REG +
                 (attr->index - DBG_CPLD_GBOX_INTR_0);
            break;
        case DBG_CPLD_QSFPDD_INTR_PORT:
            reg = DBG_CPLD_QSFPDD_INTR_PORT_REG;
            break;
        case DBG_CPLD_QSFPDD_INTR_PRESENT:
            reg = DBG_CPLD_QSFPDD_INTR_PRESENT_REG;
            break;
        case DBG_CPLD_QSFPDD_INTR_FUSE:
            reg = DBG_CPLD_QSFPDD_INTR_FUSE_REG;
            break;
...
static struct i2c_driver cpld_driver = {
    ...
    .driver = {
        .name = "x86_64_ufispace_s9610_48dx_cpld",
    },
    .probe = cpld_probe,
    .remove = cpld_remove,
    .id_table = cpld_id,
...
MODULE_DESCRIPTION("x86_64_ufispace_s9610_48dx_cpld driver");
MODULE_LICENSE("GPL");
