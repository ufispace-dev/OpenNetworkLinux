...
static const thrm_attr_t thrm_attr[] = {
    /*                           thermal */
    [ONLP_THERMAL_PSU_ENV]      ={TYPE_THRM_ATTR_BMC  , BMC_ATTR_ID_TEMP_PSU_ENV},
    [ONLP_THERMAL_CPU_ENV]      ={TYPE_THRM_ATTR_BMC  , BMC_ATTR_ID_TEMP_CPU_ENV},
    [ONLP_THERMAL_OP2_ENV]      ={TYPE_THRM_ATTR_BMC  , BMC_ATTR_ID_TEMP_OP2_ENV},
    [ONLP_THERMAL_MAC_ENV]      ={TYPE_THRM_ATTR_BMC  , BMC_ATTR_ID_TEMP_MAC_ENV},
    [ONLP_THERMAL_MAC_DIE]      ={TYPE_THRM_ATTR_BMC  , BMC_ATTR_ID_TEMP_MAC_DIE},
    [ONLP_THERMAL_PSU0]         ={TYPE_THRM_ATTR_BMC  , BMC_ATTR_ID_PSU0_TEMP1},
    [ONLP_THERMAL_PSU1]         ={TYPE_THRM_ATTR_BMC  , BMC_ATTR_ID_PSU1_TEMP1},
