...
bmc_info_t bmc_cache[] =
{
    ...
    [BMC_ATTR_ID_TEMP_CPU_ENV]       = {HW_PLAT_ALL , BMC_ATTR_NAME_TEMP_CPU_ENV      , BMC_DATA_FLOAT , 0},
    [BMC_ATTR_ID_TEMP_OP2_ENV]       = {HW_PLAT_ALL , BMC_ATTR_NAME_TEMP_OP2_ENV      , BMC_DATA_FLOAT , 0},
    [BMC_ATTR_ID_TEMP_MAC_ENV]       = {HW_PLAT_ALL , BMC_ATTR_NAME_TEMP_MAC_ENV      , BMC_DATA_FLOAT , 0},
    [BMC_ATTR_ID_TEMP_MAC_DIE]       = {HW_PLAT_ALL , BMC_ATTR_NAME_TEMP_MAC_DIE      , BMC_DATA_FLOAT , 0},
    ...
    [BMC_ATTR_ID_FAN0_RPM]           = {HW_PLAT_ALL , BMC_ATTR_NAME_FAN0_RPM          , BMC_DATA_FLOAT , 0},
    [BMC_ATTR_ID_FAN1_RPM]           = {HW_PLAT_ALL , BMC_ATTR_NAME_FAN1_RPM          , BMC_DATA_FLOAT , 0},
    [BMC_ATTR_ID_FAN2_RPM]           = {HW_PLAT_ALL , BMC_ATTR_NAME_FAN2_RPM          , BMC_DATA_FLOAT , 0},
    [BMC_ATTR_ID_FAN3_RPM]           = {HW_PLAT_ALL , BMC_ATTR_NAME_FAN3_RPM          , BMC_DATA_FLOAT , 0},
    ...
    [BMC_ATTR_ID_PSU0_STBVOUT]       = {HW_PLAT_NONE, BMC_ATTR_NAME_PSU0_STBVOUT      , BMC_DATA_FLOAT , 0},
    [BMC_ATTR_ID_PSU0_STBIOUT]       = {HW_PLAT_NONE, BMC_ATTR_NAME_PSU0_STBIOUT      , BMC_DATA_FLOAT , 0},
    ...
    [BMC_ATTR_ID_PSU1_STBVOUT]       = {HW_PLAT_NONE, BMC_ATTR_NAME_PSU1_STBVOUT      , BMC_DATA_FLOAT , 0},
    [BMC_ATTR_ID_PSU1_STBIOUT]       = {HW_PLAT_NONE, BMC_ATTR_NAME_PSU1_STBIOUT      , BMC_DATA_FLOAT , 0},
};
...
int get_board_version(board_t *board)
{
    ...
    if(read_file_hex(&board->hw_rev, LPC_FMT "board_hw_id") != ONLP_STATUS_OK ||
       ...
       read_file_hex(&board->id_type, LPC_FMT "board_id_type") != ONLP_STATUS_OK)
    {
        board->hw_rev = 0;
        board->deph_id = 0;
        board->hw_build = 0;
...
int get_cpu_hw_rev_id(int *rev_id, int *dev_phase, int *build_id)
{
    ...
    ONLP_TRY(read_file_hex(rev_id, "/sys/devices/platform/x86_64_ufispace_s9601_104bc_lpc/ec/cpu_rev_hw_rev"));
    ONLP_TRY(read_file_hex(dev_phase, "/sys/devices/platform/x86_64_ufispace_s9601_104bc_lpc/ec/cpu_rev_dev_phase"));
    ONLP_TRY(read_file_hex(build_id, "/sys/devices/platform/x86_64_ufispace_s9601_104bc_lpc/ec/cpu_rev_build_id"));
...
int get_thermal_thld(int thermal_local_id,  temp_thld_t *temp_thld) {
    ...
    switch(thermal_local_id) {
        case ONLP_THERMAL_PSU_ENV:
            temp_thld->warning = THERMAL_TEMP_PSU_ENV_WARNING;
            temp_thld->error = THERMAL_TEMP_PSU_ENV_ERROR;
            temp_thld->shutdown = THERMAL_TEMP_PSU_ENV_SHUTDOWN;
            return ONLP_STATUS_OK;
        case ONLP_THERMAL_CPU_ENV:
            temp_thld->warning = THERMAL_TEMP_CPU_ENV_WARNING;
            temp_thld->error = THERMAL_TEMP_CPU_ENV_ERROR;
            temp_thld->shutdown = THERMAL_TEMP_CPU_ENV_SHUTDOWN;
            return ONLP_STATUS_OK;
        case ONLP_THERMAL_OP2_ENV:
            temp_thld->warning = THERMAL_TEMP_OP2_ENV_WARNING;
            temp_thld->error = THERMAL_TEMP_OP2_ENV_ERROR;
            temp_thld->shutdown = THERMAL_TEMP_OP2_ENV_SHUTDOWN;
            return ONLP_STATUS_OK;
        case ONLP_THERMAL_MAC_ENV:
            temp_thld->warning = THERMAL_TEMP_MAC_ENV_WARNING;
            temp_thld->error = THERMAL_TEMP_MAC_ENV_ERROR;
            temp_thld->shutdown = THERMAL_TEMP_MAC_ENV_SHUTDOWN;
            return ONLP_STATUS_OK;
        case ONLP_THERMAL_MAC_DIE:
            temp_thld->warning = THERMAL_TEMP_MAC_DIE_WARNING;
            temp_thld->error = THERMAL_TEMP_MAC_DIE_ERROR;
            temp_thld->shutdown = THERMAL_TEMP_MAC_DIE_SHUTDOWN;
            return ONLP_STATUS_OK;
        case ONLP_THERMAL_PSU0:
            temp_thld->warning = THERMAL_TEMP_PSU0_WARNING;
            temp_thld->error = THERMAL_TEMP_PSU0_ERROR;
            temp_thld->shutdown = THERMAL_TEMP_PSU0_SHUTDOWN;
            return ONLP_STATUS_OK;
        case ONLP_THERMAL_PSU1:
            temp_thld->warning = THERMAL_TEMP_PSU1_WARNING;
            temp_thld->error = THERMAL_TEMP_PSU1_ERROR;
            temp_thld->shutdown = THERMAL_TEMP_PSU1_SHUTDOWN;
            return ONLP_STATUS_OK;
