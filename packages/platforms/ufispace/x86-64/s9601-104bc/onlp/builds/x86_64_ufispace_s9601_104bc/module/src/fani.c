...
static const fan_attr_t fan_attr[] = {
    ...
    [ONLP_FAN_0]     = { BMC_ATTR_ID_FAN0_PSNT_L , BMC_ATTR_ID_FAN0_RPM     , BMC_OEM_IDX_INVALID, BMC_FRU_IDX_INVALID},
    [ONLP_FAN_1]     = { BMC_ATTR_ID_FAN1_PSNT_L , BMC_ATTR_ID_FAN1_RPM     , BMC_OEM_IDX_INVALID, BMC_FRU_IDX_INVALID},
    [ONLP_FAN_2]     = { BMC_ATTR_ID_FAN2_PSNT_L , BMC_ATTR_ID_FAN2_RPM     , BMC_OEM_IDX_INVALID, BMC_FRU_IDX_INVALID},
    [ONLP_FAN_3]     = { BMC_ATTR_ID_FAN3_PSNT_L , BMC_ATTR_ID_FAN3_RPM     , BMC_OEM_IDX_INVALID, BMC_FRU_IDX_INVALID},
