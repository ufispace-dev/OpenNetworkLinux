...
static const fan_attr_t fan_attr[] = {
    ...
    [ONLP_FAN_0]     = { BMC_ATTR_ID_FAN0_PSNT_L , BMC_ATTR_ID_FAN0_RPM     , BMC_OEM_IDX_INVALID, BMC_FRU_IDX_FAN_TRAY_0},
    [ONLP_FAN_1]     = { BMC_ATTR_ID_FAN1_PSNT_L , BMC_ATTR_ID_FAN1_RPM     , BMC_OEM_IDX_INVALID, BMC_FRU_IDX_FAN_TRAY_1},
    [ONLP_FAN_2]     = { BMC_ATTR_ID_FAN2_PSNT_L , BMC_ATTR_ID_FAN2_RPM     , BMC_OEM_IDX_INVALID, BMC_FRU_IDX_FAN_TRAY_2},
    [ONLP_FAN_3]     = { BMC_ATTR_ID_FAN3_PSNT_L , BMC_ATTR_ID_FAN3_RPM     , BMC_OEM_IDX_INVALID, BMC_FRU_IDX_FAN_TRAY_3},
    [ONLP_PSU_0_FAN] = { BMC_ATTR_ID_INVALID     , BMC_ATTR_ID_PSU0_FAN1    , BMC_OEM_IDX_INVALID, BMC_FRU_IDX_INVALID},
    [ONLP_PSU_1_FAN] = { BMC_ATTR_ID_INVALID     , BMC_ATTR_ID_PSU1_FAN1    , BMC_OEM_IDX_INVALID, BMC_FRU_IDX_INVALID},
};
    ...
    *info = fan_info[local_id];
    ...
    if(info->status & ONLP_FAN_STATUS_PRESENT) {
        ...
        switch(local_id) {
            ...
            case ONLP_FAN_3:
            {
                sys_max_fan_speed = SYS_FAN_RPM_MAX;
