/*
 * A lpc driver for the ufispace_s9601_104bc
 *
...
#define DRIVER_NAME "x86_64_ufispace_s9601_104bc_lpc"
...
attr_reg_map_t attr_reg[]= {
    ...
    [ATT_MB_BRD_EXT_ID]        = {REG_BRD_EXT_ID      , MASK_ALL      , DATA_HEX},
    [ATT_MB_MUX_RESET_ALL]     = {REG_NONE            , MASK_NONE     , DATA_DEC},
    [ATT_MB_MUX_CTRL]          = {REG_MB_MUX_CTRL     , MASK_ALL      , DATA_HEX},
    [ATT_MB_UART_CTRL]         = {REG_MB_MUX_CTRL     , MASK_0100_0000, DATA_DEC},
...
static SENSOR_DEVICE_ATTR_RO(board_ext_id        , lpc_callback     , ATT_MB_BRD_EXT_ID);
...
static SENSOR_DEVICE_ATTR_RW(uart_ctrl           , lpc_callback     , ATT_MB_UART_CTRL);
...
MODULE_DESCRIPTION("x86_64_ufispace_s9601_104bc_lpc driver");
MODULE_LICENSE("GPL");
