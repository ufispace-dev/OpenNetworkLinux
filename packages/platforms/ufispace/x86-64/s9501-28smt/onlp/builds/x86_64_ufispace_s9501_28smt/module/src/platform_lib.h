...
#include "x86_64_ufispace_s9501_28smt_int.h"
...
#define MUX_RESET_PATH              "/sys/devices/platform/x86_64_ufispace_s9501_28smt_lpc/mb_cpld/mux_reset"
#define I2C_RECOVERY_BIN_PATH       "/lib/platform-config/x86-64-ufispace-s9501-28smt-r0/onl/i2c_stuck_recovery.bin"
...
#define THERMAL_CAPS_NO_WARNING (ONLP_THERMAL_CAPS_GET_TEMPERATURE | ONLP_THERMAL_CAPS_GET_ERROR_THRESHOLD | \
...
typedef enum thermal_oid_e {
    ...
    THERMAL_OID_DDR4 = ONLP_THERMAL_ID_CREATE(2),
    THERMAL_OID_CPU = ONLP_THERMAL_ID_CREATE(3),
    THERMAL_OID_BMC = ONLP_THERMAL_ID_CREATE(4),
    THERMAL_OID_FANCARD1 = ONLP_THERMAL_ID_CREATE(5),
    THERMAL_OID_FANCARD2 = ONLP_THERMAL_ID_CREATE(6),
    THERMAL_OID_MAC = ONLP_THERMAL_ID_CREATE(7),
    THERMAL_OID_HWM_MAC = ONLP_THERMAL_ID_CREATE(8),
    THERMAL_OID_HWM_AMB = ONLP_THERMAL_ID_CREATE(9),
    THERMAL_OID_HWM_PHY = ONLP_THERMAL_ID_CREATE(10),
...
typedef enum thermal_id_e {
    ...
    THERMAL_ID_CPU = 3,
    THERMAL_ID_BMC = 4,
    THERMAL_ID_FANCARD1 = 5,
    THERMAL_ID_FANCARD2 = 6,
    THERMAL_ID_MAC = 7,
    THERMAL_ID_HWM_MAC = 8,
    THERMAL_ID_HWM_AMB = 9,
    THERMAL_ID_HWM_PHY = 10,
    THERMAL_ID_PSU0 = 11,
    THERMAL_ID_PSU1 = 12,
    THERMAL_ID_MAX = 13,
} thermal_id_t;
