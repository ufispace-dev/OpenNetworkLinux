/*
 * A i2c cpld driver for the ufispace_s9600_102xc
 *
...
#include "x86-64-ufispace-s9600-102xc-cpld.h"
...
enum cpld_sysfs_attributes {
    ...
    // CPLD 5
    CPLD_QSFP_PORT_96_101_INTR,
    CPLD_SFP_PORT_44_47_PRES,
    CPLD_SFP_PORT_92_95_PRES,
    CPLD_QSFP_PORT_96_101_PRES,
    CPLD_QSFP_PORT_96_101_INTR_MASK,
    CPLD_SFP_PORT_44_47_PRES_MASK,
    CPLD_SFP_PORT_92_95_PRES_MASK,
    CPLD_QSFP_PORT_96_101_PRES_MASK,
    CPLD_QSFP_PORT_96_101_INTR_EVENT,
    CPLD_SFP_PORT_44_47_PLUG_EVENT,
    CPLD_SFP_PORT_92_95_PLUG_EVENT,
    CPLD_QSFP_PORT_96_101_PLUG_EVENT,
    CPLD_SFP_PORT_44_47_TX_DISABLE,
    CPLD_SFP_PORT_92_95_TX_DISABLE,
    CPLD_QSFP_PORT_96_101_RST,
    CPLD_QSFP_PORT_96_101_MODSEL,
    CPLD_QSFP_PORT_96_101_LPMODE,
...
static attr_reg_map_t attr_reg[]= {
    ...
    [CPLD_DAU_BD_PRES]                = {CPLD_DAU_BD_PRES_REG               , MASK_ALL      , DATA_HEX},
    ...
    // CPLD 5
    [CPLD_QSFP_PORT_96_101_INTR]       = {CPLD_QSFP_PORT_96_101_INTR_REG        , MASK_ALL, DATA_HEX},
    ...
    [CPLD_QSFP_PORT_96_101_PRES]       = {CPLD_QSFP_PORT_96_101_PRES_REG        , MASK_ALL, DATA_HEX},
    [CPLD_QSFP_PORT_96_101_INTR_MASK]  = {CPLD_QSFP_PORT_96_101_INTR_MASK_REG   , MASK_ALL, DATA_HEX},
    ...
    [CPLD_QSFP_PORT_96_101_PRES_MASK]  = {CPLD_QSFP_PORT_96_101_PRES_MASK_REG   , MASK_ALL, DATA_HEX},
    [CPLD_QSFP_PORT_96_101_INTR_EVENT] = {CPLD_QSFP_PORT_96_101_INTR_EVENT_REG  , MASK_ALL, DATA_HEX},
    ...
    [CPLD_QSFP_PORT_96_101_PLUG_EVENT] = {CPLD_QSFP_PORT_96_101_PLUG_EVENT_REG  , MASK_ALL, DATA_HEX},
    ...
    [CPLD_QSFP_PORT_96_101_RST]        = {CPLD_QSFP_PORT_96_101_RST_REG         , MASK_ALL, DATA_HEX},
    [CPLD_QSFP_PORT_96_101_MODSEL]     = {CPLD_QSFP_PORT_96_101_MODSEL_REG      , MASK_ALL, DATA_HEX},
    [CPLD_QSFP_PORT_96_101_LPMODE]     = {CPLD_QSFP_PORT_96_101_LPMODE_REG      , MASK_ALL, DATA_HEX},
...
static const struct i2c_device_id cpld_id[] = {
    { "s9600_102xc_cpld1",  cpld1 },
    { "s9600_102xc_cpld2",  cpld2 },
    { "s9600_102xc_cpld3",  cpld3 },
    { "s9600_102xc_cpld4",  cpld4 },
    { "s9600_102xc_cpld5",  cpld5 },
    {}
};
...
static SENSOR_DEVICE_ATTR_RO(cpld_dau_bd_pres           , cpld, CPLD_DAU_BD_PRES);
...
//CPLD 5
static SENSOR_DEVICE_ATTR_RO(cpld_qsfp_port_96_101_intr       , cpld, CPLD_QSFP_PORT_96_101_INTR);
...
static SENSOR_DEVICE_ATTR_RO(cpld_qsfp_port_96_101_pres       , cpld, CPLD_QSFP_PORT_96_101_PRES);
static SENSOR_DEVICE_ATTR_RW(cpld_qsfp_port_96_101_intr_mask  , cpld, CPLD_QSFP_PORT_96_101_INTR_MASK);
...
static SENSOR_DEVICE_ATTR_RW(cpld_qsfp_port_96_101_pres_mask  , cpld, CPLD_QSFP_PORT_96_101_PRES_MASK);
static SENSOR_DEVICE_ATTR_RO(cpld_qsfp_port_96_101_intr_event , cpld, CPLD_QSFP_PORT_96_101_INTR_EVENT);
...
static SENSOR_DEVICE_ATTR_RO(cpld_qsfp_port_96_101_plug_event , cpld, CPLD_QSFP_PORT_96_101_PLUG_EVENT);
...
static SENSOR_DEVICE_ATTR_RW(cpld_qsfp_port_96_101_rst        , cpld, CPLD_QSFP_PORT_96_101_RST);
static SENSOR_DEVICE_ATTR_RW(cpld_qsfp_port_96_101_modsel     , cpld, CPLD_QSFP_PORT_96_101_MODSEL);
static SENSOR_DEVICE_ATTR_RW(cpld_qsfp_port_96_101_lpmode     , cpld, CPLD_QSFP_PORT_96_101_LPMODE);
...
static struct attribute *cpld5_attributes[] = {
    ...
    // CPLD 5
    _DEVICE_ATTR(cpld_qsfp_port_96_101_intr),
    _DEVICE_ATTR(cpld_sfp_port_44_47_pres),
    _DEVICE_ATTR(cpld_sfp_port_92_95_pres),
    _DEVICE_ATTR(cpld_qsfp_port_96_101_pres),
    _DEVICE_ATTR(cpld_qsfp_port_96_101_intr_mask),
    _DEVICE_ATTR(cpld_sfp_port_44_47_pres_mask),
    _DEVICE_ATTR(cpld_sfp_port_92_95_pres_mask),
    _DEVICE_ATTR(cpld_qsfp_port_96_101_pres_mask),
    _DEVICE_ATTR(cpld_qsfp_port_96_101_intr_event),
    _DEVICE_ATTR(cpld_sfp_port_44_47_plug_event),
    _DEVICE_ATTR(cpld_sfp_port_92_95_plug_event),
    _DEVICE_ATTR(cpld_qsfp_port_96_101_plug_event),
    _DEVICE_ATTR(cpld_sfp_port_44_47_tx_disable),
    _DEVICE_ATTR(cpld_sfp_port_92_95_tx_disable),
    _DEVICE_ATTR(cpld_qsfp_port_96_101_rst),
    _DEVICE_ATTR(cpld_qsfp_port_96_101_modsel),
    _DEVICE_ATTR(cpld_qsfp_port_96_101_lpmode),
        ...
        struct device_attribute *da, char *buf)
{
    ...
    switch (attr->index) {
        ...
        //CPLD 5
        case CPLD_QSFP_PORT_96_101_INTR:
        case CPLD_SFP_PORT_44_47_PRES:
        case CPLD_SFP_PORT_92_95_PRES:
        case CPLD_QSFP_PORT_96_101_PRES:
        case CPLD_QSFP_PORT_96_101_INTR_MASK:
        case CPLD_SFP_PORT_44_47_PRES_MASK:
        case CPLD_SFP_PORT_92_95_PRES_MASK:
        case CPLD_QSFP_PORT_96_101_PRES_MASK:
        case CPLD_QSFP_PORT_96_101_INTR_EVENT:
        case CPLD_SFP_PORT_44_47_PLUG_EVENT:
        case CPLD_SFP_PORT_92_95_PLUG_EVENT:
        case CPLD_QSFP_PORT_96_101_PLUG_EVENT:
        case CPLD_SFP_PORT_44_47_TX_DISABLE:
        case CPLD_SFP_PORT_92_95_TX_DISABLE:
        case CPLD_QSFP_PORT_96_101_RST:
        case CPLD_QSFP_PORT_96_101_MODSEL:
        case CPLD_QSFP_PORT_96_101_LPMODE:
...
static struct i2c_driver cpld_driver = {
    ...
    .driver = {
        .name = "x86_64_ufispace_s9600_102xc_cpld",
    },
    .probe = cpld_probe,
    .remove = cpld_remove,
    .id_table = cpld_id,
...
MODULE_DESCRIPTION("x86_64_ufispace_s9600_102xc_cpld driver");
MODULE_LICENSE("GPL");
