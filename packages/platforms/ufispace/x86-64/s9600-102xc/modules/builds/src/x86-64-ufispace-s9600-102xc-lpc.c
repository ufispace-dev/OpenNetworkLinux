/*
 * A lpc driver for the ufispace_s9600_102xc
 *
...
#define DRIVER_NAME "x86_64_ufispace_s9600_102xc_lpc"
...
#define REG_MB_MUX_RESET1                 (REG_BASE_MB + 0x46)
#define REG_MB_MUX_RESET2                 (REG_BASE_MB + 0x47)
#define REG_MB_MUX_CTRL                   (REG_BASE_MB + 0x5C)
#define REG_MB_EXT_BYTE                   (REG_BASE_MB + 0xD0)
...
attr_reg_map_t attr_reg[]= {
    ...
    [ATT_MB_CPLD_1_VERSION]    = {REG_MB_CPLD_VERSION , MASK_ALL      , DATA_HEX},
    ...
    [ATT_MB_CPLD_1_BUILD]      = {REG_MB_CPLD_BUILD   , MASK_ALL      , DATA_DEC},
    [ATT_MB_CPLD_1_VERSION_H]  = {REG_NONE            , MASK_NONE     , DATA_UNK},
    [ATT_MB_MUX_RESET_ALL]     = {REG_NONE            , MASK_NONE     , DATA_DEC},
    [ATT_MB_MUX_CTRL]          = {REG_MB_MUX_CTRL     , MASK_ALL      , DATA_HEX},
    [ATT_MB_EXT_BYTE]          = {REG_MB_EXT_BYTE     , MASK_ALL      , DATA_HEX},
    [ATT_MB_BRD_ID_DEF]        = {REG_MB_EXT_BYTE     , MASK_1100_0000, DATA_DEC},
    ...
    [ATT_CPU_CPLD_BUILD]      = {REG_CPU_CPLD_BUILD   , MASK_ALL      , DATA_DEC},
        ...
        struct device_attribute *da, char *buf)
{
    ...
    switch (attr->index) {
        ...
        case ATT_MB_EXT_BYTE:
        case ATT_MB_BRD_ID_DEF:
        ...
        struct device_attribute *da, const char *buf, size_t count)
{
    ...
    switch (attr->index) {
        case ATT_MB_MUX_RESET_ALL:
            reg1 = REG_MB_MUX_RESET1;
            reg2 = REG_MB_MUX_RESET2;
            mask1 = MASK_ALL;
            mask2 = MASK_ALL;
            break;
        default:
...
static SENSOR_DEVICE_ATTR_RO(mb_cpld_1_version   , lpc_callback     , ATT_MB_CPLD_1_VERSION);
static SENSOR_DEVICE_ATTR_RO(mb_cpld_1_ver_minor , lpc_callback     , ATT_MB_CPLD_1_MINOR_VER);
static SENSOR_DEVICE_ATTR_RO(mb_cpld_1_ver_major , lpc_callback     , ATT_MB_CPLD_1_MAJOR_VER);
static SENSOR_DEVICE_ATTR_RO(mb_cpld_1_build     , lpc_callback     , ATT_MB_CPLD_1_BUILD);
...
static SENSOR_DEVICE_ATTR_RO(ext_byte            , lpc_callback     , ATT_MB_EXT_BYTE);
static SENSOR_DEVICE_ATTR_RO(brd_id_def          , lpc_callback     , ATT_MB_BRD_ID_DEF);

//SENSOR_DEVICE_ATTR - CPU
static SENSOR_DEVICE_ATTR_RO(cpu_cpld_version    , lpc_callback     , ATT_CPU_CPLD_VERSION);
static SENSOR_DEVICE_ATTR_RO(cpu_cpld_ver_minor  , lpc_callback     , ATT_CPU_CPLD_MINOR_VER);
static SENSOR_DEVICE_ATTR_RO(cpu_cpld_ver_major  , lpc_callback     , ATT_CPU_CPLD_MAJOR_VER);
static SENSOR_DEVICE_ATTR_RO(cpu_cpld_build      , lpc_callback     , ATT_CPU_CPLD_BUILD);
...
MODULE_DESCRIPTION("x86_64_ufispace_s9600_102xc_lpc driver");
MODULE_LICENSE("GPL");
