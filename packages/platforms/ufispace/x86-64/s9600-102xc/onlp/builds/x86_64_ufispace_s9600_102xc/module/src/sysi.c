...
/* This is definitions for x86-64-ufispace-s9600-102xc */
/* OID map*/
/*
 * [01] CHASSIS
 *            |----[01] ONLP_THERMAL_CPU_PECI
 *            |----[02] ONLP_THERMAL_ENV_CPU
 *            |----[03] ONLP_THERMAL_ENV0
 *            |----[04] ONLP_THERMAL_ENV1
 *            |----[05] ONLP_THERMAL_ENV_MAC
...
#define SYSFS_CPU_CPLD_VER_H   LPC_BSP_CPU_CPLD "cpu_cpld_version_h"
...
{
    return "x86-64-ufispace-s9600-102xc-r0";
}
