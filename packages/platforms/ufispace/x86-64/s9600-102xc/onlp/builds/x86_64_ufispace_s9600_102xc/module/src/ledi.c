...
/*  led attribute            action          attr              color blink onoff */
    [ONLP_LED_SYS_SYNC]    = {ACTION_LED_RW, CPLD_LED_SYNC_ID ,4     ,6    ,7},
    [ONLP_LED_SYS_SYS]     = {ACTION_LED_RO, CPLD_LED_FAN_SYS ,0     ,2    ,3},
    [ONLP_LED_SYS_FAN]     = {ACTION_LED_RO, CPLD_LED_FAN_SYS ,4     ,6    ,7},
    [ONLP_LED_SYS_PSU0]    = {ACTION_LED_RO, CPLD_LED_PSU     ,0     ,2    ,3},
    [ONLP_LED_SYS_PSU1]    = {ACTION_LED_RO, CPLD_LED_PSU     ,4     ,6    ,7},
    [ONLP_LED_SYS_ID]      = {ACTION_LED_RW, CPLD_LED_SYNC_ID ,-1    ,2    ,3},
};
...
static int get_led_sysfs(cpld_attr_idx_t idx, char** str)
{
    ...
    switch(idx) {
        case CPLD_LED_FAN_SYS:
           *str =  SYSFS_CPLD1 "cpld_sys_led_ctrl_1";
           break;
        case CPLD_LED_PSU:
            *str = SYSFS_CPLD1 "cpld_sys_led_ctrl_2";
            break;
        case CPLD_LED_SYNC_ID:
            *str = SYSFS_CPLD1 "cpld_sys_led_ctrl_3";
            break;
        default:
            *str = "";
            return ONLP_STATUS_E_PARAM;
