...
bmc_info_t bmc_cache[] =
{
    ...
    [BMC_ATTR_ID_TEMP_MAC1]       = {"TEMP_MAC1"       , 0},
    [BMC_ATTR_ID_TEMP_DDR_L]      = {"TEMP_DDR_L"      , 0},
    [BMC_ATTR_ID_TEMP_DDR_R]      = {"TEMP_DDR_R"      , 0},
    [BMC_ATTR_ID_TEMP_BMC]        = {"TEMP_BMC"        , 0},
    [BMC_ATTR_ID_TEMP_FRONT]      = {"TEMP_FRONT"      , 0},
    [BMC_ATTR_ID_PSU0_TEMP]       = {"PSU0_TEMP1"      , 0},
    [BMC_ATTR_ID_PSU1_TEMP]       = {"PSU1_TEMP1"      , 0},
    [BMC_ATTR_ID_FAN_0]           = {"FAN0_RPM"       , 0},
    [BMC_ATTR_ID_FAN_1]           = {"FAN1_RPM"       , 0},
    [BMC_ATTR_ID_FAN_2]           = {"FAN2_RPM"       , 0},
    [BMC_ATTR_ID_PSU0_FAN]        = {"PSU0_FAN"        , 0},
    [BMC_ATTR_ID_PSU1_FAN]        = {"PSU1_FAN"        , 0},
    [BMC_ATTR_ID_FAN0_PRESENT_L]  = {"FAN0_PRESENT_L"  , 0},
    [BMC_ATTR_ID_FAN1_PRESENT_L]  = {"FAN1_PRESENT_L"  , 0},
    [BMC_ATTR_ID_FAN2_PRESENT_L]  = {"FAN2_PRESENT_L"  , 0},
        ...
        while(fgets(line,BMC_FRU_LINE_SIZE, fp) != NULL) {
            ...
            for(i=0; i<BMC_ATTR_ID_MAX; ++i) {
                if(strcmp(line_fields[0], bmc_cache[i].name) == 0) {
                    dev_num = i;
                    if(dev_num >= BMC_ATTR_ID_FAN0_PRESENT_L && dev_num <= BMC_ATTR_ID_FAN2_PRESENT_L) {
...
int get_hw_rev_id(void)
{
    ...
    snprintf(hw_rev_cmd, sizeof(hw_rev_cmd), "cat /sys/devices/platform/x86_64_ufispace_s9500_54cf_lpc/mb_cpld/board_hw_id");
