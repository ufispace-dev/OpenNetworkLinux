...
#define LPC_FMT                     "/sys/devices/platform/x86_64_ufispace_s9500_54cf_lpc/mb_cpld/"
...
#define MUX_RESET_PATH              "/sys/devices/platform/x86_64_ufispace_s9500_54cf_lpc/mb_cpld/mux_reset_all"
...
enum bmc_attr_id {
    ...
    BMC_ATTR_ID_TEMP_DDR_L,
    BMC_ATTR_ID_TEMP_DDR_R,
    BMC_ATTR_ID_TEMP_BMC,
    BMC_ATTR_ID_TEMP_FRONT,
    ...
    BMC_ATTR_ID_FAN0_PRESENT_L,
    BMC_ATTR_ID_FAN1_PRESENT_L,
    BMC_ATTR_ID_FAN2_PRESENT_L,
