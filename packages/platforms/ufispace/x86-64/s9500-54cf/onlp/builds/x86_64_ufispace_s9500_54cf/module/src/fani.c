...
static int ufi_bmc_fan_info_get(int local_id, onlp_fan_info_t* info)
{
    ...
    switch(local_id)
    {
        case ONLP_FAN_0:
            ...
            fan_present_id = BMC_ATTR_ID_FAN0_PRESENT_L;
            break;
        case ONLP_FAN_1:
            bmc_attr_id = BMC_ATTR_ID_FAN_1;
            fan_present_id = BMC_ATTR_ID_FAN1_PRESENT_L;
            break;
        case ONLP_FAN_2:
            bmc_attr_id = BMC_ATTR_ID_FAN_2;
            fan_present_id = BMC_ATTR_ID_FAN2_PRESENT_L;
            break;
        case ONLP_PSU_0_FAN:
    ...
    if (local_id >= ONLP_FAN_0 && local_id <= ONLP_FAN_2) {
