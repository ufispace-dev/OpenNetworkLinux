...
static onlp_led_info_t led_info[] =
{
    ...
    CHASSIS_LED_INFO(ONLP_LED_SYS_PS0, "Chassis LED 5 (PS0 LED)"),
    CHASSIS_LED_INFO(ONLP_LED_SYS_PS1, "Chassis LED 5 (PS1 LED)"),
    CHASSIS_LED_INFO(ONLP_LED_SYS_ID, "Chassis LED 6 (ID LED)"),
};
...
/*  led attribute          type                 action         g_gpin y_gpin lpc_sysfs              color blink onoff */
    [ONLP_LED_SYS_GNSS] = {TYPE_LED_ATTR_SYSFS ,ACTION_LED_RW ,-1    , -1   ,MB_CPLD1_SYSFS_PATH "/cpld_system_led_gnss"  ,0    ,2    ,3},
    [ONLP_LED_SYS_SYNC] = {TYPE_LED_ATTR_SYSFS ,ACTION_LED_RW ,-1    , -1   ,MB_CPLD1_SYSFS_PATH "/cpld_system_led_sync"  ,0    ,2    ,3},
    [ONLP_LED_SYS_SYS]  = {TYPE_LED_ATTR_SYSFS ,ACTION_LED_RW ,-1    , -1   ,MB_CPLD1_SYSFS_PATH "/cpld_system_led_sys"  ,0    ,2    ,3},
    [ONLP_LED_SYS_FAN]  = {TYPE_LED_ATTR_SYSFS ,ACTION_LED_RO ,-1    , -1   ,MB_CPLD1_SYSFS_PATH "/cpld_system_led_fan",0    ,2    ,3},
    [ONLP_LED_SYS_PS0]  = {TYPE_LED_ATTR_SYSFS ,ACTION_LED_RO ,-1    , -1   ,MB_CPLD1_SYSFS_PATH "/cpld_system_led_psu_0",0    ,2    ,3},
    [ONLP_LED_SYS_PS1]  = {TYPE_LED_ATTR_SYSFS ,ACTION_LED_RO ,-1    , -1   ,MB_CPLD1_SYSFS_PATH "/cpld_system_led_psu_1",0    ,2    ,3},
    [ONLP_LED_SYS_ID]   = {TYPE_LED_ATTR_SYSFS ,ACTION_LED_RW ,-1    , -1   ,MB_CPLD1_SYSFS_PATH "/cpld_system_led_id",5    ,5    ,3},
};
...
int onlp_ledi_info_get(onlp_oid_t id, onlp_led_info_t* rv)
{
    ...
    *rv = led_info[local_id];
    ...
    switch (local_id) {
        ...
        case ONLP_LED_SYS_PS0:
        case ONLP_LED_SYS_PS1:
        case ONLP_LED_SYS_ID:
            return ufi_sys_led_info_get(local_id, rv);
        default:
            return ONLP_STATUS_E_INTERNAL;
    }
