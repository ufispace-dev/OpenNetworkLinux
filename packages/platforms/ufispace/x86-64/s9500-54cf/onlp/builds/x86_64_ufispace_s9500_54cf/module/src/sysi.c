...
/* This is definitions for x86-64-ufispace-s9500-54cf*/
/* OID map*/
/*
 * [01] CHASSIS
 ...
 *            |----[08]ONLP_THERMAL_DDR_L
 *            |----[09]ONLP_THERMAL_DDR_R
 *            |----[10]ONLP_THERMAL_BMC
 *            |----[11]ONLP_THERMAL_FRONT
 *            |
...
static onlp_oid_t __onlp_oid_info[] = {
    ...
    ONLP_THERMAL_ID_CREATE(ONLP_THERMAL_DDR_L),
    ONLP_THERMAL_ID_CREATE(ONLP_THERMAL_DDR_R),
    ONLP_THERMAL_ID_CREATE(ONLP_THERMAL_BMC),
    ONLP_THERMAL_ID_CREATE(ONLP_THERMAL_FRONT),
    ...
    ONLP_LED_ID_CREATE(ONLP_LED_SYS_PS0),
    ONLP_LED_ID_CREATE(ONLP_LED_SYS_PS1),
...
{
    return "x86-64-ufispace-s9500-54cf-r0";
}
