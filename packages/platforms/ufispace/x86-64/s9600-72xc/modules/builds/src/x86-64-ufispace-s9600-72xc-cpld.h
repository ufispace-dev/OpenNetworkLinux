/* header file for i2c cpld driver of ufispace_s9600_72xc
 *
...
#ifndef UFISPACE_S9600_I2C_CPLD_H
#define UFISPACE_S9600_I2C_CPLD_H
...
extern int s9600_cpld_read(u8 cpld_idx, u8 reg);
extern int s9600_cpld_write(u8 cpld_idx, u8 reg, u8 value);
