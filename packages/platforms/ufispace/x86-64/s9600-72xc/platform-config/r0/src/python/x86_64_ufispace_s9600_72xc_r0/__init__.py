...
class OnlPlatform_x86_64_ufispace_s9600_72xc_r0(OnlPlatformUfiSpace):
    PLATFORM = 'x86-64-ufispace-s9600-72xc-r0'
    MODEL = "s9600-72xc"
    SYS_OBJECT_ID = ".9600.72"
    PORT_COUNT = 72
    PORT_CONFIG = "64x25 8x100"
    ...
    def baseconfig(self):
        ...
        # lpc driver
        self.insmod("x86-64-ufispace-s9600-72xc-lpc")
        ...
        # onie syseeprom
        self.insmod("x86-64-ufispace-s9600-72xc-onie-syseeprom.ko")
