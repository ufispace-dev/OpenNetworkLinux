...
//#define CMD_BMC_SENSOR_CACHE "timeout 10s ipmitool sdr -c get TEMP_CPU_PECI TEMP_RAMON_ENV_T TEMP_RAMON_DIE_T TEMP_RAMON_ENV_B TEMP_RAMON_DIE_B PSU0_TEMP PSU1_TEMP TEMP_BMC_ENV TEMP_ENV_FRONT_T TEMP_ENV_FRONT_B FAN0_RPM FAN1_RPM FAN2_RPM FAN3_RPM PSU0_FAN1 PSU0_FAN2 PSU1_FAN1 PSU1_FAN2 FAN0_PRSNT_H FAN1_PRSNT_H FAN2_PRSNT_H FAN3_PRSNT_H PSU0_VIN PSU0_VOUT PSU0_IIN PSU0_IOUT PSU0_STBVOUT PSU0_STBIOUT PSU1_VIN PSU1_VOUT PSU1_IIN PSU1_IOUT PSU1_STBVOUT PSU1_STBIOUT > /tmp/bmc_sensor_cache"
...
bmc_info_t bmc_cache[] =
{
    ...
    [BMC_ATTR_ID_TEMP_RAMON_ENV_T] = {"TEMP_RAMON_ENV_T" , 0},
    [BMC_ATTR_ID_TEMP_RAMON_DIE_T] = {"TEMP_RAMON_DIE_T" , 0},
    [BMC_ATTR_ID_TEMP_RAMON_ENV_B] = {"TEMP_RAMON_ENV_B" , 0},
    [BMC_ATTR_ID_TEMP_RAMON_DIE_B] = {"TEMP_RAMON_DIE_B" , 0},
    [BMC_ATTR_ID_PSU0_TEMP]        = {"PSU0_TEMP"        , 0},
    [BMC_ATTR_ID_PSU1_TEMP]        = {"PSU1_TEMP"        , 0},
    [BMC_ATTR_ID_TEMP_BMC_ENV]     = {"TEMP_BMC_ENV"     , 0},
    [BMC_ATTR_ID_TEMP_ENV_FRONT_T] = {"TEMP_ENV_FRONT_T" , 0},
    [BMC_ATTR_ID_TEMP_ENV_FRONT_B] = {"TEMP_ENV_FRONT_B" , 0},
...
void check_and_do_i2c_mux_reset(int port)
{
    ...
    if(access("/sys/bus/i2c/devices/2-0030/cpld_id", F_OK) != -1 ) {
        ...
        if (ret != 0) {
            if(access("/sys/devices/platform/x86_64_ufispace_s9705_48d_lpc/cpu_cpld/mux_reset", F_OK) != -1 ) {
                //AIM_LOG_SYSLOG_WARN("I2C bus is stuck!! (port=%d)\r\n", port);
                snprintf(cmd_buf, sizeof(cmd_buf), "echo 0 > /sys/devices/platform/x86_64_ufispace_s9705_48d_lpc/cpu_cpld/mux_reset 2> /dev/null");
                ret = system(cmd_buf);
