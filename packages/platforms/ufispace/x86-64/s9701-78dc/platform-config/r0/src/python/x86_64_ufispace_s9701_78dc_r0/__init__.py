...
class OnlPlatform_x86_64_ufispace_s9701_78dc_r0(OnlPlatformUfiSpace):
    ...
    def check_i2c_status(self): 
        sysfs_mux_reset = "/sys/devices/platform/x86_64_ufispace_s9701_78dc_lpc/mb_cpld/mux_reset"
    ...
    def baseconfig(self):
        ...
        # lpc driver
        self.insmod("x86-64-ufispace-s9701-78dc-lpc")
        ...
        # init CPLD
        self.insmod("x86-64-ufispace-s9701-78dc-cpld")
        for i, addr in enumerate((0x30, 0x31, 0x32, 0x33)):
            self.new_i2c_device("s9701_78dc_cpld" + str(i+1), addr, 1)
        ...
        # onie syseeprom
        self.insmod("x86-64-ufispace-s9701-78dc-onie-syseeprom.ko")
        ...
        # init bcm82752
        os.system("/lib/platform-config/x86-64-ufispace-s9701-78dc-r0/onl/epdm_cli init 10G &")
