...
class OnlPlatform_x86_64_ufispace_s9301_32db_r0(OnlPlatformUfiSpace):
    PLATFORM = 'x86-64-ufispace-s9301-32db-r0'
    MODEL = "s9301-32db"
    ...
    sysfs_port_present = {
        0:  {"sysfs": "/sys/bus/i2c/devices/2-0031/cpld_qsfp56_pres_g0", "bit": 0},
        1:  {"sysfs": "/sys/bus/i2c/devices/2-0031/cpld_qsfp56_pres_g0", "bit": 1},
        2:  {"sysfs": "/sys/bus/i2c/devices/2-0031/cpld_qsfp56_pres_g0", "bit": 2},
        3:  {"sysfs": "/sys/bus/i2c/devices/2-0031/cpld_qsfp56_pres_g0", "bit": 3},
        4:  {"sysfs": "/sys/bus/i2c/devices/2-0031/cpld_qsfp56_pres_g0", "bit": 4},
        5:  {"sysfs": "/sys/bus/i2c/devices/2-0031/cpld_qsfp56_pres_g0", "bit": 5},
        6:  {"sysfs": "/sys/bus/i2c/devices/2-0031/cpld_qsfp56_pres_g0", "bit": 6},
        7:  {"sysfs": "/sys/bus/i2c/devices/2-0031/cpld_qsfp56_pres_g0", "bit": 7},
        8:  {"sysfs": "/sys/bus/i2c/devices/2-0031/cpld_qsfp56_pres_g1", "bit": 0},
        9:  {"sysfs": "/sys/bus/i2c/devices/2-0031/cpld_qsfp56_pres_g1", "bit": 1},
        10: {"sysfs": "/sys/bus/i2c/devices/2-0031/cpld_qsfp56_pres_g1", "bit": 2},
        11: {"sysfs": "/sys/bus/i2c/devices/2-0031/cpld_qsfp56_pres_g1", "bit": 3},
        12: {"sysfs": "/sys/bus/i2c/devices/2-0031/cpld_qsfp56_pres_g1", "bit": 4},
        13: {"sysfs": "/sys/bus/i2c/devices/2-0031/cpld_qsfp56_pres_g1", "bit": 5},
        14: {"sysfs": "/sys/bus/i2c/devices/2-0031/cpld_qsfp56_pres_g1", "bit": 6},
        15: {"sysfs": "/sys/bus/i2c/devices/2-0031/cpld_qsfp56_pres_g1", "bit": 7},
        16: {"sysfs": "/sys/bus/i2c/devices/2-0031/cpld_qsfp56_pres_g2", "bit": 0},
        17: {"sysfs": "/sys/bus/i2c/devices/2-0031/cpld_qsfp56_pres_g2", "bit": 1},
        18: {"sysfs": "/sys/bus/i2c/devices/2-0031/cpld_qsfp56_pres_g2", "bit": 2},
        19: {"sysfs": "/sys/bus/i2c/devices/2-0031/cpld_qsfp56_pres_g2", "bit": 3},
        20: {"sysfs": "/sys/bus/i2c/devices/2-0031/cpld_qsfp56_pres_g2", "bit": 4},
        21: {"sysfs": "/sys/bus/i2c/devices/2-0031/cpld_qsfp56_pres_g2", "bit": 5},
        22: {"sysfs": "/sys/bus/i2c/devices/2-0031/cpld_qsfp56_pres_g2", "bit": 6},
        23: {"sysfs": "/sys/bus/i2c/devices/2-0031/cpld_qsfp56_pres_g2", "bit": 7},
        24: {"sysfs": "/sys/bus/i2c/devices/2-0031/cpld_qsfpdd_pres", "bit": 0},
        25: {"sysfs": "/sys/bus/i2c/devices/2-0031/cpld_qsfpdd_pres", "bit": 1},
        26: {"sysfs": "/sys/bus/i2c/devices/2-0031/cpld_qsfpdd_pres", "bit": 2},
        27: {"sysfs": "/sys/bus/i2c/devices/2-0031/cpld_qsfpdd_pres", "bit": 3},
        28: {"sysfs": "/sys/bus/i2c/devices/2-0031/cpld_qsfpdd_pres", "bit": 4},
        29: {"sysfs": "/sys/bus/i2c/devices/2-0031/cpld_qsfpdd_pres", "bit": 5},
        30: {"sysfs": "/sys/bus/i2c/devices/2-0031/cpld_qsfpdd_pres", "bit": 6},
        31: {"sysfs": "/sys/bus/i2c/devices/2-0031/cpld_qsfpdd_pres", "bit": 7},
    }
    ...
    def check_i2c_status(self):
        sysfs_mux_reset = "/sys/devices/platform/x86_64_ufispace_s9301_32db_lpc/mb_cpld/mux_reset"
    ...
    def bsp_pr(self, pr_msg, level = LEVEL_INFO):
        if level == self.LEVEL_INFO:
            sysfs_bsp_logging = "/sys/devices/platform/x86_64_ufispace_s9301_32db_lpc/bsp/bsp_pr_info"
        elif level == self.LEVEL_ERR:
            sysfs_bsp_logging = "/sys/devices/platform/x86_64_ufispace_s9301_32db_lpc/bsp/bsp_pr_err"
        else:
    ...
    def baseconfig(self):
        ...
        # lpc driver
        self.insmod("x86-64-ufispace-s9301-32db-lpc")
        ...
        self.insmod("x86-64-ufispace-s9301-32db-cpld")
        for i, addr in enumerate((0x30, 0x31, 0x32)):
            self.new_i2c_device("s9301_32db_cpld" + str(i+1), addr, 2)
